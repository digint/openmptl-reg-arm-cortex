...
#ifndef ARCH_REG_DMAC0_HPP_INCLUDED
#define ARCH_REG_DMAC0_HPP_INCLUDED
...
struct DMAC0
{
  ...
  : public reg< uint32_t, base_addr + 0x00000000, rw, 0x00000010 >
  {
    ...
    using DICEN    = regbits< type,  8,  1 >;  /**< Descriptor Integrity Check  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000004, rw, 0x00000000 >
  {
    ...
    using ENABLE  = regbits< type,  0,  1 >;  /**< General Enable of DMA  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000018, wo, 0 >
  {
    ...
    using DICERR0  = regbits< type, 24,  1 >;  /**< Descriptor Integrity Check Error [7:0]   */
    using DICERR1  = regbits< type, 25,  1 >;  /**< Descriptor Integrity Check Error [7:0]   */
    using DICERR2  = regbits< type, 26,  1 >;  /**< Descriptor Integrity Check Error [7:0]   */
    using DICERR3  = regbits< type, 27,  1 >;  /**< Descriptor Integrity Check Error [7:0]   */
    using DICERR4  = regbits< type, 28,  1 >;  /**< Descriptor Integrity Check Error [7:0]   */
    using DICERR5  = regbits< type, 29,  1 >;  /**< Descriptor Integrity Check Error [7:0]   */
    using DICERR6  = regbits< type, 30,  1 >;  /**< Descriptor Integrity Check Error [7:0]   */
    using DICERR7  = regbits< type, 31,  1 >;  /**< Descriptor Integrity Check Error [7:0]   */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000044, rw, 0x00000000 >
  {
    ...
    using DSCR_IF  = regbits< type,  0,  2 >;  /**< Descriptor Interface Selection      */
  ...
  : public reg< uint32_t, base_addr + 0x00000048, rw, 0x00000000 >
  {
    ...
    using DONE       = regbits< type, 31,  1 >;  /**< Current Descriptor Stop Command and Transfer Completed Memory Indicator  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x0000004c, rw, 0x00000000 >
  {
    ...
    using FC        = regbits< type, 21,  2 >;  /**< Flow Control                                                     */
    ...
    using IEN       = regbits< type, 30,  1 >;  /**< Interrupt Enable Not                                             */
  ...
  : public reg< uint32_t, base_addr + 0x00000050, rw, 0x01000000 >
  {
    ...
    using SRC_PER_MSB  = regbits< type, 10,  2 >;  /**< SRC_PER Most Significant Bits                       */
    ...
    using DST_PER_MSB  = regbits< type, 14,  2 >;  /**< DST_PER Most Significant Bits                       */
...
#endif // ARCH_REG_DMAC0_HPP_INCLUDED
