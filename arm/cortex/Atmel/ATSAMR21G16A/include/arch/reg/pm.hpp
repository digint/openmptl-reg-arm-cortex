...
struct PM
{
  ...
  : public reg< uint32_t, base_addr + 0x20, rw, 0x00010000 >
  {
    ...
    using TC6      = regbits< type, 14,  1 >;  /**< TC6 APB Clock Enable      */
    using TC7      = regbits< type, 15,  1 >;  /**< TC7 APB Clock Enable      */
    using ADC      = regbits< type, 16,  1 >;  /**< ADC APB Clock Enable      */
    using AC       = regbits< type, 17,  1 >;  /**< AC APB Clock Enable       */
    using RFCTRL   = regbits< type, 21,  1 >;  /**< RFCTRL APB Clock Enable   */
