...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Atmel/ATSAM3S8C.svd"
//
//  vendor: Atmel
//  name: ATSAM3S8C
//  series: SAM3SD8
//  version: 20130205
//  description: Atmel ATSAM3S8C device: Cortex-M3 Microcontroller with 512KB Flash, USB, 100 Pins (refer to http://www.atmel.com/devices/SAM3S8C.aspx for more)
//  --------------------------------------------------------------------
//
...
struct USART2
{
   ...
   */
  struct VERSION
  : public reg< uint32_t, base_addr + 0x000000fc, ro, 0 /* svd2hpp: missing resetValue! */ >
  {
    using type = reg< uint32_t, base_addr + 0x000000fc, ro, 0 /* svd2hpp: missing resetValue! */ >;

    // fixme: Field name equals parent register name: VERSION
    using VERSION_ = regbits< type,  0, 12 >;  /**< Harware Module Version  */
    using MFN      = regbits< type, 16,  3 >;  /**< Metal Fix Number        */
  };
