...
struct CAN0
{
  static constexpr reg_addr_t base_addr = 0x400b4000;
  ...
  : public reg< uint32_t, base_addr + 0x00000000, rw, 0x00000000 >
  {
    ...
    using RXSYNC  = regbits< type, 24,  3 >;  /**< Reception Synchronization Stage (not readable)  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000020, ro, 0x00000000 >
  {
    ...
    using TEC  = regbits< type, 16,  8 >;  /**< Transmit Error Counter  */
  };
