...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Atmel/ATSAM3X8C.svd"
//
//  vendor: Atmel
//  name: ATSAM3X8C
//  series: SAM3X
//  version: 20130131
//  description: Atmel ATSAM3X8C device: Cortex-M3 Microcontroller with 2x256 KB Flash, HS USB, 100 Pins (refer to http://www.atmel.com/devices/SAM3X8C.aspx for more)
//  --------------------------------------------------------------------
//
...
struct DMAC
{
  static constexpr reg_addr_t base_addr = 0x400c4000;
  ...
  : public reg< uint32_t, base_addr + 0x00000018, wo, 0 >
  {
    ...
    using BTC0   = regbits< type,  0,  1 >;  /**< Buffer Transfer Completed [5:0]          */
    using BTC1   = regbits< type,  1,  1 >;  /**< Buffer Transfer Completed [5:0]          */
    using BTC2   = regbits< type,  2,  1 >;  /**< Buffer Transfer Completed [5:0]          */
    using BTC3   = regbits< type,  3,  1 >;  /**< Buffer Transfer Completed [5:0]          */
    using BTC4   = regbits< type,  4,  1 >;  /**< Buffer Transfer Completed [5:0]          */
    using BTC5   = regbits< type,  5,  1 >;  /**< Buffer Transfer Completed [5:0]          */
    using CBTC0  = regbits< type,  8,  1 >;  /**< Chained Buffer Transfer Completed [5:0]  */
    using CBTC1  = regbits< type,  9,  1 >;  /**< Chained Buffer Transfer Completed [5:0]  */
    using CBTC2  = regbits< type, 10,  1 >;  /**< Chained Buffer Transfer Completed [5:0]  */
    using CBTC3  = regbits< type, 11,  1 >;  /**< Chained Buffer Transfer Completed [5:0]  */
    using CBTC4  = regbits< type, 12,  1 >;  /**< Chained Buffer Transfer Completed [5:0]  */
    using CBTC5  = regbits< type, 13,  1 >;  /**< Chained Buffer Transfer Completed [5:0]  */
    using ERR0   = regbits< type, 16,  1 >;  /**< Access Error [5:0]                       */
    using ERR1   = regbits< type, 17,  1 >;  /**< Access Error [5:0]                       */
    using ERR2   = regbits< type, 18,  1 >;  /**< Access Error [5:0]                       */
    using ERR3   = regbits< type, 19,  1 >;  /**< Access Error [5:0]                       */
    using ERR4   = regbits< type, 20,  1 >;  /**< Access Error [5:0]                       */
    using ERR5   = regbits< type, 21,  1 >;  /**< Access Error [5:0]                       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000028, wo, 0 >
  {
    ...
    using ENA0   = regbits< type,  0,  1 >;  /**< Enable [5:0]   */
    using ENA1   = regbits< type,  1,  1 >;  /**< Enable [5:0]   */
    using ENA2   = regbits< type,  2,  1 >;  /**< Enable [5:0]   */
    using ENA3   = regbits< type,  3,  1 >;  /**< Enable [5:0]   */
    using ENA4   = regbits< type,  4,  1 >;  /**< Enable [5:0]   */
    using ENA5   = regbits< type,  5,  1 >;  /**< Enable [5:0]   */
    using SUSP0  = regbits< type,  8,  1 >;  /**< Suspend [5:0]  */
    using SUSP1  = regbits< type,  9,  1 >;  /**< Suspend [5:0]  */
    using SUSP2  = regbits< type, 10,  1 >;  /**< Suspend [5:0]  */
    using SUSP3  = regbits< type, 11,  1 >;  /**< Suspend [5:0]  */
    using SUSP4  = regbits< type, 12,  1 >;  /**< Suspend [5:0]  */
    using SUSP5  = regbits< type, 13,  1 >;  /**< Suspend [5:0]  */
    using KEEP0  = regbits< type, 24,  1 >;  /**< Keep on [5:0]  */
    using KEEP1  = regbits< type, 25,  1 >;  /**< Keep on [5:0]  */
    using KEEP2  = regbits< type, 26,  1 >;  /**< Keep on [5:0]  */
    using KEEP3  = regbits< type, 27,  1 >;  /**< Keep on [5:0]  */
    using KEEP4  = regbits< type, 28,  1 >;  /**< Keep on [5:0]  */
    using KEEP5  = regbits< type, 29,  1 >;  /**< Keep on [5:0]  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x0000002c, wo, 0 >
  {
    ...
    using DIS0  = regbits< type,  0,  1 >;  /**< Disable [5:0]  */
    using DIS1  = regbits< type,  1,  1 >;  /**< Disable [5:0]  */
    using DIS2  = regbits< type,  2,  1 >;  /**< Disable [5:0]  */
    using DIS3  = regbits< type,  3,  1 >;  /**< Disable [5:0]  */
    using DIS4  = regbits< type,  4,  1 >;  /**< Disable [5:0]  */
    using DIS5  = regbits< type,  5,  1 >;  /**< Disable [5:0]  */
    using RES0  = regbits< type,  8,  1 >;  /**< Resume [5:0]   */
    using RES1  = regbits< type,  9,  1 >;  /**< Resume [5:0]   */
    using RES2  = regbits< type, 10,  1 >;  /**< Resume [5:0]   */
    using RES3  = regbits< type, 11,  1 >;  /**< Resume [5:0]   */
    using RES4  = regbits< type, 12,  1 >;  /**< Resume [5:0]   */
    using RES5  = regbits< type, 13,  1 >;  /**< Resume [5:0]   */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000030, ro, 0x00FF0000 >
  {
    ...
    using SUSP4  = regbits< type, 12,  1 >;  /**< Suspend [5:0]  */
    using SUSP5  = regbits< type, 13,  1 >;  /**< Suspend [5:0]  */
    using EMPT0  = regbits< type, 16,  1 >;  /**< Empty [5:0]    */
    using EMPT1  = regbits< type, 17,  1 >;  /**< Empty [5:0]    */
    using EMPT2  = regbits< type, 18,  1 >;  /**< Empty [5:0]    */
    using EMPT3  = regbits< type, 19,  1 >;  /**< Empty [5:0]    */
    using EMPT4  = regbits< type, 20,  1 >;  /**< Empty [5:0]    */
    using EMPT5  = regbits< type, 21,  1 >;  /**< Empty [5:0]    */
    using STAL0  = regbits< type, 24,  1 >;  /**< Stalled [5:0]  */
    using STAL1  = regbits< type, 25,  1 >;  /**< Stalled [5:0]  */
    using STAL2  = regbits< type, 26,  1 >;  /**< Stalled [5:0]  */
    using STAL3  = regbits< type, 27,  1 >;  /**< Stalled [5:0]  */
    using STAL4  = regbits< type, 28,  1 >;  /**< Stalled [5:0]  */
    using STAL5  = regbits< type, 29,  1 >;  /**< Stalled [5:0]  */
  };
