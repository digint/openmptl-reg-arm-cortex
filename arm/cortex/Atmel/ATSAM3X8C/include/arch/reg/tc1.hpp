...
#ifndef ARCH_REG_TC1_HPP_INCLUDED
#define ARCH_REG_TC1_HPP_INCLUDED
...
struct TC1
{
  static constexpr reg_addr_t base_addr = 0x40084000;
  ...
  {
    using type = reg< uint32_t, base_addr + 0x000000d8, rw, 0x00000000 >;

    using ENCF0  = regbits< type,  0,  1 >;  /**< ENable Compare Fault Channel 0  */
    using ENCF1  = regbits< type,  1,  1 >;  /**< ENable Compare Fault Channel 1  */
  };
...
#endif // ARCH_REG_TC1_HPP_INCLUDED
