...
struct SUPC
{
  static constexpr reg_addr_t base_addr = 0x400e1a10;
  ...
  : public reg< uint32_t, base_addr + 0x00000008, rw, 0x00005A00 >
  {
    ...
    using VDDIORDYONREG  = regbits< type, 14,  1 >;
  ...
  : public reg< uint32_t, base_addr + 0x0000000c, rw, 0x00000000 >
  {
    ...
    using FWUPEN   = regbits< type,  0,  1 >;  /**< Force Wake Up Enable             */
    ...
    using FWUPDBC  = regbits< type,  8,  3 >;  /**< Force Wake Up Debouncer Period   */
   ...
   */
  struct SR
  : public reg< uint32_t, base_addr + 0x00000014, ro, 0x00000800 >
  {
    using type = reg< uint32_t, base_addr + 0x00000014, ro, 0x00000800 >;

    using FWUPS     = regbits< type,  0,  1 >;  /**< FWUP Wake Up Status                      */
    ...
    using FWUPIS    = regbits< type, 12,  1 >;  /**< FWUP Input Status                        */
