...
#ifndef ARCH_REG_SSC1_HPP_INCLUDED
#define ARCH_REG_SSC1_HPP_INCLUDED
...
struct SSC1
{
  static constexpr reg_addr_t base_addr = 0xfffa0000;
  ...
  : public reg< uint32_t, base_addr + 0x0000001c, rw, 0x00000000 >
  {
    ...
    using MSBF       = regbits< type,  7,  1 >;  /**< Most Significant Bit First            */
    using DATNB      = regbits< type,  8,  4 >;  /**< Data Number per frame                 */
    using FSLEN      = regbits< type, 16,  4 >;  /**< Transmit Frame Syn Length             */
...
#endif // ARCH_REG_SSC1_HPP_INCLUDED
