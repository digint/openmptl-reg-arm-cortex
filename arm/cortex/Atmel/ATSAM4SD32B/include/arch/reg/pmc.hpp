...
struct PMC
{
  ...
  : public reg< uint32_t, base_addr + 0x00000020, rw, 0x00000001 >
  {
    ...
    using WAITMODE  = regbits< type,  2,  1 >;  /**< Wait Mode Command                               */
  ...
  : public reg< uint32_t, base_addr + 0x00000024, rw, 0x00000000 >
  {
    ...
    using RCMEAS    = regbits< type, 20,  1 >;  /**< RC Oscillator Frequency Measure (write-only)  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x0000002c, rw, 0x00003F00 >
  {
    ...
    using DIVB       = regbits< type,  0,  8 >;  /**< Divider          */
    using PLLBCOUNT  = regbits< type,  8,  6 >;  /**< PLLB Counter     */
    using MULB       = regbits< type, 16, 11 >;  /**< PLLB Multiplier  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000030, rw, 0x00000001 >
  {
    ...
    using PLLBDIV2  = regbits< type, 13,  1 >;  /**< PLLB Divisor by 2              */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000060, wo, 0 >
  {
    ...
    using LOCKB     = regbits< type,  2,  1 >;  /**< PLLB Lock Interrupt Enable                         */
  ...
  : public reg< uint32_t, base_addr + 0x00000064, wo, 0 >
  {
    ...
    using LOCKB     = regbits< type,  2,  1 >;  /**< PLLB Lock Interrupt Disable                         */
  ...
  : public reg< uint32_t, base_addr + 0x00000068, ro, 0x00010008 >
  {
    ...
    using LOCKB     = regbits< type,  2,  1 >;  /**< PLLB Lock Status                            */
  ...
  : public reg< uint32_t, base_addr + 0x0000006c, ro, 0x00000000 >
  {
    ...
    using LOCKB     = regbits< type,  2,  1 >;  /**< PLLB Lock Interrupt Mask                         */
  ...
  : public reg< uint32_t, base_addr + 0x00000070, rw, 0x00000000 >
  {
    ...
    using FLPM    = regbits< type, 21,  2 >;  /**< Flash Low Power Mode          */
  };
   ...
   */
  struct PMC_OCR
  : public reg< uint32_t, base_addr + 0x00000110, rw, 0x00404040 >
  {
    using type = reg< uint32_t, base_addr + 0x00000110, rw, 0x00404040 >;

    using CAL4   = regbits< type,  0,  7 >;  /**< RC Oscillator Calibration bits for 4 MHz                */
    using SEL4   = regbits< type,  7,  1 >;  /**< Selection of RC Oscillator Calibration bits for 4 MHz   */
    using CAL8   = regbits< type,  8,  7 >;  /**< RC Oscillator Calibration bits for 8 MHz                */
    using SEL8   = regbits< type, 15,  1 >;  /**< Selection of RC Oscillator Calibration bits for 8 MHz   */
    using CAL12  = regbits< type, 16,  7 >;  /**< RC Oscillator Calibration bits for 12 MHz               */
    using SEL12  = regbits< type, 23,  1 >;  /**< Selection of RC Oscillator Calibration bits for 12 MHz  */
  };
};
} // namespace mptl
