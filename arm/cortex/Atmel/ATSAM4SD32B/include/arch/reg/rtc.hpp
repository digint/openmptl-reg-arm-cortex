...
struct RTC
{
  static constexpr reg_addr_t base_addr = 0x400e1460;
  ...
  : public reg< uint32_t, base_addr + 0x00000004, rw, 0x00000000 >
  {
    ...
    using PERSIAN     = regbits< type,  1,  1 >;  /**< PERSIAN Calendar                   */
    using NEGPPM      = regbits< type,  4,  1 >;  /**< NEGative PPM Correction            */
    using CORRECTION  = regbits< type,  8,  7 >;  /**< Slow Clock Correction              */
    using HIGHPPM     = regbits< type, 15,  1 >;  /**< HIGH PPM Correction                */
    using OUT0        = regbits< type, 16,  3 >;  /**< RTCOUT0 Output Source Selection    */
    using OUT1        = regbits< type, 20,  3 >;  /**< RTCOUT1 Output Source Selection    */
    using THIGH       = regbits< type, 24,  3 >;  /**< High Duration of the Output Pulse  */
    using TPERIOD     = regbits< type, 28,  2 >;  /**< Period of the Output Pulse         */
  };
   ...
   */
  struct CALR
  : public reg< uint32_t, base_addr + 0x0000000c, rw, 0x01A11020 >
  {
    using type = reg< uint32_t, base_addr + 0x0000000c, rw, 0x01A11020 >;
  ...
  : public reg< uint32_t, base_addr + 0x00000018, ro, 0x00000000 >
  {
    ...
    using TDERR   = regbits< type,  5,  1 >;  /**< Time and/or Date Free Running Error  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x0000001c, wo, 0 >
  {
    ...
    using TDERRCLR  = regbits< type,  5,  1 >;  /**< Time and/or Date Free Running Error Clear  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000020, wo, 0 >
  {
    ...
    using TDERREN  = regbits< type,  5,  1 >;  /**< Time and/or Date Error Interrupt Enable  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000024, wo, 0 >
  {
    ...
    using TDERRDIS  = regbits< type,  5,  1 >;  /**< Time and/or Date Error Interrupt Disable  */
  };
