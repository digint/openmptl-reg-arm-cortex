...
#ifndef ARCH_REG_USART2_HPP_INCLUDED
#define ARCH_REG_USART2_HPP_INCLUDED
...
struct USART2
{
  static constexpr reg_addr_t base_addr = 0xfffb8000;
  ...
  : public reg< uint32_t, base_addr + 0x00000000, wo, 0 >
  {
    ...
    using DTREN    = regbits< type, 16,  1 >;  /**< Data Terminal Ready Enable   */
    using DTRDIS   = regbits< type, 17,  1 >;  /**< Data Terminal Ready Disable  */
  ...
  : public reg< uint32_t, base_addr + 0x00000004, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using USART_MODE     = regbits< type,  0,  4 >;
    ...
    using MAX_ITERATION  = regbits< type, 24,  3 >;
  ...
  : public reg< uint32_t, base_addr + 0x00000008, wo, 0 >
  {
    ...
    using ENDRX    = regbits< type,  3,  1 >;  /**< End of Receive Transfer Interrupt Enable           */
    using ENDTX    = regbits< type,  4,  1 >;  /**< End of Transmit Interrupt Enable                   */
    ...
    using ITER     = regbits< type, 10,  1 >;  /**< Max number of Repetitions Reached                  */
    using TXBUFE   = regbits< type, 11,  1 >;  /**< Buffer Empty Interrupt Enable                      */
    using RXBUFF   = regbits< type, 12,  1 >;  /**< Buffer Full Interrupt Enable                       */
    using NACK     = regbits< type, 13,  1 >;  /**< Non AcknowledgeInterrupt Enable                    */
    using RIIC     = regbits< type, 16,  1 >;  /**< Ring Indicator Input Change Enable                 */
    using DSRIC    = regbits< type, 17,  1 >;  /**< Data Set Ready Input Change Enable                 */
    using DCDIC    = regbits< type, 18,  1 >;  /**< Data Carrier Detect Input Change Interrupt Enable  */
  ...
  : public reg< uint32_t, base_addr + 0x0000000c, wo, 0 >
  {
    ...
    using ENDRX    = regbits< type,  3,  1 >;  /**< End of Receive Transfer Interrupt Disable           */
    using ENDTX    = regbits< type,  4,  1 >;  /**< End of Transmit Interrupt Disable                   */
    ...
    using ITER     = regbits< type, 10,  1 >;  /**< Max number of Repetitions Reached Disable           */
    using TXBUFE   = regbits< type, 11,  1 >;  /**< Buffer Empty Interrupt Disable                      */
    using RXBUFF   = regbits< type, 12,  1 >;  /**< Buffer Full Interrupt Disable                       */
    using NACK     = regbits< type, 13,  1 >;  /**< Non AcknowledgeInterrupt Disable                    */
    using RIIC     = regbits< type, 16,  1 >;  /**< Ring Indicator Input Change Disable                 */
    using DSRIC    = regbits< type, 17,  1 >;  /**< Data Set Ready Input Change Disable                 */
    using DCDIC    = regbits< type, 18,  1 >;  /**< Data Carrier Detect Input Change Interrupt Disable  */
  ...
  : public reg< uint32_t, base_addr + 0x00000010, ro, 0x00000000 >
  {
    ...
    using ENDRX    = regbits< type,  3,  1 >;  /**< End of Receive Transfer Interrupt Mask           */
    using ENDTX    = regbits< type,  4,  1 >;  /**< End of Transmit Interrupt Mask                   */
    ...
    using ITER     = regbits< type, 10,  1 >;  /**< Max number of Repetitions Reached Mask           */
    using TXBUFE   = regbits< type, 11,  1 >;  /**< Buffer Empty Interrupt Mask                      */
    using RXBUFF   = regbits< type, 12,  1 >;  /**< Buffer Full Interrupt Mask                       */
    using NACK     = regbits< type, 13,  1 >;  /**< Non AcknowledgeInterrupt Mask                    */
    using RIIC     = regbits< type, 16,  1 >;  /**< Ring Indicator Input Change Mask                 */
    using DSRIC    = regbits< type, 17,  1 >;  /**< Data Set Ready Input Change Mask                 */
    using DCDIC    = regbits< type, 18,  1 >;  /**< Data Carrier Detect Input Change Interrupt Mask  */
  ...
  : public reg< uint32_t, base_addr + 0x00000014, ro, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using RIIC     = regbits< type, 16,  1 >;  /**< Ring Indicator Input Change Flag       */
    using DSRIC    = regbits< type, 17,  1 >;  /**< Data Set Ready Input Change Flag       */
    using DCDIC    = regbits< type, 18,  1 >;  /**< Data Carrier Detect Input Change Flag  */
    using CTSIC    = regbits< type, 19,  1 >;  /**< Clear to Send Input Change Flag        */
    using RI       = regbits< type, 20,  1 >;  /**< Image of RI Input                      */
    using DSR      = regbits< type, 21,  1 >;  /**< Image of DSR Input                     */
    using DCD      = regbits< type, 22,  1 >;  /**< Image of DCD Input                     */
   ...
   */
  struct MAN
  : public reg< uint32_t, base_addr + 0x00000050, rw, 0x30011004 >
  {
    using type = reg< uint32_t, base_addr + 0x00000050, rw, 0x30011004 >;
...
#endif // ARCH_REG_USART2_HPP_INCLUDED
