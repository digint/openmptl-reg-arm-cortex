...
struct PMC
{
  ...
  : public reg< uint32_t, base_addr + 0x00000000, wo, 0 >
  {
    ...
    using UHP   = regbits< type,  6,  1 >;  /**< USB Host Port Clock Enable          */
  ...
  : public reg< uint32_t, base_addr + 0x00000004, wo, 0 >
  {
    ...
    using UHP   = regbits< type,  6,  1 >;  /**< USB Host Port Clock Disable          */
  ...
  : public reg< uint32_t, base_addr + 0x00000028, rw, 0x00003F00 >
  {
    ...
    using MULA       = regbits< type, 16,  8 >;  /**< PLL A Multiplier             */
  ...
  : public reg< uint32_t, base_addr + 0x0000002c, rw, 0x00003F00 >
  {
    ...
    using OUTB       = regbits< type, 14,  2 >;  /**< PLL B Clock Frequency Range  */
    using MULB       = regbits< type, 16,  6 >;  /**< PLL B Multiplier             */
  ...
  : public reg< uint32_t, base_addr + 0x00000030, rw, 0x00000000 >
  {
    ...
    using PDIV  = regbits< type, 12,  1 >;  /**< Processor Clock Division                 */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000068, ro, 0x00000008 >
  {
    ...
    using MOSCS    = regbits< type,  0,  1 >;  /**< Main Oscillator Status           */
    ...
    using OSC_SEL  = regbits< type,  7,  1 >;  /**< Slow Clock Oscillator Selection  */
  ...
  : public reg< uint32_t, base_addr + 0x0000006c, ro, 0x00000000 >
  {
    ...
    using PCKRDY0  = regbits< type,  8,  1 >;  /**< Programmable Clock Ready Interrupt Mask  */
    using PCKRDY1  = regbits< type,  9,  1 >;  /**< Programmable Clock Ready Interrupt Mask  */
  };
   ...
   */
  struct PMC_PLLICPR
  : public reg< uint32_t, base_addr + 0x00000080, wo, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0x00000080, wo, 0x00000000 >;

    using ICPLLA  = regbits< type,  0,  1 >;  /**< Charge Pump Current  */
    using ICPLLB  = regbits< type, 16,  1 >;  /**< Charge Pump Current  */
  };
};
} // namespace mptl
