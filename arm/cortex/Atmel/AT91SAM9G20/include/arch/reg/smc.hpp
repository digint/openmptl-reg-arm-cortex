...
struct SMC
{
   ...
   */
  struct CYCLE0
  : public reg< uint32_t, base_addr + 0x00000008, rw, 0x00010001 >
  {
    using type = reg< uint32_t, base_addr + 0x00000008, rw, 0x00010001 >;
   ...
   */
  struct CYCLE1
  : public reg< uint32_t, base_addr + 0x00000018, rw, 0x00010001 >
  {
    using type = reg< uint32_t, base_addr + 0x00000018, rw, 0x00010001 >;
   ...
   */
  struct CYCLE2
  : public reg< uint32_t, base_addr + 0x00000028, rw, 0x00010001 >
  {
    using type = reg< uint32_t, base_addr + 0x00000028, rw, 0x00010001 >;
   ...
   */
  struct CYCLE3
  : public reg< uint32_t, base_addr + 0x00000038, rw, 0x00010001 >
  {
    using type = reg< uint32_t, base_addr + 0x00000038, rw, 0x00010001 >;
   ...
   */
  struct CYCLE4
  : public reg< uint32_t, base_addr + 0x00000048, rw, 0x00010001 >
  {
    using type = reg< uint32_t, base_addr + 0x00000048, rw, 0x00010001 >;
   ...
   */
  struct CYCLE5
  : public reg< uint32_t, base_addr + 0x00000058, rw, 0x00010001 >
  {
    using type = reg< uint32_t, base_addr + 0x00000058, rw, 0x00010001 >;
   ...
   */
  struct CYCLE6
  : public reg< uint32_t, base_addr + 0x00000068, rw, 0x00010001 >
  {
    using type = reg< uint32_t, base_addr + 0x00000068, rw, 0x00010001 >;
   ...
   */
  struct CYCLE7
  : public reg< uint32_t, base_addr + 0x00000078, rw, 0x00010001 >
  {
    using type = reg< uint32_t, base_addr + 0x00000078, rw, 0x00010001 >;
