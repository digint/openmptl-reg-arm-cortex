...
#ifndef ARCH_REG_DDRSDRC_HPP_INCLUDED
#define ARCH_REG_DDRSDRC_HPP_INCLUDED
...
struct DDRSDRC
{
  ...
  : public reg< uint32_t, base_addr + 0x00000014, rw, 0x00002062 >
  {
    ...
    using TFAW    = regbits< type, 16,  4 >;  /**< Four Active window                                                 */
  };
...
#endif // ARCH_REG_DDRSDRC_HPP_INCLUDED
