...
#ifndef ARCH_REG_TWI1_HPP_INCLUDED
#define ARCH_REG_TWI1_HPP_INCLUDED
...
struct TWI1
{
  static constexpr reg_addr_t base_addr = 0xf8014000;
  ...
  : public reg< uint32_t, base_addr + 0x000000e4, rw, 0x00000000 >
  {
    ...
    using WPROT          = regbits< type,  0,  1 >;  /**< Write protection bit                 */
    using SECURITY_CODE  = regbits< type,  8, 24 >;  /**< Write protection mode security code  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x000000e8, ro, 0x00000000 >
  {
    ...
    using WPROTADDR  = regbits< type,  8, 24 >;  /**< Write Protection Error Address  */
  };
};
} // namespace mptl

#endif // ARCH_REG_TWI1_HPP_INCLUDED
