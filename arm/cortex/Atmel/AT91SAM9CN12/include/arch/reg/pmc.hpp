...
struct PMC
{
   ...
   */
  struct CKGR_MOR
  : public reg< uint32_t, base_addr + 0x00000020, rw, 0x01000001 >
  {
    using type = reg< uint32_t, base_addr + 0x00000020, rw, 0x01000001 >;
  ...
  : public reg< uint32_t, base_addr + 0x00000024, rw, 0x00000000 >
  {
    ...
    using RCMEAS    = regbits< type, 20,  1 >;  /**< RC Measure            */
  };
