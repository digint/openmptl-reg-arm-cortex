...
using uart0   = irq_channel<16>;    
using uart1   = irq_channel<17>;    
...
using emac    = irq_channel<35>;    
using isi     = irq_channel<37>;    
using ssc0    = irq_channel<38>;    
using ssc1    = irq_channel<39>;    
using can0    = irq_channel<40>;    
using can1    = irq_channel<41>;    
