...
struct EMAC
{
  ...
  : public reg< uint32_t, base_addr + 0x00000024, rw, 0x00000000 >
  {
    ...
    using WOL    = regbits< type, 14,  1 >;  /**< Wake On LAN                        */
  };
   ...
   */
  struct IMR
  : public reg< uint32_t, base_addr + 0x00000030, ro, 0x00007FFF >
  {
    using type = reg< uint32_t, base_addr + 0x00000030, ro, 0x00007FFF >;
