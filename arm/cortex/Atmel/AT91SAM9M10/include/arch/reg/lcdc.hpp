...
struct LCDC
{
  ...
  : public reg< uint32_t, base_addr + 0x0000001c, rw, 0x00000000 >
  {
    ...
    using DMAUPDT  = regbits< type,  3,  1 >;  /**< DMA Configuration Update  */
    using DMA2DEN  = regbits< type,  4,  1 >;  /**< DMA 2D Addressing Enable  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000020, rw, 0x00000000 >
  {
    ...
    using ADDRINC   = regbits< type,  0, 16 >;  /**< DMA 2D Addressing Address increment  */
    using PIXELOFF  = regbits< type, 24,  5 >;  /**< DAM2D Addressing Pixel offset        */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000810, rw, 0x00000000 >
  {
    ...
    using LINESIZE  = regbits< type, 21, 11 >;  /**< Horizontal size of LCD module, in pixels, minus 1  */
  };
   ...
   */
  struct LCD_ITR
  : public reg< uint32_t, base_addr + 0x00000860, wo, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0x00000860, wo, 0x00000000 >;

    using LNIT     = regbits< type,  0,  1 >;  /**< Line interrupt test              */
    using LSTLNIT  = regbits< type,  1,  1 >;  /**< Last line interrupt test         */
    using EOFIT    = regbits< type,  2,  1 >;  /**< DMA End of frame interrupt test  */
    using UFLWIT   = regbits< type,  4,  1 >;  /**< FIFO underflow interrupt test    */
    using OWRIT    = regbits< type,  5,  1 >;  /**< FIFO overwrite interrupt test    */
    using MERIT    = regbits< type,  6,  1 >;  /**< DMA Memory error interrupt test  */
  };
   ...
   */
  struct LCD_IRR
  : public reg< uint32_t, base_addr + 0x00000864, ro, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0x00000864, ro, 0x00000000 >;

    using LNIR     = regbits< type,  0,  1 >;  /**< Line interrupt raw status              */
    using LSTLNIR  = regbits< type,  1,  1 >;  /**< Last line interrupt raw status         */
    using EOFIR    = regbits< type,  2,  1 >;  /**< DMA End of frame interrupt raw status  */
    using UFLWIR   = regbits< type,  4,  1 >;  /**< FIFO underflow interrupt raw status    */
    using OWRIR    = regbits< type,  5,  1 >;  /**< FIFO overwrite interrupt raw status    */
    using MERIR    = regbits< type,  6,  1 >;  /**< DMA Memory error interrupt raw status  */
  };
