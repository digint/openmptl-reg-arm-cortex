...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Atmel/ATSAM3N00B.svd"
//
//  vendor: Atmel
//  name: ATSAM3N00B
//  series: SAM3N
//  version: 20130131
//  description: Atmel ATSAM3N00B device: Cortex-M3 Microcontroller with 16KB Flash, 64 Pins (refer to http://www.atmel.com/devices/SAM3N00B.aspx for more)
//  --------------------------------------------------------------------
//
...
template<> struct address_map< 0x40028000 > { static constexpr const char * name_str = "USART1::CR"; };  /* svd2hpp: duplicate address for: USART1::CR, USART1::CR_SPI_MODE */
template<> struct address_map< 0x40028004 > { static constexpr const char * name_str = "USART1::MR"; };  /* svd2hpp: duplicate address for: USART1::MR, USART1::MR_SPI_MODE */
template<> struct address_map< 0x40028008 > { static constexpr const char * name_str = "USART1::IER"; };  /* svd2hpp: duplicate address for: USART1::IER, USART1::IER_SPI_MODE */
template<> struct address_map< 0x4002800c > { static constexpr const char * name_str = "USART1::IDR"; };  /* svd2hpp: duplicate address for: USART1::IDR, USART1::IDR_SPI_MODE */
template<> struct address_map< 0x40028010 > { static constexpr const char * name_str = "USART1::IMR"; };  /* svd2hpp: duplicate address for: USART1::IMR, USART1::IMR_SPI_MODE */
template<> struct address_map< 0x40028014 > { static constexpr const char * name_str = "USART1::CSR"; };  /* svd2hpp: duplicate address for: USART1::CSR, USART1::CSR_SPI_MODE */
template<> struct address_map< 0x40028018 > { static constexpr const char * name_str = "USART1::RHR"; };
template<> struct address_map< 0x4002801c > { static constexpr const char * name_str = "USART1::THR"; };
template<> struct address_map< 0x40028020 > { static constexpr const char * name_str = "USART1::BRGR"; };
template<> struct address_map< 0x40028024 > { static constexpr const char * name_str = "USART1::RTOR"; };
template<> struct address_map< 0x40028028 > { static constexpr const char * name_str = "USART1::TTGR"; };
template<> struct address_map< 0x40028040 > { static constexpr const char * name_str = "USART1::FIDI"; };
template<> struct address_map< 0x40028044 > { static constexpr const char * name_str = "USART1::NER"; };
template<> struct address_map< 0x4002804c > { static constexpr const char * name_str = "USART1::IF"; };
template<> struct address_map< 0x400280e4 > { static constexpr const char * name_str = "USART1::WPMR"; };
template<> struct address_map< 0x400280e8 > { static constexpr const char * name_str = "USART1::WPSR"; };
