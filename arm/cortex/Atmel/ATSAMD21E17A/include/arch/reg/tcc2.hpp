...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Atmel/ATSAMD21E17A.svd"
//
...
//  series: SAMD21
//  version: A
//  description: Atmel ATSAMD21E17A device: Cortex-M0+ Microcontroller with 128KB Flash, 16KB SRAM, 32-pin package (refer to http://www.atmel.com/devices/SAMD21E17A.aspx for more)
//  --------------------------------------------------------------------
//
...
#ifndef ARCH_REG_TCC2_HPP_INCLUDED
#define ARCH_REG_TCC2_HPP_INCLUDED
...
struct TCC2
{
  static constexpr reg_addr_t base_addr = 0x42002800;
...
#endif // ARCH_REG_TCC2_HPP_INCLUDED
