...
#ifndef ARCH_REG_ADC12B_HPP_INCLUDED
#define ARCH_REG_ADC12B_HPP_INCLUDED
...
struct ADC12B
{
  ...
  : public reg< uint32_t, base_addr + 0x00000004, rw, 0x00000000 >
  {
    ...
    using STARTUP  = regbits< type, 16,  8 >;  /**< Start Up Time             */
  ...
  : public reg< uint32_t, base_addr + 0x00000014, wo, 0 >
  {
    ...
    using CH0  = regbits< type,  0,  1 >;
    using CH1  = regbits< type,  1,  1 >;
    using CH2  = regbits< type,  2,  1 >;
    using CH3  = regbits< type,  3,  1 >;
    using CH4  = regbits< type,  4,  1 >;
    using CH5  = regbits< type,  5,  1 >;
    using CH6  = regbits< type,  6,  1 >;
    using CH7  = regbits< type,  7,  1 >;
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000064, rw, 0x00000000 >
  {
    ...
    using GAIN    = regbits< type,  0,  2 >;  /**< Input Gain            */
    using IBCTL   = regbits< type,  8,  2 >;  /**< Bias Current Control  */
    using DIFF    = regbits< type, 16,  1 >;  /**< Differential Mode     */
    using OFFSET  = regbits< type, 17,  1 >;  /**< Input OFFSET          */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000068, rw, 0x00000000 >
  {
    ...
    using OFFMODES               = regbits< type,  0,  1 >;  /**< Off Mode if Sleep Bit (ADC12B_MR) = 1  */
    using OFF_MODE_STARTUP_TIME  = regbits< type, 16,  8 >;  /**< Startup Time                           */
  };
...
#endif // ARCH_REG_ADC12B_HPP_INCLUDED
