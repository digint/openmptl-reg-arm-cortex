...
struct PWM
{
  static constexpr reg_addr_t base_addr = 0x4008c000;
  ...
  : public reg< uint32_t, base_addr + 0x0000005c, rw, 0x00000000 >
  {
    ...
    using FPOL  = regbits< type,  0,  8 >;  /**< Fault Polarity (fault input bit varies from 0 to 3)         */
    using FMOD  = regbits< type,  8,  8 >;  /**< Fault Activation Mode (fault input bit varies from 0 to 3)  */
    using FFIL  = regbits< type, 16,  8 >;  /**< Fault Filtering (fault input bit varies from 0 to 3)        */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000060, ro, 0x00000000 >
  {
    ...
    using FIV  = regbits< type,  0,  8 >;  /**< Fault Input Value (fault input bit varies from 0 to 3)  */
    using FS   = regbits< type,  8,  8 >;  /**< Fault Status (fault input bit varies from 0 to 3)       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000064, wo, 0 >
  {
    ...
    using FCLR  = regbits< type,  0,  8 >;  /**< Fault Clear (fault input bit varies from 0 to 3)  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x0000006c, rw, 0x00000000 >
  {
    ...
    using FPE0  = regbits< type,  0,  8 >;  /**< Fault Protection Enable for channel 0 (fault input bit varies from 0 to 3)  */
    using FPE1  = regbits< type,  8,  8 >;  /**< Fault Protection Enable for channel 1 (fault input bit varies from 0 to 3)  */
    using FPE2  = regbits< type, 16,  8 >;  /**< Fault Protection Enable for channel 2 (fault input bit varies from 0 to 3)  */
    using FPE3  = regbits< type, 24,  8 >;  /**< Fault Protection Enable for channel 3 (fault input bit varies from 0 to 3)  */
  };
