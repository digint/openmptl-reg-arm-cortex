...
#ifndef ARCH_REG_HSMCI2_HPP_INCLUDED
#define ARCH_REG_HSMCI2_HPP_INCLUDED
...
struct HSMCI2
{
  static constexpr reg_addr_t base_addr = 0xf8004000;
  ...
  : public reg< uint32_t, base_addr + 0x00000050, rw, 0x00000000 >
  {
    ...
    using CHKSIZE  = regbits< type,  4,  3 >;  /**< DMA Channel Read and Write Chunk Size  */
...
#endif // ARCH_REG_HSMCI2_HPP_INCLUDED
