...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Fujitsu/MB9AFAAxL.svd"
//
//  name: MB9AFAAxL
//  version: 1.1
//  description: MB9AFAAxL
//  --------------------------------------------------------------------
//
...
struct GPIO
{
   ...
   */
  struct ADE
  : public reg< uint32_t, base_addr + 0x500, rw, 0x000003BF >
  {
    using type = reg< uint32_t, base_addr + 0x500, rw, 0x000003BF >;
