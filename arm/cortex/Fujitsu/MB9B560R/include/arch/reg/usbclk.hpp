...
struct USBCLK
{
  ...
  : public reg< uint8_t, base_addr + 0x20, ro, 0x00 >
  {
    ...
    using UPCSI  = regbits< type,  0,  1 >;  /**< USB-PLL interrupt factor status bit  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x1c, wo, 0x00 >
  {
    ...
    using UPCSC  = regbits< type,  0,  1 >;  /**< USB-PLL oscillation stabilization interrupt factor clear bit  */
  };
