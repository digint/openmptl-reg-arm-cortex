...
struct CLK_GATING
{
   ...
   */
  struct CKEN0
  : public reg< uint32_t, base_addr + 0x0, rw, 0x150FFFFF >
  {
    using type = reg< uint32_t, base_addr + 0x0, rw, 0x150FFFFF >;
   ...
   */
  struct CKEN1
  : public reg< uint32_t, base_addr + 0x10, rw, 0x000F0F0F >
  {
    using type = reg< uint32_t, base_addr + 0x10, rw, 0x000F0F0F >;
   ...
   */
  struct CKEN2
  : public reg< uint32_t, base_addr + 0x20, rw, 0x03100070 >
  {
    using type = reg< uint32_t, base_addr + 0x20, rw, 0x03100070 >;

    using QSPICK  = regbits< type, 28,  1 >;  /**< 28                                                                         */
    using CECCK1  = regbits< type, 25,  1 >;  /**< 25                                                                         */
    using CECCK0  = regbits< type, 24,  1 >;  /**< 24                                                                         */
    using PCRCCK  = regbits< type, 20,  1 >;  /**< 20                                                                         */
    using I2SCK1  = regbits< type, 17,  1 >;  /**< 17                                                                         */
    using I2SCK0  = regbits< type, 16,  1 >;  /**< 16                                                                         */
    using SDCCK   = regbits< type,  8,  1 >;  /**< Settings for operation clock supply and gating to SD card interface        */
    using CANCK2  = regbits< type,  6,  1 >;  /**< Settings for operation clock supply and gating to SD card interface        */
    using CANCK1  = regbits< type,  5,  1 >;  /**< Settings for clock supply and gating to CAN controller ch.1                */
    using CANCK0  = regbits< type,  4,  1 >;  /**< Settings for clock supply and gating to CAN controller ch.0                */
    using USBCK1  = regbits< type,  1,  1 >;  /**< Settings for operation clock supply and gating of USB(function/host) ch.1  */
    using USBCK0  = regbits< type,  0,  1 >;  /**< Settings for operation clock supply and gating of USB(function/host) ch.0  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x00000000 >
  {
    ...
    using QSPIRST  = regbits< type, 28,  1 >;  /**< 28                                         */
    using CECRST1  = regbits< type, 25,  1 >;  /**< 25                                         */
    using CECRST0  = regbits< type, 24,  1 >;  /**< 24                                         */
    using PCRCRST  = regbits< type, 20,  1 >;  /**< 20                                         */
    using I2SRST1  = regbits< type, 17,  1 >;  /**< 17                                         */
    using I2SRST0  = regbits< type, 16,  1 >;  /**< 16                                         */
    using SDCRST   = regbits< type,  8,  1 >;  /**< Reset control of SD card interface         */
    using CANRST2  = regbits< type,  6,  1 >;  /**< Reset control of SD card interface         */
    using CANRST1  = regbits< type,  5,  1 >;  /**< Reset control of CAN controller ch.1       */
    using CANRST0  = regbits< type,  4,  1 >;  /**< Reset control of CAN controller ch.0       */
