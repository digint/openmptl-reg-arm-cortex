...
#ifndef ARCH_REG_MFS10_HPP_INCLUDED
#define ARCH_REG_MFS10_HPP_INCLUDED
...
struct MFS10
{
  static constexpr reg_addr_t base_addr = 0x40038a00;
  ...
  : public reg< uint8_t, base_addr + 0x5, rw, 0x03 >
  {
    ...
    using REC   = regbits< type,  7,  1 >;  /**< Received error flag clear bit  */
    using AWC   = regbits< type,  4,  1 >;  /**< Access Width Control bit       */
    using ORE   = regbits< type,  3,  1 >;  /**< Overrun error flag bit         */
    using RDRF  = regbits< type,  2,  1 >;  /**< Received data full flag bit    */
    using TDRE  = regbits< type,  1,  1 >;  /**< Transmit data empty flag bit   */
  ...
  : public reg< uint16_t, base_addr + 0x30, rw, 0x0020 >
  {
    ...
    using CSEN3  = regbits< type,  4,  1 >;  /**< Serial Chip Select Enable bit with SCS3 pin             */
    using CSEN2  = regbits< type,  3,  1 >;  /**< Serial Chip Select Enable bit with SCS2 pin             */
    using CSEN1  = regbits< type,  2,  1 >;  /**< Serial Chip Select Enable bit with SCS1 pin             */
    using CSEN0  = regbits< type,  1,  1 >;  /**< Serial Chip Select Enable bit with SCS0 pin             */
  ...
  : public reg< uint8_t, base_addr + 0x34, rw, 0x00 >
  {
    ...
    using CS1L      = regbits< type,  0,  5 >;  /**< Transfer direction select bit of Serial Chip Select 1  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x35, rw, 0x00 >
  {
    ...
    using CS2L      = regbits< type,  0,  5 >;  /**< Transfer direction select bit of Serial Chip Select 2  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x38, rw, 0x00 >
  {
    ...
    using CS3CSLVL  = regbits< type,  7,  1 >;  /**< Serial Chip Select 3 Level Setting bit                 */
    using CS3SCINV  = regbits< type,  6,  1 >;  /**< Serial Clock Invert bit of Serial Chip Select 3        */
    using CS3SPI    = regbits< type,  5,  1 >;  /**< SPI corresponding bit of Serial Chip Select 3          */
    using CS3L      = regbits< type,  0,  5 >;  /**< Transfer direction select bit of Serial Chip Select 3  */
  };
...
#endif // ARCH_REG_MFS10_HPP_INCLUDED
