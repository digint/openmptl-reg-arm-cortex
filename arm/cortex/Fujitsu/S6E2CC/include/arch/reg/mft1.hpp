...
#ifndef ARCH_REG_MFT1_HPP_INCLUDED
#define ARCH_REG_MFT1_HPP_INCLUDED
...
struct MFT1
{
   ...
   */
  struct OCU_OCSD10
  : public reg< uint16_t, base_addr + 0x11a, rw, 0x0000 >
  {
    using type = reg< uint16_t, base_addr + 0x11a, rw, 0x0000 >;

    using OFEX1      = regbits< type, 13,  1 >;  /**< extends the matching determination conditions of the connected FRT with the OCCP(1) register value  */
    using OFEX0      = regbits< type, 12,  1 >;  /**< extends the matching determination conditions of the connected FRT with the OCCP(0) register value  */
    using OEBM1      = regbits< type, 11,  1 >;  /**< sets the linked transfer settings with the FRT interrupt mask counter                               */
    using OEBM0      = regbits< type, 10,  1 >;  /**< sets the linked transfer settings with the FRT interrupt mask counter                               */
    using OPBM1      = regbits< type,  9,  1 >;  /**< sets the linked transfer settings with the FRT interrupt mask counter                               */
    using OPBM0      = regbits< type,  8,  1 >;  /**< sets the linked transfer settings with the FRT interrupt mask counter                               */
  ...
  : public reg< uint16_t, base_addr + 0x1b4, rw, 0x0000 >
  {
    ...
    using DHOLD  = regbits< type,  7,  1 >;  /**< selects whether the RTO output signal of WFG is held when the DTIF interrupt signal is asserted  */
  ...
  : public reg< uint8_t, base_addr + 0x1d4, rw, 0x00 >
  {
    ...
    using APBM   = regbits< type,  5,  1 >;  /**< sets the linked transfer with the FRT interrupt mask counter                         */
   ...
   */
  struct ADCMP_ACMC0
  : public reg< uint8_t, base_addr + 0x1d6, rw, 0x00 >
  {
    using type = reg< uint8_t, base_addr + 0x1d6, rw, 0x00 >;

    using MPCE  = regbits< type,  7,  1 >;  /**< specifies whether a comparison is performed with the FRT peak interrupt mask counter  */
    using MZCE  = regbits< type,  6,  1 >;  /**< specifies whether a comparison is performed with the FRT zero interrupt mask counter  */
    using AMC   = regbits< type,  0,  4 >;  /**< specifies the value to be compared with the FRT interrupt mask counter                */
  };
   ...
   *
   * (derived from: ADCMP_ACMC0)
   */
  struct ADCMP_ACMC1
  : public reg< uint32_t, base_addr + 0x1da, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct ADCMP_ACMC2
  : public reg< uint32_t, base_addr + 0x1de, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct ADCMP_ACMC3
  : public reg< uint32_t, base_addr + 0x1e2, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct ADCMP_ACMC4
  : public reg< uint32_t, base_addr + 0x1e6, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct ADCMP_ACMC5
  : public reg< uint32_t, base_addr + 0x1ea, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct FRT_TCSD
  : public reg< uint8_t, base_addr + 0x1ec, rw, 0x00 >
  {
    using type = reg< uint8_t, base_addr + 0x1ec, rw, 0x00 >;

    using OFMD2  = regbits< type,  1,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using OFMD1  = regbits< type,  0,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
  };
};
} // namespace mptl

#endif // ARCH_REG_MFT1_HPP_INCLUDED
