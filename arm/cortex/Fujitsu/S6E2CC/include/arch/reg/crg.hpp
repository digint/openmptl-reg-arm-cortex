...
struct CRG
{
  ...
  {
    using type = reg< uint32_t, base_addr + 0x0, rw, 0x00 >;
   ...
   */
  struct SCM_STR
  : public reg< uint32_t, base_addr + 0x4, ro, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x4, ro, 0x00 >;
   ...
   */
  struct RST_STR
  : public reg< uint32_t, base_addr + 0xc, ro, 0x0001 >
  {
    using type = reg< uint32_t, base_addr + 0xc, ro, 0x0001 >;
   ...
   */
  struct BSC_PSR
  : public reg< uint32_t, base_addr + 0x10, rw, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x10, rw, 0x00 >;
   ...
   */
  struct APBC0_PSR
  : public reg< uint32_t, base_addr + 0x14, rw, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x14, rw, 0x00 >;
   ...
   */
  struct APBC1_PSR
  : public reg< uint32_t, base_addr + 0x18, rw, 0x80 >
  {
    using type = reg< uint32_t, base_addr + 0x18, rw, 0x80 >;
   ...
   */
  struct APBC2_PSR
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x80 >
  {
    using type = reg< uint32_t, base_addr + 0x1c, rw, 0x80 >;
   ...
   */
  struct SWC_PSR
  : public reg< uint32_t, base_addr + 0x20, rw, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x20, rw, 0x00 >;
   ...
   */
  struct TTC_PSR
  : public reg< uint32_t, base_addr + 0x28, rw, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x28, rw, 0x00 >;
   ...
   */
  struct CSW_TMR
  : public reg< uint32_t, base_addr + 0x30, rw, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x30, rw, 0x00 >;

    using SOWT  = regbits< type,  4,  4 >;  /**< Sub clock stabilization wait time setup bit   */
   ...
   */
  struct PSW_TMR
  : public reg< uint32_t, base_addr + 0x34, rw, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x34, rw, 0x00 >;
   ...
   */
  struct PLL_CTL1
  : public reg< uint32_t, base_addr + 0x38, rw, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x38, rw, 0x00 >;
   ...
   */
  struct PLL_CTL2
  : public reg< uint32_t, base_addr + 0x3c, rw, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x3c, rw, 0x00 >;
   ...
   */
  struct CSV_CTL
  : public reg< uint32_t, base_addr + 0x40, rw, 0x7003 >
  {
    using type = reg< uint32_t, base_addr + 0x40, rw, 0x7003 >;
   ...
   */
  struct CSV_STR
  : public reg< uint32_t, base_addr + 0x44, ro, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x44, ro, 0x00 >;
   ...
   */
  struct FCSWD_CTL
  : public reg< uint32_t, base_addr + 0x50, ro, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0x50, ro, 0x0000 >;
   ...
   */
  struct DBWDT_CTL
  : public reg< uint32_t, base_addr + 0x54, rw, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x54, rw, 0x00 >;
   ...
   */
  struct INT_ENR
  : public reg< uint32_t, base_addr + 0x60, rw, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x60, rw, 0x00 >;
   ...
   */
  struct INT_STR
  : public reg< uint32_t, base_addr + 0x64, ro, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x64, ro, 0x00 >;
   ...
   */
  struct INT_CLR
  : public reg< uint32_t, base_addr + 0x68, wo, 0x00 >
  {
    using type = reg< uint32_t, base_addr + 0x68, wo, 0x00 >;
