...
struct INTREQ
{
   ...
   */
  struct ODDPKS1
  : public reg< uint8_t, base_addr + 0x14, rw, 0x0 >
  {
    using type = reg< uint8_t, base_addr + 0x14, rw, 0x0 >;

    using ODDPKS14  = regbits< type,  4,  1 >;  /**< "If the transfer destination address of DMAC is USB.EP5DT, the bit width of the last transfer data is converted to Byte."  */
    using ODDPKS13  = regbits< type,  3,  1 >;  /**< "If the transfer destination address of DMAC is USB.EP4DT, the bit width of the last transfer data is converted to Byte."  */
    using ODDPKS12  = regbits< type,  2,  1 >;  /**< "If the transfer destination address of DMAC is USB.EP3DT, the bit width of the last transfer data is converted to Byte."  */
    using ODDPKS11  = regbits< type,  1,  1 >;  /**< "If the transfer destination address of DMAC is USB.EP2DT, the bit width of the last transfer data is converted to Byte."  */
    using ODDPKS10  = regbits< type,  0,  1 >;  /**< "If the transfer destination address of DMAC is USB.EP1DT, the bit width of the last transfer data is converted to Byte."  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x110, rw, 0x0 >
  {
    ...
    using SELBIT  = regbits< type, 16,  8 >;  /**< Bit7 of the interrupt source is moved to bit7 of the relocate interrupt.  */
  ...
  : public reg< uint32_t, base_addr + 0x2f0, ro, 0x0 >
  {
    ...
    using IPLLINT  = regbits< type,  4,  1 >;  /**< PLL of I2S oscillation stabilization wait completion interrupt             */
  ...
  : public reg< uint32_t, base_addr + 0x348, ro, 0x0 >
  {
    ...
    using CAN1INT   = regbits< type,  4,  1 >;  /**< CAN-FD 1 interrupt request                        */
    using CAN0INT   = regbits< type,  3,  1 >;  /**< CAN-FD 0 interrupt request                        */
    using CANSEINT  = regbits< type,  2,  1 >;  /**< Single bit error interrupt request of the CAN-FD  */
    using CANDEINT  = regbits< type,  1,  1 >;  /**< Double bit error interrupt request of the CAN-FD  */
  ...
  {
    using type = reg< uint32_t, base_addr + 0x3c4, ro, 0x0 >;

    using CANDINT    = regbits< type,  5,  1 >;  /**< Interrupt request of DSTC transfer end interrupt of CAN-FD                  */
    using PCRCDINT   = regbits< type,  4,  1 >;  /**< Interrupt request of DSTC transfer end interrupt of Programmable CRC        */
    using QSPIDINT1  = regbits< type,  3,  1 >;  /**< Interrupt request of DSTC transfer end interrupt of Quad SPI(transmission)  */
    using QSPIDINT0  = regbits< type,  2,  1 >;  /**< Interrupt request of DSTC transfer end interrupt of Quad SPI(reception)     */
    using I2SDINT1   = regbits< type,  1,  1 >;  /**< Interrupt request of DSTC transfer end interrupt of I2S(transmission)       */
    using I2SDINT0   = regbits< type,  0,  1 >;  /**< Interrupt request of DSTC transfer end interrupt of I2S(reception)          */
  };
  ...
  : public reg< uint32_t, base_addr + 0x3c8, ro, 0x0 >
  {
    ...
    using RCEC0INT      = regbits< type,  5,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using USB_DRQ_INT4  = regbits< type,  4,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using USB_DRQ_INT3  = regbits< type,  3,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using USB_DRQ_INT2  = regbits< type,  2,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using USB_DRQ_INT1  = regbits< type,  1,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using USB_DRQ_INT0  = regbits< type,  0,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x3cc, ro, 0x0 >
  {
    ...
    using RCEC1INT  = regbits< type,  6,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using USB_INT5  = regbits< type,  5,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using USB_INT4  = regbits< type,  4,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using USB_INT3  = regbits< type,  3,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using USB_INT2  = regbits< type,  2,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using USB_INT1  = regbits< type,  1,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using USB_INT0  = regbits< type,  0,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
  };
  ...
  {
    using type = reg< uint32_t, base_addr + 0x3d0, ro, 0x0 >;

    using QSPIINT2  = regbits< type,  2,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using QSPIINT1  = regbits< type,  1,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using QSPIINT0  = regbits< type,  0,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
  };
  ...
  {
    using type = reg< uint32_t, base_addr + 0x3d8, ro, 0x0 >;

    using PRGCRC  = regbits< type,  1,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using I2SINT  = regbits< type,  0,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x3dc, ro, 0x0 >
  {
    ...
    using SDINT1  = regbits< type,  1,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using SDINT0  = regbits< type,  0,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x3e0, ro, 0x0 >
  {
    ...
    using FLINT  = regbits< type,  0,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x3e4, ro, 0x0 >
  {
    ...
    using MFSRINT  = regbits< type,  0,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x3e8, ro, 0x0 >
  {
    ...
    using MFSINT1  = regbits< type,  1,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
    using MFSINT0  = regbits< type,  0,  1 >;  /**< ERROR!!!!!!!!!!!!!!!!!!!!  */
  };
