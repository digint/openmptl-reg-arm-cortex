...
#ifndef ARCH_REG_QPRC2_HPP_INCLUDED
#define ARCH_REG_QPRC2_HPP_INCLUDED
...
struct QPRC2
{
  static constexpr reg_addr_t base_addr = 0x40026080;
  ...
  : public reg< uint16_t, base_addr + 0x1c, rw, 0x0000 >
  {
    ...
    using PEC     = regbits< type,  3,  1 >;  /**< Phase edge change bit                */
...
#endif // ARCH_REG_QPRC2_HPP_INCLUDED
