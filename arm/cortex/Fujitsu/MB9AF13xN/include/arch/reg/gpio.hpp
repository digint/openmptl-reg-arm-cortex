...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Fujitsu/MB9AF13xN.svd"
//
//  name: MB9AF13xN
//  version: 1.8
...
struct GPIO
{
  ...
  : public reg< uint32_t, base_addr + 0x38, rw, 0x0 >
  {
    ...
    using P3  = regbits< type,  3,  1 >;  /**< Bit2 of PFRE  */
    using P2  = regbits< type,  2,  1 >;  /**< Bit1 of PFRE  */
  ...
  : public reg< uint32_t, base_addr + 0x620, rw, 0x0 >
  {
    ...
    using CTS4S  = regbits< type,  2,  2 >;  /**< CTS4S Input Select bits        */
    using RTS4E  = regbits< type,  0,  2 >;  /**< RTS4E Output Select bits       */
  };
   ...
   */
  struct PZR0
  : public reg< uint32_t, base_addr + 0x700, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x700, rw, 0x0 >;
   ...
   */
  struct PZR6
  : public reg< uint32_t, base_addr + 0x718, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x718, rw, 0x0 >;
   ...
   */
  struct PZR8
  : public reg< uint32_t, base_addr + 0x720, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x720, rw, 0x0 >;

    using P2  = regbits< type,  2,  1 >;  /**< Bit2 of PZR8  */
    using P1  = regbits< type,  1,  1 >;  /**< Bit1 of PZR8  */
  };
};
} // namespace mptl
