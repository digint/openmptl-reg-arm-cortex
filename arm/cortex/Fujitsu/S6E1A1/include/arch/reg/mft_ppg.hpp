...
struct MFT_PPG
{
   ...
   */
  struct COMP0
  : public reg< uint8_t, base_addr + 0x9, rw, 0x00 >
  {
  };
   ...
   */
  struct COMP4
  : public reg< uint32_t, base_addr + 0x11, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct COMP1
  : public reg< uint32_t, base_addr + 0x29, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct COMP5
  : public reg< uint32_t, base_addr + 0x31, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct COMP8
  : public reg< uint32_t, base_addr + 0x49, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct COMP12
  : public reg< uint32_t, base_addr + 0x51, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct TRG1
  : public reg< uint16_t, base_addr + 0x140, rw, 0x0000 >
  {
    using type = reg< uint16_t, base_addr + 0x140, rw, 0x0000 >;
   ...
   */
  struct REVC1
  : public reg< uint16_t, base_addr + 0x144, rw, 0x0000 >
  {
    using type = reg< uint16_t, base_addr + 0x144, rw, 0x0000 >;
  ...
  : public reg< uint8_t, base_addr + 0x218, rw, 0x00 >
  {
    ...
    using STRG2  = regbits< type,  5,  1 >;  /**< Select trigger bit for PPG2                */
    using EDGE2  = regbits< type,  4,  1 >;  /**< Start Effective Level Select bit for PPG2  */
    using STRG0  = regbits< type,  1,  1 >;  /**< Select trigger bit for PPG0                */
    using EDGE0  = regbits< type,  0,  1 >;  /**< Start Effective Level Select bit for PPG0  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x258, rw, 0x00 >
  {
    ...
    using STRG6  = regbits< type,  5,  1 >;  /**< Select trigger bit for PPG6                */
    using EDGE6  = regbits< type,  4,  1 >;  /**< Start Effective Level Select bit for PPG6  */
    using STRG4  = regbits< type,  1,  1 >;  /**< Select trigger bit for PPG4                */
    using EDGE4  = regbits< type,  0,  1 >;  /**< Start Effective Level Select bit for PPG4  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x298, rw, 0x00 >
  {
    ...
    using STRG10  = regbits< type,  5,  1 >;  /**< Select trigger bit for PPG10                */
    using EDGE10  = regbits< type,  4,  1 >;  /**< Start Effective Level Select bit for PPG10  */
    using STRG8   = regbits< type,  1,  1 >;  /**< Select trigger bit for PPG8                 */
    using EDGE8   = regbits< type,  0,  1 >;  /**< Start Effective Level Select bit for PPG8   */
  };
  ...
  : public reg< uint8_t, base_addr + 0x2d8, rw, 0x00 >
  {
    ...
    using STRG14  = regbits< type,  5,  1 >;  /**< Select trigger bit for PPG14                */
    using EDGE14  = regbits< type,  4,  1 >;  /**< Start Effective Level Select bit for PPG14  */
    using STRG12  = regbits< type,  1,  1 >;  /**< Select trigger bit for PPG12                */
    using EDGE12  = regbits< type,  0,  1 >;  /**< Start Effective Level Select bit for PPG12  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x318, rw, 0x00 >
  {
    ...
    using STRG18  = regbits< type,  5,  1 >;  /**< Select trigger bit for PPG18                */
    using EDGE18  = regbits< type,  4,  1 >;  /**< Start Effective Level Select bit for PPG18  */
    using STRG16  = regbits< type,  1,  1 >;  /**< Select trigger bit for PPG16                */
    using EDGE16  = regbits< type,  0,  1 >;  /**< Start Effective Level Select bit for PPG16  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x358, rw, 0x00 >
  {
    ...
    using STRG22  = regbits< type,  5,  1 >;  /**< Select trigger bit for PPG22                */
    using EDGE22  = regbits< type,  4,  1 >;  /**< Start Effective Level Select bit for PPG22  */
    using STRG20  = regbits< type,  1,  1 >;  /**< Select trigger bit for PPG20                */
    using EDGE20  = regbits< type,  0,  1 >;  /**< Start Effective Level Select bit for PPG20  */
  };
