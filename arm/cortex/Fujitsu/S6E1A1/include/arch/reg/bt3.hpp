...
#ifndef ARCH_REG_BT3_HPP_INCLUDED
#define ARCH_REG_BT3_HPP_INCLUDED
...
struct BT3
{
  static constexpr reg_addr_t base_addr = 0x400250c0;
  ...
  : public reg< uint16_t, base_addr + 0xc, rw, 0x0000 >
  {
    ...
    using CKS    = regbits< type, 12,  3 >;  /**< Count clock selection bits         */
  ...
  : public reg< uint16_t, base_addr + 0xc, rw, 0x0000 >
  {
    ...
    using CKS   = regbits< type, 12,  3 >;  /**< Count clock selection bits                                   */
    using EGS   = regbits< type,  8,  2 >;  /**< Slection bits of trigger input edge and gate function level  */
  ...
  : public reg< uint8_t, base_addr + 0x11, rw, 0x00 >
  {
    ...
    using GATE  = regbits< type,  7,  1 >;  /**< Gate Input Enable bit      */
    using CKS3  = regbits< type,  0,  1 >;  /**< Count clock selection bit  */
  };
...
#endif // ARCH_REG_BT3_HPP_INCLUDED
