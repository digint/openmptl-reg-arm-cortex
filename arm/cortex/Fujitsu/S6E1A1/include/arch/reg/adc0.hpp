...
struct ADC0
{
  ...
  : public reg< uint8_t, base_addr + 0x8, rw, 0x00 >
  {
    ...
    using SFS  = regbits< type,  0,  4 >;  /**< Scan conversion FIFO stage count setting bits  */
  };
   ...
   */
  struct SCFD
  : public reg< uint32_t, base_addr + 0xc, ro, 0x00001000 >
  {
    using type = reg< uint32_t, base_addr + 0xc, ro, 0x00001000 >;
  ...
  : public reg< uint8_t, base_addr + 0x11, rw, 0x00 >
  {
    ...
    using AN31  = regbits< type,  7,  1 >;  /**< AN31 analog input selection bit  */
    using AN30  = regbits< type,  6,  1 >;  /**< AN30 analog input selection bit  */
    using AN29  = regbits< type,  5,  1 >;  /**< AN29 analog input selection bit  */
    using AN28  = regbits< type,  4,  1 >;  /**< AN28 analog input selection bit  */
    using AN27  = regbits< type,  3,  1 >;  /**< AN27 analog input selection bit  */
    using AN26  = regbits< type,  2,  1 >;  /**< AN26 analog input selection bit  */
    using AN25  = regbits< type,  1,  1 >;  /**< AN25 analog input selection bit  */
    using AN24  = regbits< type,  0,  1 >;  /**< AN24 analog input selection bit  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x10, rw, 0x00 >
  {
    ...
    using AN23  = regbits< type,  7,  1 >;  /**< AN23 analog input selection bit  */
    using AN22  = regbits< type,  6,  1 >;  /**< AN22 analog input selection bit  */
    using AN21  = regbits< type,  5,  1 >;  /**< AN21 analog input selection bit  */
    using AN20  = regbits< type,  4,  1 >;  /**< AN20 analog input selection bit  */
    using AN19  = regbits< type,  3,  1 >;  /**< AN19 analog input selection bit  */
    using AN18  = regbits< type,  2,  1 >;  /**< AN18 analog input selection bit  */
    using AN17  = regbits< type,  1,  1 >;  /**< AN17 analog input selection bit  */
    using AN16  = regbits< type,  0,  1 >;  /**< AN16 analog input selection bit  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x15, rw, 0x00 >
  {
    ...
    using AN15  = regbits< type,  7,  1 >;  /**< AN15 analog input selection bit  */
    using AN14  = regbits< type,  6,  1 >;  /**< AN14 analog input selection bit  */
    using AN13  = regbits< type,  5,  1 >;  /**< AN13 analog input selection bit  */
    using AN12  = regbits< type,  4,  1 >;  /**< AN12 analog input selection bit  */
    using AN11  = regbits< type,  3,  1 >;  /**< AN11 analog input selection bit  */
    using AN10  = regbits< type,  2,  1 >;  /**< AN10 analog input selection bit  */
    using AN9   = regbits< type,  1,  1 >;  /**< AN9 analog input selection bit   */
    using AN8   = regbits< type,  0,  1 >;  /**< AN8 analog input selection bit   */
  };
  ...
  : public reg< uint8_t, base_addr + 0x14, rw, 0x00 >
  {
    ...
    using AN7  = regbits< type,  7,  1 >;  /**< AN7 analog input selection bit  */
    using AN6  = regbits< type,  6,  1 >;  /**< AN6 analog input selection bit  */
    using AN5  = regbits< type,  5,  1 >;  /**< AN5 analog input selection bit  */
    using AN4  = regbits< type,  4,  1 >;  /**< AN4 analog input selection bit  */
    using AN3  = regbits< type,  3,  1 >;  /**< AN3 analog input selection bit  */
    using AN2  = regbits< type,  2,  1 >;  /**< AN2 analog input selection bit  */
    using AN1  = regbits< type,  1,  1 >;  /**< AN1 analog input selection bit  */
    using AN0  = regbits< type,  0,  1 >;  /**< AN0 analog input selection bit  */
  };
   ...
   */
  struct PCFD
  : public reg< uint32_t, base_addr + 0x1c, ro, 0x00001000 >
  {
    using type = reg< uint32_t, base_addr + 0x1c, ro, 0x00001000 >;
  ...
  : public reg< uint16_t, base_addr + 0x26, rw, 0x0000 >
  {
    ...
    using CMAD  = regbits< type,  6, 10 >;  /**< A/D conversion compare value setting bits  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x29, rw, 0x00 >
  {
    ...
    using TS31  = regbits< type,  7,  1 >;  /**< AN31 sampling time selection bit  */
    using TS30  = regbits< type,  6,  1 >;  /**< AN30 sampling time selection bit  */
    using TS29  = regbits< type,  5,  1 >;  /**< AN29 sampling time selection bit  */
    using TS28  = regbits< type,  4,  1 >;  /**< AN28 sampling time selection bit  */
    using TS27  = regbits< type,  3,  1 >;  /**< AN27 sampling time selection bit  */
    using TS26  = regbits< type,  2,  1 >;  /**< AN26 sampling time selection bit  */
    using TS25  = regbits< type,  1,  1 >;  /**< AN25 sampling time selection bit  */
    using TS24  = regbits< type,  0,  1 >;  /**< AN24 sampling time selection bit  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x28, rw, 0x00 >
  {
    ...
    using TS23  = regbits< type,  7,  1 >;  /**< AN23 sampling time selection bit  */
    using TS22  = regbits< type,  6,  1 >;  /**< AN22 sampling time selection bit  */
    using TS21  = regbits< type,  5,  1 >;  /**< AN21 sampling time selection bit  */
    using TS20  = regbits< type,  4,  1 >;  /**< AN20 sampling time selection bit  */
    using TS19  = regbits< type,  3,  1 >;  /**< AN19 sampling time selection bit  */
    using TS18  = regbits< type,  2,  1 >;  /**< AN18 sampling time selection bit  */
    using TS17  = regbits< type,  1,  1 >;  /**< AN17 sampling time selection bit  */
    using TS16  = regbits< type,  0,  1 >;  /**< AN16 sampling time selection bit  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x2d, rw, 0x00 >
  {
    ...
    using TS15  = regbits< type,  7,  1 >;  /**< AN15 sampling time selection bit  */
    using TS14  = regbits< type,  6,  1 >;  /**< AN14 sampling time selection bit  */
    using TS13  = regbits< type,  5,  1 >;  /**< AN13 sampling time selection bit  */
    using TS12  = regbits< type,  4,  1 >;  /**< AN12 sampling time selection bit  */
    using TS11  = regbits< type,  3,  1 >;  /**< AN11 sampling time selection bit  */
    using TS10  = regbits< type,  2,  1 >;  /**< AN10 sampling time selection bit  */
    using TS9   = regbits< type,  1,  1 >;  /**< AN9 sampling time selection bit   */
    using TS8   = regbits< type,  0,  1 >;  /**< AN8 sampling time selection bit   */
  };
  ...
  : public reg< uint8_t, base_addr + 0x2c, rw, 0x00 >
  {
    ...
    using TS7  = regbits< type,  7,  1 >;  /**< AN7 sampling time selection bit  */
    using TS6  = regbits< type,  6,  1 >;  /**< AN6 sampling time selection bit  */
    using TS5  = regbits< type,  5,  1 >;  /**< AN5 sampling time selection bit  */
    using TS4  = regbits< type,  4,  1 >;  /**< AN4 sampling time selection bit  */
    using TS3  = regbits< type,  3,  1 >;  /**< AN3 sampling time selection bit  */
    using TS2  = regbits< type,  2,  1 >;  /**< AN2 sampling time selection bit  */
    using TS1  = regbits< type,  1,  1 >;  /**< AN1 sampling time selection bit  */
    using TS0  = regbits< type,  0,  1 >;  /**< AN0 sampling time selection bit  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x34, rw, 0x07 >
  {
    ...
    using CT  = regbits< type,  0,  8 >;  /**< Frequency division ratio setting bits  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x38, rw, 0x00 >
  {
    ...
    using PRTSL_ = regbits< type,  0,  4 >;  /**< Priority conversion timer trigger selection bits  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x39, rw, 0x00 >
  {
    ...
    using SCTSL_ = regbits< type,  0,  4 >;  /**< Scan conversion timer trigger selection bits  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x3c, rw, 0xFF00 >
  {
    ...
    using ENBLTIME  = regbits< type,  8,  8 >;  /**< Operation enable state transition cycle selection bits  */
  ...
  : public reg< uint32_t, base_addr + 0x44, rw, 0x00000000 >
  {
    ...
    using RCINT  = regbits< type,  0,  1 >;  /**< Range comparison interrupt factor flag bit  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x48, rw, 0x00000000 >
  {
    ...
    using RCOOF  = regbits< type,  0,  1 >;  /**< Threshold excess flag bit  */
  };
   ...
   */
  struct WCMPCR
  : public reg< uint8_t, base_addr + 0x4c, rw, 0x20 >
  {
    using type = reg< uint8_t, base_addr + 0x4c, rw, 0x20 >;

    using RCOCD   = regbits< type,  5,  3 >;  /**< Continuous detection specification count/state indication bits  */
    using RCOIRS  = regbits< type,  4,  1 >;  /**< Selection bit of within-range and out-of- range confirmation    */
    using RCOIE   = regbits< type,  3,  1 >;  /**< Range comparison interrupt request enable bit                   */
    using RCOE    = regbits< type,  2,  1 >;  /**< Range comparison execution enable bit                           */
  };
  ...
  : public reg< uint8_t, base_addr + 0x4d, rw, 0x00 >
  {
    ...
    using WCMD  = regbits< type,  5,  1 >;  /**< Comparison mode select bit              */
    using WCCH  = regbits< type,  0,  5 >;  /**< Comparison target analog input channel  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x50, rw, 0x0000 >
  {
    ...
    using CMLD  = regbits< type,  6, 10 >;  /**< Lower limit threshold bits  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x52, rw, 0x0000 >
  {
    ...
    using CMHD  = regbits< type,  6, 10 >;  /**< Upper limit threshold bits  */
  };
};
} // namespace mptl
