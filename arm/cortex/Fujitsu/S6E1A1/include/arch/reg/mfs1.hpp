...
#ifndef ARCH_REG_MFS1_HPP_INCLUDED
#define ARCH_REG_MFS1_HPP_INCLUDED
...
struct MFS1
{
  static constexpr reg_addr_t base_addr = 0x40038100;
  ...
  {
    using type = reg< uint16_t, base_addr + 0x8, wo, 0x01FF >;
  ...
  : public reg< uint16_t, base_addr + 0xc, rw, 0x0000 >
  {
    ...
    using BGR1  = regbits< type,  8,  7 >;  /**< Baud Rate Generator Register 1  */
    using BGR0  = regbits< type,  0,  8 >;  /**< Baud Rate Generator Register 0  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x4, rw, 0x00 >
  {
    ...
    using L3    = regbits< type,  6,  1 >;  /**< Bit3 of Data length select bits          */
    using CSFE  = regbits< type,  5,  1 >;  /**< Serial Chip Select Format enable bit     */
    using WT    = regbits< type,  3,  2 >;  /**< Data transmit/received wait select bits  */
    using L     = regbits< type,  0,  3 >;  /**< Bit0-2 of Data length select bits        */
  };
  ...
  : public reg< uint16_t, base_addr + 0x8, ro, 0x0000 >
  {
    ...
    using D  = regbits< type,  0, 16 >;  /**< Data  */
  };
   ...
   */
  struct CSIO_TDR
  : public reg< uint16_t, base_addr + 0x8, wo, 0xFFFF >
  {
    using type = reg< uint16_t, base_addr + 0x8, wo, 0xFFFF >;
  ...
  : public reg< uint8_t, base_addr + 0x1c, rw, 0x00 >
  {
    ...
    using CSHD  = regbits< type,  0,  8 >;  /**< Serial Chip Select Hold Delay bits  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x1d, rw, 0x00 >
  {
    ...
    using CSSU  = regbits< type,  0,  8 >;  /**< Serial Chip Select Setup Delay bits  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x20, rw, 0x0000 >
  {
    ...
    using CSDS  = regbits< type,  0, 16 >;  /**< Serial Chip Deselect bits  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x24, rw, 0x0000 >
  {
    ...
    using TBEEN  = regbits< type, 13,  1 >;  /**< Transfer Byte Error Enable bit         */
    using CSEIE  = regbits< type, 12,  1 >;  /**< Chip Select Error Interupt Enable bit  */
    using CSE    = regbits< type, 11,  1 >;  /**< Chip Select Error Flag                 */
    using TINT   = regbits< type,  8,  1 >;  /**< Timer Interrupt Flag                   */
    using TINTE  = regbits< type,  7,  1 >;  /**< Timer Interrupt Enable bit             */
    using TSYNE  = regbits< type,  6,  1 >;  /**< Synchronous Transmission Enable bit    */
    using TDIV   = regbits< type,  1,  4 >;  /**< Timer Operation Clock Division bit     */
    using TMRE   = regbits< type,  0,  1 >;  /**< Serial Timer Enable bit                */
  };
   ...
   */
  struct CSIO_STMR
  : public reg< uint16_t, base_addr + 0x28, ro, 0x0000 >
  {
    using type = reg< uint16_t, base_addr + 0x28, ro, 0x0000 >;

    using TM  = regbits< type,  0, 16 >;  /**< Timer Data bits  */
  };
  ...
  {
    using type = reg< uint16_t, base_addr + 0x2c, rw, 0x0000 >;

    using TC  = regbits< type,  0, 16 >;  /**< Compare bits  */
  };
   ...
   */
  struct CSIO_SCSCR
  : public reg< uint16_t, base_addr + 0x30, rw, 0x0020 >
  {
    using type = reg< uint16_t, base_addr + 0x30, rw, 0x0020 >;

    using SST    = regbits< type, 14,  2 >;  /**< Serial Chip Select Active Start bit                     */
    using SED    = regbits< type, 12,  2 >;  /**< Serial Chip Select Active End bit                       */
    using SCD    = regbits< type, 10,  2 >;  /**< Serial Chip Select Active Display bit                   */
    using SCAM   = regbits< type,  9,  1 >;  /**< Serial Chip Select Active Hold bit                      */
    using CDIV   = regbits< type,  6,  3 >;  /**< Serial Chip Select Timing Operation Clock Division bit  */
    using CSLVL  = regbits< type,  5,  1 >;  /**< Serial Chip Select Level Setting bit                    */
    using CSEN3  = regbits< type,  4,  1 >;  /**< Serial Chip Select Enable bit                           */
    using CSEN2  = regbits< type,  3,  1 >;  /**< Serial Chip Select Enable bit                           */
    using CSEN1  = regbits< type,  2,  1 >;  /**< Serial Chip Select Enable bit                           */
    using CSEN0  = regbits< type,  1,  1 >;  /**< Serial Chip Select Enable bit                           */
    using CSOE   = regbits< type,  0,  1 >;  /**< Serial Chip Select Output Enable bit                    */
  };
   ...
   */
  struct CSIO_SCSFR0
  : public reg< uint8_t, base_addr + 0x34, rw, 0x80 >
  {
    using type = reg< uint8_t, base_addr + 0x34, rw, 0x80 >;

    using CS1CSLVL  = regbits< type,  7,  1 >;  /**< Serial Chip Select 1 Level Setting bit                 */
    using CS1SCINV  = regbits< type,  6,  1 >;  /**< Serial Clock Invert bit of Serial Chip Select 1        */
    using CS1SPI    = regbits< type,  5,  1 >;  /**< SPI corresponding bit of Serial Chip Select 1          */
    using CS1BDS    = regbits< type,  4,  1 >;  /**< Transfer direction select bit of Serial Chip Select 1  */
    using CS1L      = regbits< type,  0,  4 >;  /**< Data length select bits of Serial Chip Select 1        */
  };
   ...
   */
  struct CSIO_SCSFR1
  : public reg< uint8_t, base_addr + 0x35, rw, 0x80 >
  {
    using type = reg< uint8_t, base_addr + 0x35, rw, 0x80 >;

    using CS2CSLVL  = regbits< type,  7,  1 >;  /**< Serial Chip Select 2 Level Setting bit                 */
    using CS2SCINV  = regbits< type,  6,  1 >;  /**< Serial Clock Invert bit of Serial Chip Select 2        */
    using CS2SPI    = regbits< type,  5,  1 >;  /**< SPI corresponding bit of Serial Chip Select 2          */
    using CS2BDS    = regbits< type,  4,  1 >;  /**< Transfer direction select bit of Serial Chip Select 2  */
    using CS2L      = regbits< type,  0,  4 >;  /**< Data length select bits of Serial Chip Select 2        */
  };
   ...
   */
  struct CSIO_SCSFR2
  : public reg< uint8_t, base_addr + 0x38, rw, 0x80 >
  {
    using type = reg< uint8_t, base_addr + 0x38, rw, 0x80 >;

    using CS0CSLVL  = regbits< type,  7,  1 >;  /**< Serial Chip Select 0 Level Setting bit                 */
    using CS0SCINV  = regbits< type,  6,  1 >;  /**< Serial Clock Invert bit of Serial Chip Select 0        */
    using CS0SPI    = regbits< type,  5,  1 >;  /**< SPI corresponding bit of Serial Chip Select 0          */
    using CS0BDS    = regbits< type,  4,  1 >;  /**< Transfer direction select bit of Serial Chip Select 0  */
    using CS0L      = regbits< type,  0,  4 >;  /**< Data length select bits of Serial Chip Select 0        */
  };
  ...
  {
    using type = reg< uint16_t, base_addr + 0x8, wo, 0x00FF >;
  ...
  : public reg< uint8_t, base_addr + 0x1c, rw, 0x00 >
  {
    ...
    using NFT  = regbits< type,  0,  5 >;  /**< Noise Filter Time Select bits  */
  };
...
#endif // ARCH_REG_MFS1_HPP_INCLUDED
