...
#ifndef ARCH_REG_PCG_HPP_INCLUDED
#define ARCH_REG_PCG_HPP_INCLUDED
...
struct PCG
{
   ...
   */
  struct CKEN0
  : public reg< uint32_t, base_addr + 0x0, rw, 0x110FFFFF >
  {
    using type = reg< uint32_t, base_addr + 0x0, rw, 0x110FFFFF >;

    using GIOCK    = regbits< type, 28,  1 >;  /**< Software clock control of GPIO/Fast GPIO function                                        */
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0x000F0F0F >
  {
    ...
    using QDUCK3  = regbits< type, 19,  1 >;  /**< Settings for operation clock supply and gating of quad counter unit 3                         */
    using QDUCK2  = regbits< type, 18,  1 >;  /**< Settings for operation clock supply and gating of quad counter unit 2                         */
    using QDUCK1  = regbits< type, 17,  1 >;  /**< Settings for operation clock supply and gating of quad counter unit 1                         */
    using QDUCK0  = regbits< type, 16,  1 >;  /**< Settings for operation clock supply and gating of quad counter unit 0                         */
  ...
  : public reg< uint32_t, base_addr + 0x20, rw, 0x00000000 >
  {
    ...
    using CANCK1  = regbits< type,  5,  1 >;  /**< Peripheral Function Clock Control Register 2  */
    using CANCK0  = regbits< type,  4,  1 >;  /**< $                                             */
  };
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x00000000 >
  {
    ...
    using CANRST1  = regbits< type,  5,  1 >;  /**< Peripheral Function Reset Control Register 2  */
    using CANRST0  = regbits< type,  4,  1 >;  /**< $                                             */
  };
};
} // namespace mptl

#endif // ARCH_REG_PCG_HPP_INCLUDED
