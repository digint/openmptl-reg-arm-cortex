...
struct RTC
{
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x00000000 >
  {
    ...
    using TM  = regbits< type,  0, 18 >;  /**< Timer setting register  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x21, ro, 0x00 >
  {
    ...
    using WTCLKM_ = regbits< type,  0,  2 >;  /**< Clock selection status bits  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x24, rw, 0x0000 >
  {
    ...
    using WTCAL_ = regbits< type,  0, 10 >;  /**< Frequency correction value setting bits  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x28, rw, 0x00 >
  {
    ...
    using WTDIV_ = regbits< type,  0,  4 >;  /**< Divider ratio setting bits  */
  };
