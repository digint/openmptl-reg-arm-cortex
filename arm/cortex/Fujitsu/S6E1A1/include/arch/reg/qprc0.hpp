...
#ifndef ARCH_REG_QPRC0_HPP_INCLUDED
#define ARCH_REG_QPRC0_HPP_INCLUDED
...
struct QPRC0
{
  ...
  : public reg< uint8_t, base_addr + 0x19, rw, 0x00 >
  {
    ...
    using CGE   = regbits< type,  6,  2 >;  /**< Detection edge selection bits      */
    using BES   = regbits< type,  4,  2 >;  /**< BIN detection edge selection bits  */
    using AES   = regbits< type,  2,  2 >;  /**< AIN detection edge selection bits  */
    using PCRM  = regbits< type,  0,  2 >;  /**< Position counter reset mask bits   */
  };
  ...
  : public reg< uint32_t, base_addr + 0x3c, ro, 0x00000000 >
  {
    ...
    using QRCRR  = regbits< type, 16, 16 >;  /**< Quad counter rotation count display bit  */
    using QPCRR  = regbits< type,  0, 16 >;  /**< Quad counter position count display bit  */
  };
};
} // namespace mptl

#endif // ARCH_REG_QPRC0_HPP_INCLUDED
