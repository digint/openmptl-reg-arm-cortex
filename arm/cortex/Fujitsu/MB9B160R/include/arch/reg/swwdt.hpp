...
struct SWWDT
{
  ...
  : public reg< uint8_t, base_addr + 0x8, rw, 0x00 >
  {
    ...
    using SPM    = regbits< type,  4,  1 >;  /**< Software Watchdog window watchdog mode enable bit          */
    using TWD    = regbits< type,  2,  2 >;  /**< Timing window setting bit of the software watchdog         */
  ...
  : public reg< uint8_t, base_addr + 0x18, rw, 0x00 >
  {
    ...
    using TGR  = regbits< type,  0,  1 >;  /**< Software watchdog trigger type bit  */
  };
