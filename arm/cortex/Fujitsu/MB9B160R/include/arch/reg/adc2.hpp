...
struct ADC2
{
  static constexpr reg_addr_t base_addr = 0x40027200;
   ...
   */
  struct WCMRCIF
  : public reg< uint8_t, base_addr + 0x48, rw, 0x00 >
  {
    using type = reg< uint8_t, base_addr + 0x48, rw, 0x00 >;

    using RCINT  = regbits< type,  0,  1 >;  /**< Range comparison interrupt factor flag  */
  };
