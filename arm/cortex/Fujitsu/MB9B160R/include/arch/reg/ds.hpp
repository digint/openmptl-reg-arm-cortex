...
struct DS
{
  ...
  : public reg< uint16_t, base_addr + 0x708, ro, 0x0000 >
  {
    ...
    using WUI5   = regbits< type,  7,  1 >;  /**< WKUP pin input return bit 5  */
    using WUI4   = regbits< type,  6,  1 >;  /**< WKUP pin input return bit 4  */
  ...
  : public reg< uint16_t, base_addr + 0x70c, rw, 0x0000 >
  {
    ...
    using WUI5E  = regbits< type,  7,  1 >;  /**< WKUP pin input return enable bit 5  */
    using WUI4E  = regbits< type,  6,  1 >;  /**< WKUP pin input return enable bit 4  */
  ...
  : public reg< uint8_t, base_addr + 0x710, rw, 0x00 >
  {
    ...
    using WUI5LV  = regbits< type,  4,  1 >;  /**< WKUP pin input level select bit 5  */
    using WUI4LV  = regbits< type,  3,  1 >;  /**< WKUP pin input level select bit 4  */
