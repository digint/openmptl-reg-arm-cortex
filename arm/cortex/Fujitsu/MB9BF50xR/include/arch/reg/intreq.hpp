...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Fujitsu/MB9BF50xR.svd"
//
//  name: MB9BF50xR
//  version: 1.8
...
struct INTREQ
{
  ...
  : public reg< uint32_t, base_addr + 0x94, rw, 0x00000000 >
  {
    ...
    using CANINT  = regbits< type,  0,  1 >;  /**< Interrupt request of CAN ch.0  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x98, rw, 0x00000000 >
  {
    ...
    using CANINT  = regbits< type,  0,  1 >;  /**< Interrupt request of CAN ch.1  */
  };
