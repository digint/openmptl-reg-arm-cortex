...
#ifndef ARCH_REG_GPIOD_AHB_HPP_INCLUDED
#define ARCH_REG_GPIOD_AHB_HPP_INCLUDED
...
struct GPIOD_AHB
{
  ...
  : public reg< uint32_t, base_addr + 0x00000538, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using GPIO_SI_SUM  = regbits< type,  0,  1 >;  /**< Summary Interrupt  */
  };
};
} // namespace mptl

#endif // ARCH_REG_GPIOD_AHB_HPP_INCLUDED
