...
struct PWM1
{
  ...
  : public reg< uint32_t, base_addr + 0x00000014, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_INTEN_INTFAULT2  = regbits< type, 18,  1 >;  /**< Interrupt Fault 2      */
    using PWM_INTEN_INTFAULT3  = regbits< type, 19,  1 >;  /**< Interrupt Fault 3      */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000018, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_RIS_INTFAULT2  = regbits< type, 18,  1 >;  /**< Interrupt Fault PWM 2    */
    using PWM_RIS_INTFAULT3  = regbits< type, 19,  1 >;  /**< Interrupt Fault PWM 3    */
  };
  ...
  : public reg< uint32_t, base_addr + 0x0000001c, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_ISC_INTFAULT2  = regbits< type, 18,  1 >;  /**< FAULT2 Interrupt Asserted  */
    using PWM_ISC_INTFAULT3  = regbits< type, 19,  1 >;  /**< FAULT3 Interrupt Asserted  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000020, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_STATUS_FAULT2  = regbits< type,  2,  1 >;  /**< Generator 2 Fault Status  */
    using PWM_STATUS_FAULT3  = regbits< type,  3,  1 >;  /**< Generator 3 Fault Status  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000074, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_0_FLTSRC0_FAULT2  = regbits< type,  2,  1 >;  /**< Fault2 Input  */
    using PWM_0_FLTSRC0_FAULT3  = regbits< type,  3,  1 >;  /**< Fault3 Input  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x000000b4, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_1_FLTSRC0_FAULT2  = regbits< type,  2,  1 >;  /**< Fault2 Input  */
    using PWM_1_FLTSRC0_FAULT3  = regbits< type,  3,  1 >;  /**< Fault3 Input  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x000000f4, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_2_FLTSRC0_FAULT2  = regbits< type,  2,  1 >;  /**< Fault2 Input  */
    using PWM_2_FLTSRC0_FAULT3  = regbits< type,  3,  1 >;  /**< Fault3 Input  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000134, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_3_FLTSRC0_FAULT2  = regbits< type,  2,  1 >;  /**< Fault2        */
    using PWM_3_FLTSRC0_FAULT3  = regbits< type,  3,  1 >;  /**< Fault3 Input  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000800, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_0_FLTSEN_FAULT2  = regbits< type,  2,  1 >;  /**< Fault2 Sense  */
    using PWM_0_FLTSEN_FAULT3  = regbits< type,  3,  1 >;  /**< Fault3 Sense  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000804, ro, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_0_FLTSTAT0_FAULT2  = regbits< type,  2,  1 >;  /**< Fault Input 2  */
    using PWM_0_FLTSTAT0_FAULT3  = regbits< type,  3,  1 >;  /**< Fault Input 3  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000880, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_1_FLTSEN_FAULT2  = regbits< type,  2,  1 >;  /**< Fault2 Sense  */
    using PWM_1_FLTSEN_FAULT3  = regbits< type,  3,  1 >;  /**< Fault3 Sense  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000884, ro, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_1_FLTSTAT0_FAULT2  = regbits< type,  2,  1 >;  /**< Fault Input 2  */
    using PWM_1_FLTSTAT0_FAULT3  = regbits< type,  3,  1 >;  /**< Fault Input 3  */
  };
   ...
   */
  struct _2_FLTSEN
  : public reg< uint32_t, base_addr + 0x00000900, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    using type = reg< uint32_t, base_addr + 0x00000900, rw, 0 /* svd2hpp: missing resetValue! */ >;

    using PWM_2_FLTSEN_FAULT0  = regbits< type,  0,  1 >;  /**< Fault0 Sense  */
    using PWM_2_FLTSEN_FAULT1  = regbits< type,  1,  1 >;  /**< Fault1 Sense  */
    using PWM_2_FLTSEN_FAULT2  = regbits< type,  2,  1 >;  /**< Fault2 Sense  */
    using PWM_2_FLTSEN_FAULT3  = regbits< type,  3,  1 >;  /**< Fault3 Sense  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000904, ro, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_2_FLTSTAT0_FAULT2  = regbits< type,  2,  1 >;  /**< Fault Input 2  */
    using PWM_2_FLTSTAT0_FAULT3  = regbits< type,  3,  1 >;  /**< Fault Input 3  */
  };
   ...
   */
  struct _3_FLTSEN
  : public reg< uint32_t, base_addr + 0x00000980, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    using type = reg< uint32_t, base_addr + 0x00000980, rw, 0 /* svd2hpp: missing resetValue! */ >;

    using PWM_3_FLTSEN_FAULT0  = regbits< type,  0,  1 >;  /**< Fault0 Sense  */
    using PWM_3_FLTSEN_FAULT1  = regbits< type,  1,  1 >;  /**< Fault1 Sense  */
    using PWM_3_FLTSEN_FAULT2  = regbits< type,  2,  1 >;  /**< Fault2 Sense  */
    using PWM_3_FLTSEN_FAULT3  = regbits< type,  3,  1 >;  /**< Fault3 Sense  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000984, ro, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using PWM_3_FLTSTAT0_FAULT2  = regbits< type,  2,  1 >;  /**< Fault Input 2  */
    using PWM_3_FLTSTAT0_FAULT3  = regbits< type,  3,  1 >;  /**< Fault Input 3  */
  };
