...
using pwm0_fault  = irq_channel< 9>;    
using pwm0_0      = irq_channel<10>;    
using pwm0_1      = irq_channel<11>;    
using pwm0_2      = irq_channel<12>;    
using qei0        = irq_channel<13>;    
...
using qei1        = irq_channel<38>;    
using can0        = irq_channel<39>;    
using can1        = irq_channel<40>;    
using hib         = irq_channel<43>;    
using pwm0_3      = irq_channel<45>;    
...
using gpiom       = irq_channel<111>;    
using gpion       = irq_channel<112>;    
using gpiop0      = irq_channel<116>;    
using gpiop1      = irq_channel<117>;    
using gpiop2      = irq_channel<118>;    
using gpiop3      = irq_channel<119>;    
using gpiop4      = irq_channel<120>;    
using gpiop5      = irq_channel<121>;    
using gpiop6      = irq_channel<122>;    
using gpiop7      = irq_channel<123>;    
using gpioq0      = irq_channel<124>;    
using gpioq1      = irq_channel<125>;    
using gpioq2      = irq_channel<126>;    
using gpioq3      = irq_channel<127>;    
using gpioq4      = irq_channel<128>;    
using gpioq5      = irq_channel<129>;    
using gpioq6      = irq_channel<130>;    
using gpioq7      = irq_channel<131>;    
using pwm1_0      = irq_channel<134>;    
using pwm1_1      = irq_channel<135>;    
using pwm1_2      = irq_channel<136>;    
using pwm1_3      = irq_channel<137>;    
using pwm1_fault  = irq_channel<138>;    

static constexpr int numof_interrupt_channels = 139
