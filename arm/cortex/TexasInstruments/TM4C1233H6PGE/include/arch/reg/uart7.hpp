...
#ifndef ARCH_REG_UART7_HPP_INCLUDED
#define ARCH_REG_UART7_HPP_INCLUDED
...
struct UART7
{
  ...
  : public reg< uint32_t, base_addr + 0x00000018, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using UART_FR_DSR   = regbits< type,  1,  1 >;  /**< Data Set Ready            */
    using UART_FR_DCD   = regbits< type,  2,  1 >;  /**< Data Carrier Detect       */
    ...
    using UART_FR_RI    = regbits< type,  8,  1 >;  /**< Ring Indicator            */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000030, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using UART_CTL_DTR     = regbits< type, 10,  1 >;  /**< Data Terminal Ready          */
  ...
  : public reg< uint32_t, base_addr + 0x00000038, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using UART_IM_RIMIM   = regbits< type,  0,  1 >;  /**< UART Ring Indicator Modem Interrupt Mask       */
    using UART_IM_CTSMIM  = regbits< type,  1,  1 >;  /**< UART Clear to Send Modem Interrupt Mask        */
    using UART_IM_DCDMIM  = regbits< type,  2,  1 >;  /**< UART Data Carrier Detect Modem Interrupt Mask  */
    using UART_IM_DSRMIM  = regbits< type,  3,  1 >;  /**< UART Data Set Ready Modem Interrupt Mask       */
  ...
  : public reg< uint32_t, base_addr + 0x0000003c, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using UART_RIS_RIRIS    = regbits< type,  0,  1 >;  /**< UART Ring Indicator Modem Raw Interrupt Status       */
    using UART_RIS_CTSRIS   = regbits< type,  1,  1 >;  /**< UART Clear to Send Modem Raw Interrupt Status        */
    using UART_RIS_DCDRIS   = regbits< type,  2,  1 >;  /**< UART Data Carrier Detect Modem Raw Interrupt Status  */
    using UART_RIS_DSRRIS   = regbits< type,  3,  1 >;  /**< UART Data Set Ready Modem Raw Interrupt Status       */
  ...
  : public reg< uint32_t, base_addr + 0x00000040, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using UART_MIS_RIMIS    = regbits< type,  0,  1 >;  /**< UART Ring Indicator Modem Masked Interrupt Status       */
    using UART_MIS_CTSMIS   = regbits< type,  1,  1 >;  /**< UART Clear to Send Modem Masked Interrupt Status        */
    using UART_MIS_DCDMIS   = regbits< type,  2,  1 >;  /**< UART Data Carrier Detect Modem Masked Interrupt Status  */
    using UART_MIS_DSRMIS   = regbits< type,  3,  1 >;  /**< UART Data Set Ready Modem Masked Interrupt Status       */
  ...
  : public reg< uint32_t, base_addr + 0x00000044, wo, 0 >
  {
    ...
    using UART_ICR_RIMIC   = regbits< type,  0,  1 >;  /**< UART Ring Indicator Modem Interrupt Clear       */
    using UART_ICR_CTSMIC  = regbits< type,  1,  1 >;  /**< UART Clear to Send Modem Interrupt Clear        */
    using UART_ICR_DCDMIC  = regbits< type,  2,  1 >;  /**< UART Data Carrier Detect Modem Interrupt Clear  */
    using UART_ICR_DSRMIC  = regbits< type,  3,  1 >;  /**< UART Data Set Ready Modem Interrupt Clear       */
...
#endif // ARCH_REG_UART7_HPP_INCLUDED
