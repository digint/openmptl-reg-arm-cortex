...
struct FLASH_CTRL
{
  ...
  : public reg< uint32_t, base_addr + 0x00000000, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using FLASH_FMA_OFFSET  = regbits< type,  0, 18 >;  /**< Address Offset  */
  };
   ...
   */
  struct FMPRE2
  : public reg< uint32_t, base_addr + 0x00001208, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct FMPRE3
  : public reg< uint32_t, base_addr + 0x0000120c, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct FMPPE2
  : public reg< uint32_t, base_addr + 0x00001408, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
   ...
   */
  struct FMPPE3
  : public reg< uint32_t, base_addr + 0x0000140c, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
  };
};
} // namespace mptl
