...
struct ADC1
{
  ...
  : public reg< uint32_t, base_addr + 0x00000058, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using ADC_SSEMUX0_EMUX0  = regbits< type,  0,  1 >;  /**< 1st Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX0_EMUX1  = regbits< type,  4,  1 >;  /**< 2th Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX0_EMUX2  = regbits< type,  8,  1 >;  /**< 3rd Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX0_EMUX3  = regbits< type, 12,  1 >;  /**< 4th Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX0_EMUX4  = regbits< type, 16,  1 >;  /**< 5th Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX0_EMUX5  = regbits< type, 20,  1 >;  /**< 6th Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX0_EMUX6  = regbits< type, 24,  1 >;  /**< 7th Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX0_EMUX7  = regbits< type, 28,  1 >;  /**< 8th Sample Input Select (Upper Bit)  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000078, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using ADC_SSEMUX1_EMUX0  = regbits< type,  0,  1 >;  /**< 1st Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX1_EMUX1  = regbits< type,  4,  1 >;  /**< 2th Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX1_EMUX2  = regbits< type,  8,  1 >;  /**< 3rd Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX1_EMUX3  = regbits< type, 12,  1 >;  /**< 4th Sample Input Select (Upper Bit)  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x00000098, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using ADC_SSEMUX2_EMUX0  = regbits< type,  0,  1 >;  /**< 1st Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX2_EMUX1  = regbits< type,  4,  1 >;  /**< 2th Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX2_EMUX2  = regbits< type,  8,  1 >;  /**< 3rd Sample Input Select (Upper Bit)  */
    using ADC_SSEMUX2_EMUX3  = regbits< type, 12,  1 >;  /**< 4th Sample Input Select (Upper Bit)  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x000000b8, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using ADC_SSEMUX3_EMUX0  = regbits< type,  0,  1 >;  /**< 1st Sample Input Select (Upper Bit)  */
  };
