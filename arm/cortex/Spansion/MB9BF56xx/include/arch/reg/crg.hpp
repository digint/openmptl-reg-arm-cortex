...
struct CRG
{
  ...
  : public reg< uint8_t, base_addr + 0x30, rw, 0x00 >
  {
    ...
    using SOWT  = regbits< type,  4,  4 >;  /**< bitfield SOWT  */
  ...
  : public reg< uint16_t, base_addr + 0x48, rw, 0xFFFF >
  {
    ...
    using FWH  = regbits< type,  0, 16 >;  /**< bitfield FWH  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x4c, rw, 0x0000 >
  {
    ...
    using FWL  = regbits< type,  0, 16 >;  /**< bitfield FWL  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x50, ro, 0x0000 >
  {
    ...
    using FWD  = regbits< type,  0, 16 >;  /**< bitfield FWD  */
  };
};
} // namespace mptl
