...
struct MFS12
{
  ...
  : public reg< uint16_t, base_addr + 0x8, ro, 0x0000 >
  {
    ...
    using D  = regbits< type,  0,  9 >;  /**< bitfield D  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x5, rw, 0x03 >
  {
    ...
    using REC   = regbits< type,  7,  1 >;  /**< bitfield REC   */
    using AWC   = regbits< type,  4,  1 >;  /**< bitfield AWC   */
    using ORE   = regbits< type,  3,  1 >;  /**< bitfield ORE   */
    using RDRF  = regbits< type,  2,  1 >;  /**< bitfield RDRF  */
    using TDRE  = regbits< type,  1,  1 >;  /**< bitfield TDRE  */
    using TBI   = regbits< type,  0,  1 >;  /**< bitfield TBI   */
  ...
  : public reg< uint8_t, base_addr + 0x4, rw, 0x00 >
  {
    ...
    using L3   = regbits< type,  6,  1 >;  /**< bitfield L3   */
  ...
  : public reg< uint16_t, base_addr + 0x8, ro, 0x0000 >
  {
    ...
    using D  = regbits< type,  0, 16 >;  /**< bitfield D  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x1c, rw, 0x00 >
  {
    ...
    using CSHD  = regbits< type,  0,  8 >;  /**< bitfield CSHD  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x1d, rw, 0x00 >
  {
    ...
    using CSSU  = regbits< type,  0,  8 >;  /**< bitfield CSSU  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x20, rw, 0x0000 >
  {
    ...
    using CSDS  = regbits< type,  0, 16 >;  /**< bitfield CSDS  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x24, rw, 0x0000 >
  {
    ...
    using TBEEN  = regbits< type, 13,  1 >;  /**< bitfield TBEEN  */
    using CSEIE  = regbits< type, 12,  1 >;  /**< bitfield CSEIE  */
    using CSE    = regbits< type, 11,  1 >;  /**< bitfield CSE    */
    using TINT   = regbits< type,  8,  1 >;  /**< bitfield TINT   */
    using TINTE  = regbits< type,  7,  1 >;  /**< bitfield TINTE  */
    using TSYNE  = regbits< type,  6,  1 >;  /**< bitfield TSYNE  */
    using TDIV   = regbits< type,  1,  4 >;  /**< bitfield TDIV   */
    using TMRE   = regbits< type,  0,  1 >;  /**< bitfield TMRE   */
  };
  ...
  : public reg< uint16_t, base_addr + 0x28, ro, 0x0000 >
  {
    ...
    using TM  = regbits< type,  0, 16 >;  /**< bitfield TM  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x30, rw, 0x0020 >
  {
    ...
    using SCAM   = regbits< type,  9,  1 >;  /**< bitfield SCAM   */
    using CDIV   = regbits< type,  6,  3 >;  /**< bitfield CDIV   */
    using CSLVL  = regbits< type,  5,  1 >;  /**< bitfield CSLVL  */
    using CSEN0  = regbits< type,  1,  1 >;  /**< bitfield CSEN0  */
    using CSOE   = regbits< type,  0,  1 >;  /**< bitfield CSOE   */
  };
  ...
  : public reg< uint16_t, base_addr + 0x8, ro, 0x0000 >
  {
    ...
    using D  = regbits< type,  0,  8 >;  /**< bitfield D  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x1c, rw, 0x00 >
  {
    ...
    using NFT  = regbits< type,  0,  5 >;  /**< bitfield NFT  */
  };
