...
struct DS
{
  ...
  : public reg< uint8_t, base_addr + 0x4, rw, 0x01 >
  {
    ...
    using CECCKE  = regbits< type,  1,  1 >;  /**< bitfield CECCKE  */
  ...
  : public reg< uint16_t, base_addr + 0x708, ro, 0x0000 >
  {
    ...
    using WCEC1I  = regbits< type,  9,  1 >;  /**< bitfield WCEC1I  */
    using WCEC0I  = regbits< type,  8,  1 >;  /**< bitfield WCEC0I  */
  ...
  : public reg< uint16_t, base_addr + 0x70c, rw, 0x0000 >
  {
    ...
    using WCEC1E  = regbits< type,  9,  1 >;  /**< bitfield WCEC1E  */
    using WCEC0E  = regbits< type,  8,  1 >;  /**< bitfield WCEC0E  */
