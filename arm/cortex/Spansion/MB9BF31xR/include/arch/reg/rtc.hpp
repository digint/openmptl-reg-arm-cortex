...
struct RTC
{
  ...
  : public reg< uint8_t, base_addr + 0x11, rw, 0x00 >
  {
    ...
    using TMO  = regbits< type,  4,  1 >;  /**< the second digit in the month  */
  ...
  : public reg< uint8_t, base_addr + 0x19, rw, 0x00 >
  {
    ...
    using TAMO  = regbits< type,  4,  1 >;  /**< the second digit of the alarm-set month  */
  ...
  : public reg< uint8_t, base_addr + 0x24, rw, 0x00 >
  {
    ...
    using WTCAL_ = regbits< type,  0,  7 >;  /**< Frequency correction value  */
  };
