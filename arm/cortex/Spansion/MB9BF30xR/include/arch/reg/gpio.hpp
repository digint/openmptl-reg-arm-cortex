...
struct GPIO
{
   ...
   */
  struct PFR0
  : public reg< uint32_t, base_addr + 0x00, rw, 0x0000001F >
  {
    using type = reg< uint32_t, base_addr + 0x00, rw, 0x0000001F >;
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
    ...
    using P8  = regbits< type,  8,  1 >;  /**< Bit8 of PFR6  */
    using P7  = regbits< type,  7,  1 >;  /**< Bit7 of PFR6  */
    using P6  = regbits< type,  6,  1 >;  /**< Bit6 of PFR6  */
    using P5  = regbits< type,  5,  1 >;  /**< Bit5 of PFR6  */
    using P4  = regbits< type,  4,  1 >;  /**< Bit4 of PFR6  */
   ...
   */
  struct ADE
  : public reg< uint32_t, base_addr + 0x500, rw, 0x0000FFFF >
  {
    using type = reg< uint32_t, base_addr + 0x500, rw, 0x0000FFFF >;
  ...
  : public reg< uint32_t, base_addr + 0x600, rw, 0x00030000 >
  {
    ...
    using CROUTE    = regbits< type,  1,  1 >;  /**< Internal high-speed CR oscillation output function select bit  */
  ...
  : public reg< uint32_t, base_addr + 0x628, rw, 0x00000000 >
  {
    ...
    using TESTB   = regbits< type,  2,  1 >;  /**< UECLKE output select bit        */
   ...
   */
  struct SPSR
  : public reg< uint32_t, base_addr + 0x580, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0x580, rw, 0x00000000 >;
