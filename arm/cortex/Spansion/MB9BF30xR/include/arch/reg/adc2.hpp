...
struct ADC2
{
  ...
  : public reg< uint32_t, base_addr + 0xc, ro, 0x00000000 >
  {
    ...
    using CS    = regbits< type,  0,  5 >;  /**< Conversion input channel bits      */
  };
  ...
  : public reg< uint8_t, base_addr + 0x24, rw, 0x00 >
  {
    ...
    using CMD    = regbits< type,  5,  2 >;  /**< Comparison mode 1                                           */
    using CCH    = regbits< type,  0,  5 >;  /**< Comparison mode 0                                           */
  };
  ...
  : public reg< uint8_t, base_addr + 0x30, rw, 0x10 >
  {
    ...
    using ST    = regbits< type,  0,  5 >;  /**< Sampling time setting bits          */
  };
  ...
  : public reg< uint8_t, base_addr + 0x34, rw, 0x07 >
  {
    ...
    using CT  = regbits< type,  0,  3 >;  /**< Compare clock frequency division ratio setting bits  */
  };
