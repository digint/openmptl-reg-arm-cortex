...
struct MFT0
{
  ...
  : public reg< uint16_t, base_addr + 0x34, rw, 0x0000 >
  {
    ...
    using AD2E  = regbits< type,  2,  1 >;  /**< bitfield AD2E  */
    using AD1E  = regbits< type,  1,  1 >;  /**< bitfield AD1E  */
  ...
  : public reg< uint16_t, base_addr + 0xc0, rw, 0x0000 >
  {
    ...
    using AD1S  = regbits< type,  2,  2 >;  /**< bitfield AD1S  */
    using AD2S  = regbits< type,  4,  2 >;  /**< bitfield AD2S  */
    using AD0P  = regbits< type,  8,  2 >;  /**< bitfield AD0P  */
    using AD1P  = regbits< type, 10,  2 >;  /**< bitfield AD1P  */
    using AD2P  = regbits< type, 12,  2 >;  /**< bitfield AD2P  */
  };
};
} // namespace mptl
