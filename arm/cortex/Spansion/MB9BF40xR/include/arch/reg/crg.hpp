...
struct CRG
{
  ...
  : public reg< uint8_t, base_addr + 0x28, rw, 0x00 >
  {
    ...
    using TTC  = regbits< type,  0,  1 >;  /**< Trace clock frequency division ratio setting bit  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x3c, rw, 0x00 >
  {
    ...
    using PLLN  = regbits< type,  0,  5 >;  /**< PLL feedback frequency division ratio setting bit  */
  };
