...
struct INTREQ
{
  ...
  : public reg< uint32_t, base_addr + 0x2c, ro, 0x0 >
  {
    ...
    using QUD1INT5  = regbits< type, 13,  1 >;  /**< bitfield QUD1INT5  */
    using QUD1INT4  = regbits< type, 12,  1 >;  /**< bitfield QUD1INT4  */
    using QUD1INT3  = regbits< type, 11,  1 >;  /**< bitfield QUD1INT3  */
    using QUD1INT2  = regbits< type, 10,  1 >;  /**< bitfield QUD1INT2  */
    using QUD1INT1  = regbits< type,  9,  1 >;  /**< bitfield QUD1INT1  */
    using QUD1INT0  = regbits< type,  8,  1 >;  /**< bitfield QUD1INT0  */
  ...
  : public reg< uint32_t, base_addr + 0x94, ro, 0x0 >
  {
    ...
    using CAN0INT  = regbits< type,  0,  1 >;  /**< bitfield CAN0INT  */
  };
