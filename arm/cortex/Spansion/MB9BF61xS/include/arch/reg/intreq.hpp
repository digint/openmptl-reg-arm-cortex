...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Spansion/MB9BF61xS.svd"
//
//  name: MB9BF61xS
//  version: 1.7
//  description: MB9BF61xS
//  --------------------------------------------------------------------
//
...
struct INTREQ
{
  ...
  : public reg< uint8_t, base_addr + 0xb, rw, 0x0 >
  {
    ...
    using ODDPKS4  = regbits< type,  4,  1 >;  /**< "When the transfer destination address of DMAC is USB.EP5DT, the bit width of the last transfer data is converted to Byte."  */
    using ODDPKS3  = regbits< type,  3,  1 >;  /**< "When the transfer destination address of DMAC is USB.EP4DT, the bit width of the last transfer data is converted to Byte."  */
    using ODDPKS2  = regbits< type,  2,  1 >;  /**< "When the transfer destination address of DMAC is USB.EP3DT, the bit width of the last transfer data is converted to Byte."  */
    using ODDPKS1  = regbits< type,  1,  1 >;  /**< "When the transfer destination address of DMAC is USB.EP2DT, the bit width of the last transfer data is converted to Byte."  */
    using ODDPKS0  = regbits< type,  0,  1 >;  /**< "When the transfer destination address of DMAC is USB.EP1DT, the bit width of the last transfer data is converted to Byte."  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x94, ro, 0x0 >
  {
    ...
    using MAC0LPI  = regbits< type,  3,  1 >;  /**< LPI interrupt request of Ethernet MAC ch.0  */
    using MAC0PMI  = regbits< type,  2,  1 >;  /**< PMI interrupt request of Ethernet MAC ch.0  */
    using MAC0SBD  = regbits< type,  1,  1 >;  /**< SBD interrupt request of Ethernet MAC ch.0  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x98, ro, 0x0 >
  {
    ...
    using MAC1LPI  = regbits< type,  3,  1 >;  /**< LPI interrupt request of Ethernet MAC ch.1  */
    using MAC1PMI  = regbits< type,  2,  1 >;  /**< PMI interrupt request of Ethernet MAC ch.1  */
    using MAC1SBD  = regbits< type,  1,  1 >;  /**< SBD interrupt request of Ethernet MAC ch.1  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x9c, ro, 0x0 >
  {
    ...
    using USB0INT4  = regbits< type,  4,  1 >;  /**< Endpoint 5 DRQ interrupt request on the USB ch.0  */
    using USB0INT3  = regbits< type,  3,  1 >;  /**< Endpoint 4 DRQ interrupt request on the USB ch.0  */
    using USB0INT2  = regbits< type,  2,  1 >;  /**< Endpoint 3 DRQ interrupt request on the USB ch.0  */
    using USB0INT1  = regbits< type,  1,  1 >;  /**< Endpoint 2 DRQ interrupt request on the USB ch.0  */
    using USB0INT0  = regbits< type,  0,  1 >;  /**< Endpoint 1 DRQ interrupt request on the USB ch.0  */
  };
  ...
  : public reg< uint32_t, base_addr + 0xa0, ro, 0x0 >
  {
    ...
    using USB0INT5  = regbits< type,  5,  1 >;  /**< "Status (SOFIRQ, CMPIRO) interrupt request on the USB ch.0 "               */
    using USB0INT4  = regbits< type,  4,  1 >;  /**< "Status (DIRQ, URIRQ, RWKIRQ, CNNIRQ) interrupt request on the USB ch.0 "  */
    using USB0INT3  = regbits< type,  3,  1 >;  /**< Status (SPK) interrupt request on the USB ch.0                             */
    using USB0INT2  = regbits< type,  2,  1 >;  /**< "Status (SUSP, SOF, BRST, CONF, WKUP) interrupt request on the USB ch.0 "  */
    using USB0INT1  = regbits< type,  1,  1 >;  /**< Endpoint 0 DRQO interrupt request on the USB ch.0                          */
    using USB0INT0  = regbits< type,  0,  1 >;  /**< Endpoint 0 DRQI interrupt request on the USB ch.0                          */
  };
  ...
  : public reg< uint32_t, base_addr + 0xa4, ro, 0x0 >
  {
    ...
    using USB1INT4  = regbits< type,  4,  1 >;  /**< Endpoint 5 DRQ interrupt request on the USB ch.1  */
    using USB1INT3  = regbits< type,  3,  1 >;  /**< Endpoint 4 DRQ interrupt request on the USB ch.1  */
    using USB1INT2  = regbits< type,  2,  1 >;  /**< Endpoint 3 DRQ interrupt request on the USB ch.1  */
    using USB1INT1  = regbits< type,  1,  1 >;  /**< Endpoint 2 DRQ interrupt request on the USB ch.1  */
    using USB1INT0  = regbits< type,  0,  1 >;  /**< Endpoint 1 DRQ interrupt request on the USB ch.1  */
  };
  ...
  : public reg< uint32_t, base_addr + 0xa8, ro, 0x0 >
  {
    ...
    using USB1INT5  = regbits< type,  5,  1 >;  /**< "Status (SOFIRQ, CMPIRO) interrupt request on the USB ch.1 "               */
    using USB1INT4  = regbits< type,  4,  1 >;  /**< "Status (DIRQ, URIRQ, RWKIRQ, CNNIRQ) interrupt request on the USB ch.1 "  */
    using USB1INT3  = regbits< type,  3,  1 >;  /**< Status (SPK) interrupt request on the USB ch.1                             */
    using USB1INT2  = regbits< type,  2,  1 >;  /**< "Status (SUSP, SOF, BRST, CONF, WKUP) interrupt request on the USB ch.1 "  */
    using USB1INT1  = regbits< type,  1,  1 >;  /**< Endpoint 0 DRQO interrupt request on the USB ch.1                          */
    using USB1INT0  = regbits< type,  0,  1 >;  /**< Endpoint 0 DRQI interrupt request on the USB ch.1                          */
  };
  ...
  : public reg< uint32_t, base_addr + 0x200, rw, 0x0 >
  {
    ...
    using DRQSEL14  = regbits< type,  4,  1 >;  /**< Interrupt signal of EP5 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector  */
    using DRQSEL13  = regbits< type,  3,  1 >;  /**< Interrupt signal of EP4 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector  */
    using DRQSEL12  = regbits< type,  2,  1 >;  /**< Interrupt signal of EP3 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector  */
    using DRQSEL11  = regbits< type,  1,  1 >;  /**< Interrupt signal of EP2 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector  */
    using DRQSEL10  = regbits< type,  0,  1 >;  /**< Interrupt signal of EP1 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector  */
  };
   ...
   */
  struct ODDPKS1
  : public reg< uint8_t, base_addr + 0x20f, rw, 0x0 >
  {
    using type = reg< uint8_t, base_addr + 0x20f, rw, 0x0 >;

    using ODDPKS14  = regbits< type,  4,  1 >;  /**< "When the transfer destination address of the DMAC is USB.EP5DT, convert the bit width of the last transfer data to byte."  */
    using ODDPKS13  = regbits< type,  3,  1 >;  /**< "When the transfer destination address of the DMAC is USB.EP4DT, convert the bit width of the last transfer data to byte."  */
    using ODDPKS12  = regbits< type,  2,  1 >;  /**< "When the transfer destination address of the DMAC is USB.EP3DT, convert the bit width of the last transfer data to byte."  */
    using ODDPKS11  = regbits< type,  1,  1 >;  /**< "When the transfer destination address of the DMAC is USB.EP2DT, convert the bit width of the last transfer data to byte."  */
    using ODDPKS10  = regbits< type,  0,  1 >;  /**< "When the transfer destination address of the DMAC is USB.EP1DT, convert the bit width of the last transfer data to byte."  */
  };
};
} // namespace mptl
