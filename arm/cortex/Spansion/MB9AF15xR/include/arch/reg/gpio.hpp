...
struct GPIO
{
   ...
   */
  struct ADE
  : public reg< uint32_t, base_addr + 0x500, rw, 0x00FFFFFF >
  {
    using type = reg< uint32_t, base_addr + 0x500, rw, 0x00FFFFFF >;
  ...
  : public reg< uint32_t, base_addr + 0x714, rw, 0x00000000 >
  {
    ...
    using P8  = regbits< type,  8,  1 >;  /**< Bit8 of PZR5  */
    using P7  = regbits< type,  7,  1 >;  /**< Bit7 of PZR5  */
    using P6  = regbits< type,  6,  1 >;  /**< Bit6 of PZR5  */
  };
