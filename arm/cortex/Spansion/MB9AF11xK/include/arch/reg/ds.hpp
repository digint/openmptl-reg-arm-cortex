...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Spansion/MB9AF11xK.svd"
//
//  name: MB9AF11xK
//  version: 1.7
//  description: MB9AF11xK
//  --------------------------------------------------------------------
//
...
struct DS
{
  static constexpr reg_addr_t base_addr = 0x40035800;
   ...
   */
  struct BUR02
  : public reg< uint8_t, base_addr + 0x101, rw, 0x00 >
  {
  };
   ...
   */
  struct BUR03
  : public reg< uint8_t, base_addr + 0x102, rw, 0x00 >
  {
  };
   ...
   */
  struct BUR04
  : public reg< uint8_t, base_addr + 0x103, rw, 0x00 >
  {
  };
   ...
   */
  struct BUR06
  : public reg< uint8_t, base_addr + 0x105, rw, 0x00 >
  {
  };
   ...
   */
  struct BUR07
  : public reg< uint8_t, base_addr + 0x106, rw, 0x00 >
  {
  };
   ...
   */
  struct BUR08
  : public reg< uint8_t, base_addr + 0x107, rw, 0x00 >
  {
  };
   ...
   */
  struct BUR10
  : public reg< uint8_t, base_addr + 0x109, rw, 0x00 >
  {
  };
   ...
   */
  struct BUR11
  : public reg< uint8_t, base_addr + 0x10a, rw, 0x00 >
  {
  };
   ...
   */
  struct BUR12
  : public reg< uint8_t, base_addr + 0x10b, rw, 0x00 >
  {
  };
   ...
   */
  struct BUR14
  : public reg< uint8_t, base_addr + 0x10d, rw, 0x00 >
  {
  };
   ...
   */
  struct BUR15
  : public reg< uint8_t, base_addr + 0x10e, rw, 0x00 >
  {
  };
   ...
   */
  struct BUR16
  : public reg< uint8_t, base_addr + 0x10f, rw, 0x00 >
  {
  };
};
} // namespace mptl
