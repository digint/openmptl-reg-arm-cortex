...
struct ADC2
{
  ...
  : public reg< uint8_t, base_addr + 0x44, rw, 0x00 >
  {
    ...
    using RCOOF  = regbits< type,  0,  1 >;  /**< bitfield RCOOF  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x48, rw, 0x00 >
  {
    ...
    using RCINT  = regbits< type,  0,  1 >;  /**< bitfield RCINT  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x4c, rw, 0x20 >
  {
    ...
    using RCOCD   = regbits< type,  5,  3 >;  /**< bitfield RCOCD   */
    using RCOIRS  = regbits< type,  4,  1 >;  /**< bitfield RCOIRS  */
    using RCOIE   = regbits< type,  3,  1 >;  /**< bitfield RCOIE   */
    using RCOE    = regbits< type,  2,  1 >;  /**< bitfield RCOE    */
  };
  ...
  : public reg< uint8_t, base_addr + 0x4d, rw, 0x00 >
  {
    ...
    using WCMD  = regbits< type,  5,  1 >;  /**< bitfield WCMD  */
    using WCCH  = regbits< type,  0,  5 >;  /**< bitfield WCCH  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x50, rw, 0x0000 >
  {
    ...
    using CMLD  = regbits< type,  6, 10 >;  /**< bitfield CMLD  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x52, rw, 0x0000 >
  {
    ...
    using CMHD  = regbits< type,  6, 10 >;  /**< bitfield CMHD  */
  };
};
} // namespace mptl
