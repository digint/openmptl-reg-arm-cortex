...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0x00000000 >
  {
    ...
    using PLLSAIRDYC   = regbits< type, 22,  1 >;  /**< PLLSAI Ready Interrupt Clear           */
    ...
    using PLLSAIRDYIE  = regbits< type, 14,  1 >;  /**< PLLSAI Ready Interrupt Enable          */
    ...
    using PLLSAIRDYF   = regbits< type,  6,  1 >;  /**< PLLSAI ready interrupt flag            */
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0x00000000 >
  {
    ...
    using DMA2DRST   = regbits< type, 23,  1 >;  /**< DMA2D reset              */
    ...
    using GPIOKRST   = regbits< type, 10,  1 >;  /**< IO port K reset          */
    using GPIOJRST   = regbits< type,  9,  1 >;  /**< IO port J reset          */
  ...
  : public reg< uint32_t, base_addr + 0x14, rw, 0x00000000 >
  {
    ...
    using HSAHRST   = regbits< type,  5,  1 >;  /**< Hash module reset                     */
    using CRYPRST   = regbits< type,  4,  1 >;  /**< Cryptographic module reset            */
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
    ...
    using FMCRST   = regbits< type,  0,  1 >;  /**< Flexible memory controller module reset  */
    using QSPIRST  = regbits< type,  1,  1 >;  /**< Quad SPI memory controller reset         */
  };
  ...
  : public reg< uint32_t, base_addr + 0x20, rw, 0x00000000 >
  {
    ...
    using UART7RST    = regbits< type, 30,  1 >;  /**< UART7 reset              */
    using UART8RST    = regbits< type, 31,  1 >;  /**< UART8 reset              */
    using SPDIFRXRST  = regbits< type, 16,  1 >;  /**< SPDIF-RX reset           */
    using CECRST      = regbits< type, 27,  1 >;  /**< HDMI-CEC reset           */
    using LPTIM1RST   = regbits< type,  9,  1 >;  /**< Low power timer 1 reset  */
    using I2C4RST     = regbits< type, 24,  1 >;  /**< I2C 4 reset              */
  };
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x00000000 >
  {
    ...
    using SPI4RST    = regbits< type, 13,  1 >;  /**< SPI4 reset                                */
    ...
    using SPI5RST    = regbits< type, 20,  1 >;  /**< SPI5 reset                                */
    using SPI6RST    = regbits< type, 21,  1 >;  /**< SPI6 reset                                */
    using SAI1RST    = regbits< type, 22,  1 >;  /**< SAI1 reset                                */
    using LTDCRST    = regbits< type, 26,  1 >;  /**< LTDC reset                                */
    using SAI2RST    = regbits< type, 23,  1 >;  /**< SAI2 reset                                */
    using SDMMC1RST  = regbits< type, 11,  1 >;  /**< SDMMC1 reset                              */
  };
  ...
  : public reg< uint32_t, base_addr + 0x30, rw, 0x00100000 >
  {
    ...
    using DMA2DEN       = regbits< type, 23,  1 >;  /**< DMA2D clock enable                  */
    using DMA2EN        = regbits< type, 22,  1 >;  /**< DMA2 clock enable                   */
    using DMA1EN        = regbits< type, 21,  1 >;  /**< DMA1 clock enable                   */
    using CCMDATARAMEN  = regbits< type, 20,  1 >;  /**< CCM data RAM clock enable           */
    using BKPSRAMEN     = regbits< type, 18,  1 >;  /**< Backup SRAM interface clock enable  */
    using CRCEN         = regbits< type, 12,  1 >;  /**< CRC clock enable                    */
    using GPIOKEN       = regbits< type, 10,  1 >;  /**< IO port K clock enable              */
    using GPIOJEN       = regbits< type,  9,  1 >;  /**< IO port J clock enable              */
  ...
  : public reg< uint32_t, base_addr + 0x34, rw, 0x00000000 >
  {
    ...
    using HASHEN   = regbits< type,  5,  1 >;  /**< Hash modules clock enable             */
    using CRYPEN   = regbits< type,  4,  1 >;  /**< Cryptographic modules clock enable    */
  ...
  : public reg< uint32_t, base_addr + 0x38, rw, 0x00000000 >
  {
    ...
    using FMCEN   = regbits< type,  0,  1 >;  /**< Flexible memory controller module clock enable  */
    using QSPIEN  = regbits< type,  1,  1 >;  /**< Quad SPI memory controller clock enable         */
  };
  ...
  : public reg< uint32_t, base_addr + 0x40, rw, 0x00000000 >
  {
    ...
    using UART7ENR   = regbits< type, 30,  1 >;  /**< UART7 clock enable              */
    using UART8ENR   = regbits< type, 31,  1 >;  /**< UART8 clock enable              */
    using SPDIFRXEN  = regbits< type, 16,  1 >;  /**< SPDIF-RX clock enable           */
    using CECEN      = regbits< type, 27,  1 >;  /**< HDMI-CEN clock enable           */
    using LPTMI1EN   = regbits< type,  9,  1 >;  /**< Low power timer 1 clock enable  */
    using I2C4EN     = regbits< type, 24,  1 >;  /**< I2C4 clock enable               */
  };
  ...
  : public reg< uint32_t, base_addr + 0x44, rw, 0x00000000 >
  {
    ...
    using SPI4ENR   = regbits< type, 13,  1 >;  /**< SPI4 clock enable                             */
    ...
    using SPI5ENR   = regbits< type, 20,  1 >;  /**< SPI5 clock enable                             */
    using SPI6ENR   = regbits< type, 21,  1 >;  /**< SPI6 clock enable                             */
    using SAI1EN    = regbits< type, 22,  1 >;  /**< SAI1 clock enable                             */
    using LTDCEN    = regbits< type, 26,  1 >;  /**< LTDC clock enable                             */
    using SAI2EN    = regbits< type, 23,  1 >;  /**< SAI2 clock enable                             */
    using SDMMC1EN  = regbits< type, 11,  1 >;  /**< SDMMC1 clock enable                           */
  };
  ...
  : public reg< uint32_t, base_addr + 0x50, rw, 0x7E6791FF >
  {
    ...
    using GPIOJLPEN      = regbits< type,  9,  1 >;  /**< IO port J clock enable during Sleep mode              */
    using GPIOKLPEN      = regbits< type, 10,  1 >;  /**< IO port K clock enable during Sleep mode              */
    ...
    using SRAM3LPEN      = regbits< type, 19,  1 >;  /**< SRAM 3 interface clock enable during Sleep mode       */
    ...
    using DMA2DLPEN      = regbits< type, 23,  1 >;  /**< DMA2D clock enable during Sleep mode                  */
  ...
  : public reg< uint32_t, base_addr + 0x54, rw, 0x000000F1 >
  {
    ...
    using HASHLPEN   = regbits< type,  5,  1 >;  /**< Hash modules clock enable during Sleep mode             */
    using CRYPLPEN   = regbits< type,  4,  1 >;  /**< Cryptography modules clock enable during Sleep mode     */
  ...
  : public reg< uint32_t, base_addr + 0x58, rw, 0x00000001 >
  {
    ...
    using FMCLPEN   = regbits< type,  0,  1 >;  /**< Flexible memory controller module clock enable during Sleep mode  */
    using QSPILPEN  = regbits< type,  1,  1 >;  /**< Quand SPI memory controller clock enable during Sleep mode        */
  };
  ...
  : public reg< uint32_t, base_addr + 0x60, rw, 0x36FEC9FF >
  {
    ...
    using UART7LPEN    = regbits< type, 30,  1 >;  /**< UART7 clock enable during Sleep mode              */
    using UART8LPEN    = regbits< type, 31,  1 >;  /**< UART8 clock enable during Sleep mode              */
    using SPDIFRXLPEN  = regbits< type, 16,  1 >;  /**< SPDIF-RX clock enable during sleep mode           */
    using CECLPEN      = regbits< type, 27,  1 >;  /**< HDMI-CEN clock enable during Sleep mode           */
    using LPTIM1LPEN   = regbits< type,  9,  1 >;  /**< low power timer 1 clock enable during Sleep mode  */
    using I2C4LPEN     = regbits< type, 24,  1 >;  /**< I2C4 clock enable during Sleep mode               */
  };
  ...
  : public reg< uint32_t, base_addr + 0x64, rw, 0x00075F33 >
  {
    ...
    using SPI4LPEN    = regbits< type, 13,  1 >;  /**< SPI 4 clock enable during Sleep mode                            */
    ...
    using SPI5LPEN    = regbits< type, 20,  1 >;  /**< SPI 5 clock enable during Sleep mode                            */
    using SPI6LPEN    = regbits< type, 21,  1 >;  /**< SPI 6 clock enable during Sleep mode                            */
    using SAI1LPEN    = regbits< type, 22,  1 >;  /**< SAI1 clock enable during sleep mode                             */
    using LTDCLPEN    = regbits< type, 26,  1 >;  /**< LTDC clock enable during sleep mode                             */
    using SAI2LPEN    = regbits< type, 23,  1 >;  /**< SAI2 clock enable during sleep mode                             */
    using SDMMC1LPEN  = regbits< type, 11,  1 >;  /**< SDMMC1 clock enable during Sleep mode                           */
  };
  ...
  : public reg< uint32_t, base_addr + 0x84, rw, 0x20003000 >
  {
    ...
    using PLLI2SQ  = regbits< type, 24,  4 >;  /**< PLLI2S division factor for SAI1 clock  */
   ...
   */
  struct PLLSAICFGR
  : public reg< uint32_t, base_addr + 0x88, rw, 0x20003000 >
  {
    using type = reg< uint32_t, base_addr + 0x88, rw, 0x20003000 >;

    using PLLSAIN  = regbits< type,  6,  9 >;  /**< PLLSAI division factor for VCO          */
    using PLLSAIP  = regbits< type, 16,  2 >;  /**< PLLSAI division factor for 48MHz clock  */
    using PLLSAIQ  = regbits< type, 24,  4 >;  /**< PLLSAI division factor for SAI clock    */
    using PLLSAIR  = regbits< type, 28,  3 >;  /**< PLLSAI division factor for LCD clock    */
  };
   ...
   */
  struct DKCFGR1
  : public reg< uint32_t, base_addr + 0x8c, rw, 0x20003000 >
  {
    using type = reg< uint32_t, base_addr + 0x8c, rw, 0x20003000 >;

    using PLLI2SDIV   = regbits< type,  0,  5 >;  /**< PLLI2S division factor for SAI1 clock  */
    using PLLSAIDIVQ  = regbits< type,  8,  5 >;  /**< PLLSAI division factor for SAI1 clock  */
    using PLLSAIDIVR  = regbits< type, 16,  2 >;  /**< division factor for LCD_CLK            */
    using SAI1SEL     = regbits< type, 20,  2 >;  /**< SAI1 clock source selection            */
    using SAI2SEL     = regbits< type, 22,  2 >;  /**< SAI2 clock source selection            */
    using TIMPRE      = regbits< type, 24,  1 >;  /**< Timers clocks prescalers selection     */
  };
   ...
   */
  struct DKCFGR2
  : public reg< uint32_t, base_addr + 0x90, rw, 0x20003000 >
  {
    using type = reg< uint32_t, base_addr + 0x90, rw, 0x20003000 >;

    using USART1SEL  = regbits< type,  0,  2 >;  /**< USART 1 clock source selection            */
    using USART2SEL  = regbits< type,  2,  2 >;  /**< USART 2 clock source selection            */
    using USART3SEL  = regbits< type,  4,  2 >;  /**< USART 3 clock source selection            */
    using UART4SEL   = regbits< type,  6,  2 >;  /**< UART 4 clock source selection             */
    using UART5SEL   = regbits< type,  8,  2 >;  /**< UART 5 clock source selection             */
    using USART6SEL  = regbits< type, 10,  2 >;  /**< USART 6 clock source selection            */
    using UART7SEL   = regbits< type, 12,  2 >;  /**< UART 7 clock source selection             */
    using UART8SEL   = regbits< type, 14,  2 >;  /**< UART 8 clock source selection             */
    using I2C1SEL    = regbits< type, 16,  2 >;  /**< I2C1 clock source selection               */
    using I2C2SEL    = regbits< type, 18,  2 >;  /**< I2C2 clock source selection               */
    using I2C3SEL    = regbits< type, 20,  2 >;  /**< I2C3 clock source selection               */
    using I2C4SEL    = regbits< type, 22,  2 >;  /**< I2C4 clock source selection               */
    using LPTIM1SEL  = regbits< type, 24,  2 >;  /**< Low power timer 1 clock source selection  */
    using CECSEL     = regbits< type, 26,  1 >;  /**< HDMI-CEC clock source selection           */
    using CK48MSEL   = regbits< type, 27,  1 >;  /**< 48MHz clock source selection              */
    using SDMMCSEL   = regbits< type, 28,  1 >;  /**< SDMMC clock source selection              */
  };
};
} // namespace mptl
