...
#ifndef ARCH_REG_TIM20_HPP_INCLUDED
#define ARCH_REG_TIM20_HPP_INCLUDED
...
struct TIM20
{
  ...
  : public reg< uint32_t, base_addr + 0x60, rw, 0x00000000 >
  {
    ...
    using TIM1_ETR_ADC1_RMP  = regbits< type,  0,  2 >;  /**< TIM1_ETR_ADC1 remapping capability  */
    using TIM1_ETR_ADC4_RMP  = regbits< type,  2,  2 >;  /**< TIM1_ETR_ADC4 remapping capability  */
  };
};
} // namespace mptl

#endif // ARCH_REG_TIM20_HPP_INCLUDED
