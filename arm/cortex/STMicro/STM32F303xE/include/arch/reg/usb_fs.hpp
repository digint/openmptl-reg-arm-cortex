...
struct USB_FS
{
  ...
  : public reg< uint32_t, base_addr + 0x4c, rw, 0x0000 >
  {
    ...
    using ADD   = regbits< type,  0,  1 >;  /**< Device address   */
    using ADD1  = regbits< type,  1,  1 >;  /**< Device address   */
    using ADD2  = regbits< type,  2,  1 >;  /**< Device address   */
    using ADD3  = regbits< type,  3,  1 >;  /**< Device address   */
    using ADD4  = regbits< type,  4,  1 >;  /**< Device address   */
    using ADD5  = regbits< type,  5,  1 >;  /**< Device address   */
    using ADD6  = regbits< type,  6,  1 >;  /**< Device address   */
