...
using tim8_trg_com        = irq_channel<45>;    /**< TIM8 Trigger and commutation interrupts                                             */
...
using adc4                = irq_channel<61>;    /**< ADC4 global interrupt                                                               */
...
using fpu                 = irq_channel<81>;    /**< Floating point interrupt                                                            */
