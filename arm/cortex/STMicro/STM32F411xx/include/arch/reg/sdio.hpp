...
struct SDIO
{
  ...
  : public reg< uint32_t, base_addr + 0x14, ro, 0x00000000 >
  {
    ...
    using CARDSTATUS1  = regbits< type,  0, 32 >;  /**< Card Status  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x18, ro, 0x00000000 >
  {
    ...
    using CARDSTATUS2  = regbits< type,  0, 32 >;  /**< Card Status  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1c, ro, 0x00000000 >
  {
    ...
    using CARDSTATUS3  = regbits< type,  0, 32 >;  /**< Card Status  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x20, ro, 0x00000000 >
  {
    ...
    using CARDSTATUS4  = regbits< type,  0, 32 >;  /**< Card Status  */
  };
