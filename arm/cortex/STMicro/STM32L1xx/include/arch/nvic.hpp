...
using sdio           = irq_channel<45>;    /**< SDIO global interrupt                                                                    */
using tim5           = irq_channel<46>;    /**< TIM5 global interrupt                                                                    */
using spi3           = irq_channel<47>;    /**< SPI3 global interrupt                                                                    */
using dma2_ch1       = irq_channel<50>;    /**< DMA2 Channel 1 interrupt                                                                 */
using dma2_ch2       = irq_channel<51>;    /**< DMA2 Channel 2 interrupt                                                                 */
using dma2_ch3       = irq_channel<52>;    /**< DMA2 Channel 3 interrupt                                                                 */
using dma2_ch4       = irq_channel<53>;    /**< DMA2 Channel 4 interrupt                                                                 */
using dma2_ch5       = irq_channel<54>;    /**< DMA2 Channel 5 interrupt                                                                 */
using aes            = irq_channel<55>;    /**< AES global interrupt                                                                     */
