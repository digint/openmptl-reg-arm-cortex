...
template<> struct address_map< 0x40007c5c > { static constexpr const char * name_str = "OPAMP::CSR"; };
template<> struct address_map< 0x40007c60 > { static constexpr const char * name_str = "OPAMP::OTR"; };
template<> struct address_map< 0x40007c64 > { static constexpr const char * name_str = "OPAMP::LPOTR"; };
...
template<> struct address_map< 0x40021800 > { static constexpr const char * name_str = "GPIOF::MODER"; };
template<> struct address_map< 0x40021804 > { static constexpr const char * name_str = "GPIOF::OTYPER"; };
template<> struct address_map< 0x40021808 > { static constexpr const char * name_str = "GPIOF::OSPEEDER"; };
template<> struct address_map< 0x4002180c > { static constexpr const char * name_str = "GPIOF::PUPDR"; };
template<> struct address_map< 0x40021810 > { static constexpr const char * name_str = "GPIOF::IDR"; };
template<> struct address_map< 0x40021814 > { static constexpr const char * name_str = "GPIOF::ODR"; };
template<> struct address_map< 0x40021818 > { static constexpr const char * name_str = "GPIOF::BSRR"; };
template<> struct address_map< 0x4002181c > { static constexpr const char * name_str = "GPIOF::LCKR"; };
template<> struct address_map< 0x40021820 > { static constexpr const char * name_str = "GPIOF::AFRL"; };
template<> struct address_map< 0x40021824 > { static constexpr const char * name_str = "GPIOF::AFRH"; };
template<> struct address_map< 0x40021c00 > { static constexpr const char * name_str = "GPIOG::MODER"; };
template<> struct address_map< 0x40021c04 > { static constexpr const char * name_str = "GPIOG::OTYPER"; };
template<> struct address_map< 0x40021c08 > { static constexpr const char * name_str = "GPIOG::OSPEEDER"; };
template<> struct address_map< 0x40021c0c > { static constexpr const char * name_str = "GPIOG::PUPDR"; };
template<> struct address_map< 0x40021c10 > { static constexpr const char * name_str = "GPIOG::IDR"; };
template<> struct address_map< 0x40021c14 > { static constexpr const char * name_str = "GPIOG::ODR"; };
template<> struct address_map< 0x40021c18 > { static constexpr const char * name_str = "GPIOG::BSRR"; };
template<> struct address_map< 0x40021c1c > { static constexpr const char * name_str = "GPIOG::LCKR"; };
template<> struct address_map< 0x40021c20 > { static constexpr const char * name_str = "GPIOG::AFRL"; };
template<> struct address_map< 0x40021c24 > { static constexpr const char * name_str = "GPIOG::AFRH"; };
