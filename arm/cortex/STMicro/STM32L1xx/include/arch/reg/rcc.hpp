...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0x00000000 >
  {
    ...
    using FSMCRST   = regbits< type, 30,  1 >;  /**< FSMC reset       */
  ...
  : public reg< uint32_t, base_addr + 0x14, rw, 0x00000000 >
  {
    ...
    using SDIORST    = regbits< type, 11,  1 >;  /**< SDIORST    */
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x00008000 >
  {
    ...
    using FSMCEN    = regbits< type, 30,  1 >;  /**< FSMCEN                  */
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x00000000 >
  {
    ...
    using USART5EN  = regbits< type, 20,  1 >;  /**< UART 5 clock enable           */
    using USART4EN  = regbits< type, 19,  1 >;  /**< UART 4 clock enable           */
  ...
  : public reg< uint32_t, base_addr + 0x2c, rw, 0x00000000 >
  {
    ...
    using SDIOLPEN    = regbits< type, 11,  1 >;  /**< Reserved                                                        */
