...
struct SDIO
{
  ...
  : public reg< uint32_t, base_addr + 0x0, rw, 0x00000000 >
  {
    ...
    using PWRCTRL  = regbits< type,  0,  2 >;  /**< Power supply control bits.  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x14, ro, 0x00000000 >
  {
    ...
    using CARDSTATUS1  = regbits< type,  0, 32 >;  /**< see Table 133.  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x18, ro, 0x00000000 >
  {
    ...
    using CARDSTATUS2  = regbits< type,  0, 32 >;  /**< see Table 133.  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1c, ro, 0x00000000 >
  {
    ...
    using CARDSTATUS3  = regbits< type,  0, 32 >;  /**< see Table 133.  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x20, ro, 0x00000000 >
  {
    ...
    using CARDSTATUS4  = regbits< type,  0, 32 >;  /**< see Table 133.  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x2c, rw, 0x00000000 >
  {
    ...
    using DTEN        = regbits< type,  0,  1 >;  /**< Data transfer enabled bit                                                */
  };
  ...
  : public reg< uint32_t, base_addr + 0x80, rw, 0x00000000 >
  {
    ...
    using FIF0Data  = regbits< type,  0, 32 >;  /**< FIF0Data  */
  };
};
} // namespace mptl
