...
#ifndef ARCH_REG_TIM9_HPP_INCLUDED
#define ARCH_REG_TIM9_HPP_INCLUDED
...
struct TIM9
{
  ...
  : public reg< uint32_t, base_addr + 0x0, rw, 0x0000 >
  {
    ...
    using OMP   = regbits< type,  3,  1 >;  /**< One-pulse mode              */
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x00000000 >
  {
    ...
    using CNT_ = regbits< type,  0, 16 >;  /**< TIM9 counter  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x28, rw, 0x0000 >
  {
    ...
    using PSC_ = regbits< type,  0, 16 >;  /**< TIM9 prescaler  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x50, rw, 0x0000 >
  {
    ...
    using TI1_RMP  = regbits< type,  0,  2 >;  /**< TIM9 Input 1 remapping capability  */
  };
};
} // namespace mptl

#endif // ARCH_REG_TIM9_HPP_INCLUDED
