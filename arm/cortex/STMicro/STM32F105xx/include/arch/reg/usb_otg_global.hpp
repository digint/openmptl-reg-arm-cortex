...
#ifndef ARCH_REG_USB_OTG_GLOBAL_HPP_INCLUDED
#define ARCH_REG_USB_OTG_GLOBAL_HPP_INCLUDED
...
struct USB_OTG_GLOBAL
{
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0x00000A00 >
  {
    ...
    using PHYSEL  = regbits< type,  7,  1 >;  /**< Full Speed serial transceiver select  */
...
#endif // ARCH_REG_USB_OTG_GLOBAL_HPP_INCLUDED
