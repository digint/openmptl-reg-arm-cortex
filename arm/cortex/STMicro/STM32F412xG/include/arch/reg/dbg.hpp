...
struct DBG
{
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x00000000 >
  {
    ...
    using DBG_RTC_Stop            = regbits< type, 10,  1 >;  /**< RTC stopped when Core is halted  */
    using DBG_WWDG_STOP           = regbits< type, 11,  1 >;  /**< DBG_WWDG_STOP                    */
    using DBG_IWDEG_STOP          = regbits< type, 12,  1 >;  /**< DBG_IWDEG_STOP                   */
    using DBG_I2C1_SMBUS_TIMEOUT  = regbits< type, 21,  1 >;  /**< DBG_J2C1_SMBUS_TIMEOUT           */
    using DBG_I2C2_SMBUS_TIMEOUT  = regbits< type, 22,  1 >;  /**< DBG_J2C2_SMBUS_TIMEOUT           */
    using DBG_I2C3SMBUS_TIMEOUT   = regbits< type, 23,  1 >;  /**< DBG_J2C3SMBUS_TIMEOUT            */
  };
