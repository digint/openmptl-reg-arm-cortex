...
struct OTG_FS_GLOBAL
{
  ...
  : public reg< uint32_t, base_addr + 0x38, rw, 0x00000000 >
  {
    ...
    using DCDET   = regbits< type,  0,  1 >;  /**< DCDET   */
    using PDET    = regbits< type,  1,  1 >;  /**< PDET    */
    using SDET    = regbits< type,  2,  1 >;  /**< SDET    */
    using PS2DET  = regbits< type,  3,  1 >;  /**< PS2DET  */
    using PWRDWN  = regbits< type, 16,  1 >;  /**< PWRDWN  */
    using BCDEN   = regbits< type, 17,  1 >;  /**< BCDEN   */
    using DCDEN   = regbits< type, 18,  1 >;  /**< DCDEN   */
    using PDEN    = regbits< type, 19,  1 >;  /**< PDEN    */
    using SDEN    = regbits< type, 20,  1 >;  /**< SDEN    */
    using VBDEN   = regbits< type, 21,  1 >;  /**< VBDEN   */
  };
