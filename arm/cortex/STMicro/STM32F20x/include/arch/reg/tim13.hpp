...
#ifndef ARCH_REG_TIM13_HPP_INCLUDED
#define ARCH_REG_TIM13_HPP_INCLUDED
...
struct TIM13
{
  static constexpr reg_addr_t base_addr = 0x40001c00;
  ...
  /**
   * capture/compare mode register (inputmode)
   */
  struct CCMR1_Input
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
  ...
  : public reg< uint32_t, base_addr + 0x50, rw, 0x00000000 >
  {
    ...
    using RMP  = regbits< type,  0,  2 >;  /**< Input 1 remapping capability  */
  };
};
} // namespace mptl

#endif // ARCH_REG_TIM13_HPP_INCLUDED
