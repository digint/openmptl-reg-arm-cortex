...
#ifndef ARCH_REG_LPUSART1_HPP_INCLUDED
#define ARCH_REG_LPUSART1_HPP_INCLUDED
...
struct LPUSART1
{
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0x0000 >
  {
    ...
    // fixme: Field name equals parent register name: BRR
    using BRR_ = regbits< type,  0, 20 >;  /**< BRR  */
  };
...
#endif // ARCH_REG_LPUSART1_HPP_INCLUDED
