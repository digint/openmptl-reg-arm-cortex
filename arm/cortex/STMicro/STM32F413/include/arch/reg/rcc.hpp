...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0x24003010 >
  {
    ...
    using PLLR    = regbits< type, 28,  3 >;  /**< Main PLL (PLL) division factor for I2S, DFSDM clocks                                    */
  };
  ...
  : public reg< uint32_t, base_addr + 0x14, rw, 0x00000000 >
  {
    ...
    using CRYPRST   = regbits< type,  4,  1 >;  /**< CRYP module reset        */
  };
  ...
  : public reg< uint32_t, base_addr + 0x20, rw, 0x00000000 >
  {
    ...
    using LPTIMER1RST  = regbits< type,  9,  1 >;  /**< LPTimer1 reset         */
    using USART4RST    = regbits< type, 19,  1 >;  /**< USART4 reset           */
    using USART5RST    = regbits< type, 20,  1 >;  /**< USART5 reset           */
    using CAN3RST      = regbits< type, 27,  1 >;  /**< CAN 3 reset            */
    using DACRST       = regbits< type, 29,  1 >;  /**< DAC reset              */
    using UART7RST     = regbits< type, 30,  1 >;  /**< UART 7 reset           */
    using UART8RST     = regbits< type, 31,  1 >;  /**< UART 8 reset           */
  };
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x00000000 >
  {
    ...
    using USART9RST  = regbits< type,  6,  1 >;  /**< USART9 reset                              */
    using SART10RST  = regbits< type,  7,  1 >;  /**< USART10 reset                             */
    using SPI4RST    = regbits< type, 13,  1 >;  /**< SPI4 reset                                */
    using SPI5RST    = regbits< type, 20,  1 >;  /**< SPI5RST                                   */
    using SAI1RST    = regbits< type, 22,  1 >;  /**< SAI1 reset                                */
    using DFSDM2RST  = regbits< type, 25,  1 >;  /**< DFSDM2 reset                              */
  };
  ...
  : public reg< uint32_t, base_addr + 0x34, rw, 0x00000000 >
  {
    ...
    using CRYPEN   = regbits< type,  4,  1 >;  /**< CRYP clock enable        */
  };
  ...
  : public reg< uint32_t, base_addr + 0x40, rw, 0x00000000 >
  {
    ...
    using LPTIMER1EN  = regbits< type,  9,  1 >;  /**< LPTimer 1 clock enable        */
    using RTCAPB      = regbits< type, 10,  1 >;  /**< clock enable                  */
    using UART4EN     = regbits< type, 19,  1 >;  /**< UART 4 clock enable           */
    using UART5EN     = regbits< type, 20,  1 >;  /**< UART 5 clock enable           */
    using CAN3EN      = regbits< type, 27,  1 >;  /**< CAN 3 clock enable            */
    using DACEN       = regbits< type, 29,  1 >;  /**< DAC clock enable              */
    using UART7EN     = regbits< type, 30,  1 >;  /**< UART7 clock enable            */
    using UART8EN     = regbits< type, 31,  1 >;  /**< UART8 clock enable            */
  };
  ...
  : public reg< uint32_t, base_addr + 0x44, rw, 0x00000000 >
  {
    ...
    using SPI5EN    = regbits< type, 20,  1 >;  /**< SPI5 clock enable                             */
    using SAI1EN    = regbits< type, 22,  1 >;  /**< SAI 1 clock enable                            */
    using DFSDM2EN  = regbits< type, 25,  1 >;  /**< DFSDM2 clock enable                           */
  };
  ...
  : public reg< uint32_t, base_addr + 0x50, rw, 0x7E6791FF >
  {
    ...
    using SRAM2LPEN  = regbits< type, 17,  1 >;  /**< SRAM2interface clock enable during Sleep mode   */
  };
  ...
  : public reg< uint32_t, base_addr + 0x54, rw, 0x000000F1 >
  {
    ...
    using FSMCLPEN   = regbits< type,  0,  1 >;  /**< Flexible memory controller module clock enable during Sleep mode  */
  ...
  : public reg< uint32_t, base_addr + 0x60, rw, 0x36FEC9FF >
  {
    ...
    using LPTIMER1LPEN  = regbits< type,  9,  1 >;  /**< TIM14 clock enable during Sleep mode            */
    using RTCAPBEN      = regbits< type, 10,  1 >;  /**< RTC APB clock enable during Sleep mode          */
    using USART4LPEN    = regbits< type, 19,  1 >;  /**< USART4 clock enable during Sleep mode           */
    using USART5LPEN    = regbits< type, 20,  1 >;  /**< USART5 clock enable during Sleep mode           */
    using CAN3LPEN      = regbits< type, 27,  1 >;  /**< CAN3 clock enable during Sleep mode             */
    using DACLPEN       = regbits< type, 29,  1 >;  /**< DAC clock enable during Sleep mode              */
  ...
  : public reg< uint32_t, base_addr + 0x64, rw, 0x00075F33 >
  {
    ...
    using USART9LPEN   = regbits< type,  6,  1 >;  /**< USART9 clock enable during Sleep mode                           */
    using USART10LPEN  = regbits< type,  7,  1 >;  /**< USART10 clock enable during Sleep mode                          */
    using EXTITEN      = regbits< type, 15,  1 >;  /**< EXTIT APB and SYSCTRL PFREE clock enable during Sleep mode      */
    using SPI5LPEN     = regbits< type, 20,  1 >;  /**< SPI5 clock enable during Sleep mode                             */
    using SAI1LPEN     = regbits< type, 22,  1 >;  /**< SAI1 clock enable during Sleep mode                             */
    using DFSDM2LPEN   = regbits< type, 25,  1 >;  /**< DFSDM2 clock enable during Sleep mode                           */
  };
  ...
  : public reg< uint32_t, base_addr + 0x70, rw, 0x00000000 >
  {
    ...
    using LSEMOD   = regbits< type,  3,  1 >;  /**< External low-speed oscillator bypass  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x84, rw, 0x20003000 >
  {
    ...
    using PLLI2SM    = regbits< type,  0,  6 >;  /**< Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock  */
    using PLLI2SSRC  = regbits< type, 22,  1 >;  /**< PLLI2S entry clock source                                                  */
    using PLLI2SQ    = regbits< type, 24,  4 >;  /**< PLLI2S division factor for USB OTG FS/SDIO/RNG clock                       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
    ...
    using FSMCRST  = regbits< type,  0,  1 >;  /**< Flexible memory controller module reset  */
    using QSPIRST  = regbits< type,  1,  1 >;  /**< QUADSPI module reset                     */
  };
  ...
  : public reg< uint32_t, base_addr + 0x38, rw, 0x00000000 >
  {
    ...
    using FSMCEN  = regbits< type,  0,  1 >;  /**< Flexible memory controller module clock enable  */
   ...
   */
  struct AHB3LPENR
  : public reg< uint32_t, base_addr + 0x58, rw, 0x00000003 >
  {
    using type = reg< uint32_t, base_addr + 0x58, rw, 0x00000003 >;
  ...
  : public reg< uint32_t, base_addr + 0x8c, rw, 0x00000000 >
  {
    ...
    using CKDFSDM1ASEL  = regbits< type, 15,  1 >;  /**< DFSDM1 audio clock selection.                */
    using TIMPRE        = regbits< type, 24,  1 >;  /**< Timers clocks prescalers selection           */
    using I2S1SRC       = regbits< type, 25,  2 >;  /**< I2S APB1 clocks source selection (I2S2/3)    */
    using I2S2SRC       = regbits< type, 27,  2 >;  /**< I2S APB2 clocks source selection (I2S1/4/5)  */
    using LPTIMER1SEL   = regbits< type, 30,  2 >;  /**< LPTIMER1 kernel clock selection.             */
  };
  ...
  : public reg< uint32_t, base_addr + 0x90, rw, 0x00000000 >
  {
    ...
    using AHB2APB1_CKEN  = regbits< type,  0,  1 >;  /**< AHB to APB1 Bridge clock enable  */
    using AHB2APB2_CKEN  = regbits< type,  1,  1 >;  /**< AHB to APB2 Bridge clock enable  */
    using CM4DBG_CKEN    = regbits< type,  2,  1 >;  /**< Cortex M4 ETM clock enable       */
    using SPARE_CKEN     = regbits< type,  3,  1 >;  /**< Spare clock enable               */
    using SRAM_CKEN      = regbits< type,  4,  1 >;  /**< SRQAM controller clock enable    */
    using FLITF_CKEN     = regbits< type,  5,  1 >;  /**< Flash Interface clock enable     */
    using RCC_CKEN       = regbits< type,  6,  1 >;  /**< RCC clock enable                 */
    using EVTCL_CKEN     = regbits< type,  7,  1 >;  /**< EVTCL_CKEN                       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x94, rw, 0x00000000 >
  {
    ...
    using CKSDIOSEL   = regbits< type, 28,  1 >;  /**< SDIO clock selection.                  */
    using CK48MSEL    = regbits< type, 27,  1 >;  /**< SDIO/USBFS clock selection.            */
    using I2CFMP1SEL  = regbits< type, 22,  1 >;  /**< I2CFMP1 kernel clock source selection  */
  };
};
} // namespace mptl
