...
struct ADC1
{
  ...
  : public reg< uint32_t, base_addr + 0x300, rw, 0x00000000 >
  {
    ...
    using AWD1    = regbits< type,  0,  1 >;  /**< Analog watchdog flag of ADC1                */
    using EOC1    = regbits< type,  1,  1 >;  /**< End of conversion of ADC1                   */
    using JEOC1   = regbits< type,  2,  1 >;  /**< Injected channel end of conversion of ADC1  */
    using JSTRT1  = regbits< type,  3,  1 >;  /**< Injected channel Start flag of ADC1         */
    using STRT1   = regbits< type,  4,  1 >;  /**< Regular channel Start flag of ADC1          */
    using OVR1    = regbits< type,  5,  1 >;  /**< Overrun flag of ADC1                        */
  };
