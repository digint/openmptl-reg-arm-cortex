...
struct DAC
{
  ...
  : public reg< uint32_t, base_addr + 0x0, rw, 0x00000000 >
  {
    ...
    using TSEL10     = regbits< type,  3,  1 >;  /**< DAC channel1 trigger selection              */
    using TSEL11     = regbits< type,  4,  1 >;  /**< DAC channel1 trigger selection              */
    using TSEL12     = regbits< type,  5,  1 >;  /**< DAC channel1 trigger selection              */
