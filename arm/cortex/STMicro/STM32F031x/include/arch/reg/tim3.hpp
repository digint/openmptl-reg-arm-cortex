...
struct TIM3
{
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x00000000 >
  {
    ...
    using CNT_H  = regbits< type, 16, 16 >;  /**< High counter value (TIM2 only)  */
  ...
  : public reg< uint32_t, base_addr + 0x2c, rw, 0x00000000 >
  {
    ...
    using ARR_H  = regbits< type, 16, 16 >;  /**< High Auto-reload value (TIM2 only)  */
  ...
  : public reg< uint32_t, base_addr + 0x34, rw, 0x00000000 >
  {
    ...
    using CCR1_H  = regbits< type, 16, 16 >;  /**< High Capture/Compare 1 value (TIM2 only)  */
  ...
  : public reg< uint32_t, base_addr + 0x38, rw, 0x00000000 >
  {
    ...
    using CCR2_H  = regbits< type, 16, 16 >;  /**< High Capture/Compare 2 value (TIM2 only)  */
  ...
  : public reg< uint32_t, base_addr + 0x3c, rw, 0x00000000 >
  {
    ...
    using CCR3_H  = regbits< type, 16, 16 >;  /**< High Capture/Compare value (TIM2 only)  */
  ...
  : public reg< uint32_t, base_addr + 0x40, rw, 0x00000000 >
  {
    ...
    using CCR4_H  = regbits< type, 16, 16 >;  /**< High Capture/Compare value (TIM2 only)  */
  ...
  : public reg< uint32_t, base_addr + 0x4c, rw, 0x0000 >
  {
    ...
    // fixme: Field name equals parent register name: DMAR
    using DMAR_ = regbits< type,  0, 16 >;  /**< DMA register for burst accesses  */
  };
};
} // namespace mptl
