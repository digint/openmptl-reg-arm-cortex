...
template<> struct address_map< 0x40007800 > { static constexpr const char * name_str = "CEC::CFGR"; };
template<> struct address_map< 0x40007804 > { static constexpr const char * name_str = "CEC::OAR"; };
template<> struct address_map< 0x40007808 > { static constexpr const char * name_str = "CEC::PRES"; };
template<> struct address_map< 0x4000780c > { static constexpr const char * name_str = "CEC::ESR"; };
template<> struct address_map< 0x40007810 > { static constexpr const char * name_str = "CEC::CSR"; };
template<> struct address_map< 0x40007814 > { static constexpr const char * name_str = "CEC::TXD"; };
template<> struct address_map< 0x40007818 > { static constexpr const char * name_str = "CEC::RXD"; };
