...
struct ADC1
{
  ...
  : public reg< uint32_t, base_addr + 0x14, rw, 0x00000000 >
  {
    ...
    using JOFFSET1  = regbits< type,  0, 12 >;  /**< Data offset for injected channel 1  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
    ...
    using JOFFSET2  = regbits< type,  0, 12 >;  /**< Data offset for injected channel 2  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x00000000 >
  {
    ...
    using JOFFSET3  = regbits< type,  0, 12 >;  /**< Data offset for injected channel 3  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x20, rw, 0x00000000 >
  {
    ...
    using JOFFSET4  = regbits< type,  0, 12 >;  /**< Data offset for injected channel 4  */
  };
