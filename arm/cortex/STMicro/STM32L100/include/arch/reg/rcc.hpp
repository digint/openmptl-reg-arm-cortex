...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0x00000000 >
  {
    ...
    using DMARST    = regbits< type, 24,  1 >;  /**< DMA1 reset       */
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x00008000 >
  {
    ...
    using DMAEN     = regbits< type, 24,  1 >;  /**< DMA1 clock enable       */
  ...
  : public reg< uint32_t, base_addr + 0x28, rw, 0x0101903F >
  {
    ...
    using DMALPEN    = regbits< type, 24,  1 >;  /**< DMA1 clock enable during Sleep mode       */
