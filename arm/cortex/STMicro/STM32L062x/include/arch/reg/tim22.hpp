...
#ifndef ARCH_REG_TIM22_HPP_INCLUDED
#define ARCH_REG_TIM22_HPP_INCLUDED
...
struct TIM22
{
  ...
  : public reg< uint32_t, base_addr + 0x50, rw, 0x00000000 >
  {
    ...
    using ETR_RMP  = regbits< type,  0,  2 >;  /**< Timer22 ETR remap  */
    using TI1_RMP  = regbits< type,  2,  2 >;  /**< Timer22 TI1        */
  };
};
} // namespace mptl

#endif // ARCH_REG_TIM22_HPP_INCLUDED
