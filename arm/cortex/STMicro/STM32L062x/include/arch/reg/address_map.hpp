...
template<> struct address_map< 0x40026000 > { static constexpr const char * name_str = "AES::CR"; };
template<> struct address_map< 0x40026004 > { static constexpr const char * name_str = "AES::SR"; };
template<> struct address_map< 0x40026008 > { static constexpr const char * name_str = "AES::DINR"; };
template<> struct address_map< 0x4002600c > { static constexpr const char * name_str = "AES::DOUTR"; };
template<> struct address_map< 0x40026010 > { static constexpr const char * name_str = "AES::KEYR0"; };
template<> struct address_map< 0x40026014 > { static constexpr const char * name_str = "AES::KEYR1"; };
template<> struct address_map< 0x40026018 > { static constexpr const char * name_str = "AES::KEYR2"; };
template<> struct address_map< 0x4002601c > { static constexpr const char * name_str = "AES::KEYR3"; };
template<> struct address_map< 0x40026020 > { static constexpr const char * name_str = "AES::IVR0"; };
template<> struct address_map< 0x40026024 > { static constexpr const char * name_str = "AES::IVR1"; };
template<> struct address_map< 0x40026028 > { static constexpr const char * name_str = "AES::IVR2"; };
template<> struct address_map< 0x4002602c > { static constexpr const char * name_str = "AES::IVR3"; };
