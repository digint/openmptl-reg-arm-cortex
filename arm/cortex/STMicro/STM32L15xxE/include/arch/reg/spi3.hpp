...
#ifndef ARCH_REG_SPI3_HPP_INCLUDED
#define ARCH_REG_SPI3_HPP_INCLUDED
...
struct SPI3
{
   ...
   */
  struct CR1
  : public reg< uint32_t, base_addr + 0xf800, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xf800, rw, 0x0000 >;
   ...
   */
  struct CR2
  : public reg< uint32_t, base_addr + 0xf804, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xf804, rw, 0x0000 >;
   ...
   */
  struct SR
  : public reg< uint32_t, base_addr + 0xf808, rw, 0x0002 >
  {
    using type = reg< uint32_t, base_addr + 0xf808, rw, 0x0002 >;
   ...
   */
  struct DR
  : public reg< uint32_t, base_addr + 0xf80c, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xf80c, rw, 0x0000 >;
   ...
   */
  struct CRCPR
  : public reg< uint32_t, base_addr + 0xf810, rw, 0x0007 >
  {
    using type = reg< uint32_t, base_addr + 0xf810, rw, 0x0007 >;
   ...
   */
  struct RXCRCR
  : public reg< uint32_t, base_addr + 0xf814, ro, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xf814, ro, 0x0000 >;
   ...
   */
  struct TXCRCR
  : public reg< uint32_t, base_addr + 0xf818, ro, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xf818, ro, 0x0000 >;
   ...
   */
  struct I2SCFGR
  : public reg< uint32_t, base_addr + 0xf81c, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xf81c, rw, 0x0000 >;
   ...
   */
  struct I2SPR
  : public reg< uint32_t, base_addr + 0xf820, rw, 0x00000002 >
  {
    using type = reg< uint32_t, base_addr + 0xf820, rw, 0x00000002 >;
...
#endif // ARCH_REG_SPI3_HPP_INCLUDED
