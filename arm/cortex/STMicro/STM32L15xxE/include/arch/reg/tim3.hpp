...
#ifndef ARCH_REG_TIM3_HPP_INCLUDED
#define ARCH_REG_TIM3_HPP_INCLUDED
...
struct TIM3
{
   ...
   */
  struct CR1
  : public reg< uint32_t, base_addr + 0xfffffc00, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc00, rw, 0x0000 >;
   ...
   */
  struct CR2
  : public reg< uint32_t, base_addr + 0xfffffc04, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc04, rw, 0x0000 >;
   ...
   */
  struct SMCR
  : public reg< uint32_t, base_addr + 0xfffffc08, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc08, rw, 0x0000 >;
   ...
   */
  struct DIER
  : public reg< uint32_t, base_addr + 0xfffffc0c, wo, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc0c, wo, 0x0000 >;
   ...
   */
  struct SR
  : public reg< uint32_t, base_addr + 0xfffffc10, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc10, rw, 0x0000 >;
   ...
   */
  struct EGR
  : public reg< uint32_t, base_addr + 0xfffffc14, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc14, rw, 0x0000 >;
   ...
   */
  struct CCMR1_Output
  : public reg< uint32_t, base_addr + 0xfffffc18, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc18, rw, 0x0000 >;
   ...
   */
  struct CCMR1_Input
  : public reg< uint32_t, base_addr + 0xfffffc18, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc18, rw, 0x00000000 >;
   ...
   */
  struct CCMR2_Output
  : public reg< uint32_t, base_addr + 0xfffffc1c, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc1c, rw, 0x0000 >;
   ...
   */
  struct CCMR2_Input
  : public reg< uint32_t, base_addr + 0xfffffc1c, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc1c, rw, 0x00000000 >;
   ...
   */
  struct CCER
  : public reg< uint32_t, base_addr + 0xfffffc20, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc20, rw, 0x0000 >;
   ...
   */
  struct CNT
  : public reg< uint32_t, base_addr + 0xfffffc24, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc24, rw, 0x0000 >;
   ...
   */
  struct PSC
  : public reg< uint32_t, base_addr + 0xfffffc28, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc28, rw, 0x0000 >;
   ...
   */
  struct ARR
  : public reg< uint32_t, base_addr + 0xfffffc2c, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc2c, rw, 0x0000 >;
   ...
   */
  struct CCR1
  : public reg< uint32_t, base_addr + 0xfffffc34, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc34, rw, 0x0000 >;
   ...
   */
  struct CCR2
  : public reg< uint32_t, base_addr + 0xfffffc38, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc38, rw, 0x0000 >;
   ...
   */
  struct CCR3
  : public reg< uint32_t, base_addr + 0xfffffc3c, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc3c, rw, 0x00000000 >;
   ...
   */
  struct CCR4
  : public reg< uint32_t, base_addr + 0xfffffc40, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc40, rw, 0x00000000 >;
   ...
   */
  struct DCR
  : public reg< uint32_t, base_addr + 0xfffffc48, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc48, rw, 0x0000 >;
   ...
   */
  struct DMAR
  : public reg< uint32_t, base_addr + 0xfffffc4c, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffffc4c, rw, 0x0000 >;
...
#endif // ARCH_REG_TIM3_HPP_INCLUDED
