...
#ifndef ARCH_REG_GPIOG_HPP_INCLUDED
#define ARCH_REG_GPIOG_HPP_INCLUDED
...
struct GPIOG
{
  static constexpr reg_addr_t base_addr = 0x40021c00;

  /**
   * GPIO port mode register
   */
  struct MODER
  : public reg< uint32_t, base_addr + 0xfffff800, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffff800, rw, 0x00000000 >;
   ...
   */
  struct OTYPER
  : public reg< uint32_t, base_addr + 0xfffff804, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffff804, rw, 0x00000000 >;
   ...
   */
  struct OSPEEDER
  : public reg< uint32_t, base_addr + 0xfffff808, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffff808, rw, 0x00000000 >;

    using OSPEEDR15  = regbits< type, 30,  2 >;  /**< OSPEEDR15  */
    using OSPEEDR14  = regbits< type, 28,  2 >;  /**< OSPEEDR14  */
    using OSPEEDR13  = regbits< type, 26,  2 >;  /**< OSPEEDR13  */
    using OSPEEDR12  = regbits< type, 24,  2 >;  /**< OSPEEDR12  */
    using OSPEEDR11  = regbits< type, 22,  2 >;  /**< OSPEEDR11  */
    using OSPEEDR10  = regbits< type, 20,  2 >;  /**< OSPEEDR10  */
    using OSPEEDR9   = regbits< type, 18,  2 >;  /**< OSPEEDR9   */
    using OSPEEDR8   = regbits< type, 16,  2 >;  /**< OSPEEDR8   */
    using OSPEEDR7   = regbits< type, 14,  2 >;  /**< OSPEEDR7   */
    using OSPEEDR6   = regbits< type, 12,  2 >;  /**< OSPEEDR6   */
    using OSPEEDR5   = regbits< type, 10,  2 >;  /**< OSPEEDR5   */
    using OSPEEDR4   = regbits< type,  8,  2 >;  /**< OSPEEDR4   */
    using OSPEEDR3   = regbits< type,  6,  2 >;  /**< OSPEEDR3   */
    using OSPEEDR2   = regbits< type,  4,  2 >;  /**< OSPEEDR2   */
    using OSPEEDR1   = regbits< type,  2,  2 >;  /**< OSPEEDR1   */
    using OSPEEDR0   = regbits< type,  0,  2 >;  /**< OSPEEDR0   */
  };
   ...
   */
  struct PUPDR
  : public reg< uint32_t, base_addr + 0xfffff80c, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffff80c, rw, 0x00000000 >;
   ...
   */
  struct IDR
  : public reg< uint32_t, base_addr + 0xfffff810, ro, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffff810, ro, 0x00000000 >;
   ...
   */
  struct ODR
  : public reg< uint32_t, base_addr + 0xfffff814, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffff814, rw, 0x00000000 >;
   ...
   */
  struct BSRR
  : public reg< uint32_t, base_addr + 0xfffff818, wo, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffff818, wo, 0x00000000 >;
   ...
   */
  struct LCKR
  : public reg< uint32_t, base_addr + 0xfffff81c, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffff81c, rw, 0x00000000 >;
   ...
   */
  struct AFRL
  : public reg< uint32_t, base_addr + 0xfffff820, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffff820, rw, 0x00000000 >;
   ...
   */
  struct AFRH
  : public reg< uint32_t, base_addr + 0xfffff824, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xfffff824, rw, 0x00000000 >;
...
#endif // ARCH_REG_GPIOG_HPP_INCLUDED
