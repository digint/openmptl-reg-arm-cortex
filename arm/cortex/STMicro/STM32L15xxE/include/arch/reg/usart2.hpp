...
struct USART2
{
  static constexpr reg_addr_t base_addr = 0x40004400;

  /**
   * Status register
   */
  struct SR
  : public reg< uint32_t, base_addr + 0xf000, rw, 0x00C00000 >
  {
    using type = reg< uint32_t, base_addr + 0xf000, rw, 0x00C00000 >;
   ...
   */
  struct DR
  : public reg< uint32_t, base_addr + 0xf004, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xf004, rw, 0x00000000 >;
   ...
   */
  struct BRR
  : public reg< uint32_t, base_addr + 0xf008, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xf008, rw, 0x00000000 >;
   ...
   */
  struct CR1
  : public reg< uint32_t, base_addr + 0xf00c, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xf00c, rw, 0x00000000 >;
   ...
   */
  struct CR2
  : public reg< uint32_t, base_addr + 0xf010, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xf010, rw, 0x00000000 >;
   ...
   */
  struct CR3
  : public reg< uint32_t, base_addr + 0xf014, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xf014, rw, 0x00000000 >;
   ...
   */
  struct GTPR
  : public reg< uint32_t, base_addr + 0xf018, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0xf018, rw, 0x00000000 >;
