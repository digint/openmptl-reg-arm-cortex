...
#ifndef ARCH_REG_SC1_SPI_HPP_INCLUDED
#define ARCH_REG_SC1_SPI_HPP_INCLUDED
...
struct SC1_SPI
{
  static constexpr reg_addr_t base_addr = 0x4000c840;
...
#endif // ARCH_REG_SC1_SPI_HPP_INCLUDED
