...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0x00000000 >
  {
    ...
    using USBPRE    = regbits< type, 22,  1 >;  /**< USB prescaler                    */
    using MCO       = regbits< type, 24,  3 >;  /**< Microcontroller clock output     */
    using SDPRE     = regbits< type, 27,  5 >;  /**< SDADC prescaler                  */
  };
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0x00000000 >
  {
    ...
    using TIM19RST   = regbits< type, 19,  1 >;  /**< TIM19 timer reset                 */
    using SDAD1RST   = regbits< type, 24,  1 >;  /**< SDADC1 (Sigma delta ADC 1) reset  */
    using SDAD2RST   = regbits< type, 25,  1 >;  /**< SDADC2 (Sigma delta ADC 2) reset  */
    using SDAD3RST   = regbits< type, 26,  1 >;  /**< SDADC3 (Sigma delta ADC 3) reset  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0x00000000 >
  {
    ...
    using TIM18RST   = regbits< type,  9,  1 >;  /**< Timer 18 reset         */
    ...
    using DAC3RST    = regbits< type, 26,  1 >;  /**< DAC3 reset             */
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
    ...
    using TIM19EN   = regbits< type, 19,  1 >;  /**< TIM19 timer clock enable                 */
    using DBGMCUEN  = regbits< type, 22,  1 >;  /**< MCU debug module clock enable            */
    using SDAD1EN   = regbits< type, 24,  1 >;  /**< SDADC1 (Sigma Delta ADC 1) clock enable  */
    using SDAD2EN   = regbits< type, 25,  1 >;  /**< SDADC2 (Sigma Delta ADC 2) clock enable  */
    using SDAD3EN   = regbits< type, 26,  1 >;  /**< SDADC3 (Sigma Delta ADC 3) clock enable  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x00000000 >
  {
    ...
    using TIM18EN   = regbits< type,  9,  1 >;  /**< Timer 18 clock enable            */
    ...
    using DAC3EN    = regbits< type, 26,  1 >;  /**< DAC3 interface clock enable      */
