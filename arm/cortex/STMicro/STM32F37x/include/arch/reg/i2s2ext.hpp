...
#ifndef ARCH_REG_I2S2EXT_HPP_INCLUDED
#define ARCH_REG_I2S2EXT_HPP_INCLUDED
...
struct I2S2ext
{
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x0002 >
  {
    ...
    using FRLVL   = regbits< type,  9,  2 >;  /**< FIFO reception level      */
    using FTLVL   = regbits< type, 11,  2 >;  /**< FIFO transmission level   */
  };
...
#endif // ARCH_REG_I2S2EXT_HPP_INCLUDED
