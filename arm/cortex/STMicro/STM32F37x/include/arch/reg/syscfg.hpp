...
struct SYSCFG
{
  ...
  : public reg< uint32_t, base_addr + 0x0, rw, 0x00000000 >
  {
    ...
    using TIM18_DAC3_DMA_RMP  = regbits< type, 15,  1 >;  /**< TIM18 and DAC3 DMA request remapping bit                  */
    ...
    using VBAT_MON            = regbits< type, 24,  1 >;  /**< VBAT monitoring enable                                    */
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x0000 >
  {
    ...
    using LOCUP_LOCK        = regbits< type,  0,  1 >;  /**< Cortex-M4 LOCKUP bit enable bit  */
  };
};
} // namespace mptl
