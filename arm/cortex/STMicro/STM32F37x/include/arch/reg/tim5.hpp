...
struct TIM5
{
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x00000000 >
  {
    ...
    using CNTH  = regbits< type, 16, 16 >;  /**< High counter value  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x34, rw, 0x00000000 >
  {
    ...
    using CCR1H  = regbits< type, 16, 16 >;  /**< High Capture/Compare 1 value  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x38, rw, 0x00000000 >
  {
    ...
    using CCR2H  = regbits< type, 16, 16 >;  /**< High Capture/Compare 2 value  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x3c, rw, 0x00000000 >
  {
    ...
    using CCR3H  = regbits< type, 16, 16 >;  /**< High Capture/Compare value  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x40, rw, 0x00000000 >
  {
    ...
    using CCR4H  = regbits< type, 16, 16 >;  /**< High Capture/Compare value  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x50, rw, 0x0000 >
  {
    ...
    using IT4_RMP  = regbits< type,  6,  2 >;  /**< Timer Input 4 remap  */
  };
};
} // namespace mptl
