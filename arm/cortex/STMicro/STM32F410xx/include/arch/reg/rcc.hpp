...
struct RCC
{
   ...
   */
  struct PLLCFGR
  : public reg< uint32_t, base_addr + 0x4, rw, 0x7F003010 >
  {
    using type = reg< uint32_t, base_addr + 0x4, rw, 0x7F003010 >;
    ...
    using PLLR1   = regbits< type, 28,  1 >;  /**< PLLR1                                                                                   */
    using PLLR2   = regbits< type, 29,  1 >;  /**< PLLR2                                                                                   */
    using PLLR3   = regbits< type, 30,  1 >;  /**< PLLR3                                                                                   */
  };
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x00000000 >
  {
    ...
    using MCO1EN   = regbits< type,  8,  1 >;  /**< MCO output enable                  */
    using MCO2EN   = regbits< type,  9,  1 >;  /**< MCO output enable                  */
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0x00000000 >
  {
    ...
    using RNGRST    = regbits< type, 31,  1 >;  /**< RNGRST           */
  };
  ...
  : public reg< uint32_t, base_addr + 0x20, rw, 0x00000000 >
  {
    ...
    using LPTIM1RST  = regbits< type,  9,  1 >;  /**< LPTIM1 reset           */
    ...
    using I2C4RST    = regbits< type, 24,  1 >;  /**< I2C4 reset             */
  ...
  : public reg< uint32_t, base_addr + 0x30, rw, 0x00100000 >
  {
    ...
    using RNGEN    = regbits< type, 31,  1 >;  /**< RNG clock enable        */
  };
  ...
  : public reg< uint32_t, base_addr + 0x40, rw, 0x00000000 >
  {
    ...
    using LPTIM1EN  = regbits< type,  9,  1 >;  /**< LPTIM1 clock enable           */
    using RTCAPBEN  = regbits< type, 10,  1 >;  /**< RTC APB clock enable          */
  ...
  : public reg< uint32_t, base_addr + 0x44, rw, 0x00000000 >
  {
    ...
    using EXTITEN   = regbits< type, 15,  1 >;  /**< EXTI ans external IT clock enable             */
  ...
  : public reg< uint32_t, base_addr + 0x50, rw, 0x7E6791FF >
  {
    ...
    using RNGLPEN    = regbits< type, 31,  1 >;  /**< RNG clock enable during sleep mode              */
  };
  ...
  : public reg< uint32_t, base_addr + 0x60, rw, 0x36FEC9FF >
  {
    ...
    using LPTIM1LPEN  = regbits< type,  9,  1 >;  /**< LPTIM1 clock enable during sleep mode           */
    using RTCAPBLPEN  = regbits< type, 10,  1 >;  /**< RTC APB clock enable during sleep mode          */
  ...
  : public reg< uint32_t, base_addr + 0x64, rw, 0x00075F33 >
  {
    ...
    using EXTITLPEN   = regbits< type, 15,  1 >;  /**< EXTI and External IT clock enable during sleep mode             */
  ...
  : public reg< uint32_t, base_addr + 0x8c, rw, 0x00000000 >
  {
    ...
    using I2SSRC  = regbits< type, 25,  2 >;  /**< I2SSRC  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x94, rw, 0x00000000 >
  {
    ...
    using I2C4SEL    = regbits< type, 22,  2 >;  /**< I2C4SEL    */
    using LPTIM1SEL  = regbits< type, 30,  2 >;  /**< LPTIM1SEL  */
  };
};
} // namespace mptl
