...
struct FLASH
{
   ...
   */
  struct OPTCR
  : public reg< uint32_t, base_addr + 0x14, rw, 0x7FFFAAED >
  {
    using type = reg< uint32_t, base_addr + 0x14, rw, 0x7FFFAAED >;
    ...
    using nWRP        = regbits< type, 16,  5 >;  /**< Not write protect             */
    using SPRMOD      = regbits< type, 31,  1 >;  /**< SPRMOD                        */
  };
};
} // namespace mptl
