...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0x000000000 >
  {
    ...
    using ADC3RST    = regbits< type, 15,  1 >;  /**< ADC 3 interface reset         */
  ...
  : public reg< uint32_t, base_addr + 0x14, rw, 0x00000014 >
  {
    ...
    using SDIOEN   = regbits< type, 10,  1 >;  /**< SDIO clock enable            */
  };
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
    ...
    using ADC3EN    = regbits< type, 15,  1 >;  /**< ADC3 interface clock enable          */
