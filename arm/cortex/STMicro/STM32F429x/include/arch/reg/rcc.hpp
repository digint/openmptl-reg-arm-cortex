...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0x88, rw, 0x24003000 >
  {
    ...
    using PLLSAIN  = regbits< type,  6,  9 >;  /**< PLLSAIN  */
    using PLLSAIQ  = regbits< type, 24,  4 >;  /**< PLLSAIN  */
    using PLLSAIR  = regbits< type, 28,  3 >;  /**< PLLSAIN  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x8c, rw, 0x00000000 >
  {
    ...
    using PLLI2SDIVQ  = regbits< type,  0,  5 >;  /**< PLLI2SDIVQ  */
    using PLLSAIDIVQ  = regbits< type,  8,  5 >;  /**< PLLSAIDIVQ  */
    using PLLSAIDIVR  = regbits< type, 16,  2 >;  /**< PLLSAIDIVR  */
    using SAI1ASRC    = regbits< type, 20,  2 >;  /**< SAI1ASRC    */
    using SAI1BSRC    = regbits< type, 22,  2 >;  /**< SAI1BSRC    */
    using TIMPRE      = regbits< type, 24,  1 >;  /**< TIMPRE      */
  };
};
} // namespace mptl
