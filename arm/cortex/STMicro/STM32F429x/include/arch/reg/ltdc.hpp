...
#ifndef ARCH_REG_LTDC_HPP_INCLUDED
#define ARCH_REG_LTDC_HPP_INCLUDED
...
struct LTDC
{
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x00000000 >
  {
    ...
    using HSW  = regbits< type, 16, 12 >;  /**< Horizontal Synchronization Width (in units of pixel clock period)   */
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0x00000000 >
  {
    ...
    using AHBP  = regbits< type, 16, 12 >;  /**< Accumulated Horizontal back porch (in units of pixel clock period)  */
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0x00000000 >
  {
    ...
    using AAW  = regbits< type, 16, 12 >;  /**< Accumulated Active Width (in units of pixel clock period)     */
  ...
  : public reg< uint32_t, base_addr + 0x14, rw, 0x00000000 >
  {
    ...
    using TOTALW  = regbits< type, 16, 12 >;  /**< Total Width (in units of pixel clock period)     */
...
#endif // ARCH_REG_LTDC_HPP_INCLUDED
