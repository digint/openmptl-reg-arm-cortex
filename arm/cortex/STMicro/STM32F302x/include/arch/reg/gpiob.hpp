...
struct GPIOB
{
  static constexpr reg_addr_t base_addr = 0x48000400;

  /**
   * GPIO port mode register
   */
  struct MODER
  : public reg< uint32_t, base_addr + 0x0, rw, 0x00000280 >
  {
    using type = reg< uint32_t, base_addr + 0x0, rw, 0x00000280 >;
   ...
   */
  struct OSPEEDR
  : public reg< uint32_t, base_addr + 0x8, rw, 0x000000C0 >
  {
    using type = reg< uint32_t, base_addr + 0x8, rw, 0x000000C0 >;
   ...
   */
  struct PUPDR
  : public reg< uint32_t, base_addr + 0xc, rw, 0x00000100 >
  {
    using type = reg< uint32_t, base_addr + 0xc, rw, 0x00000100 >;
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x00000000 >
  {
    ...
    using LCKK   = regbits< type, 16,  1 >;  /**< Lok Key                       */
  ...
  : public reg< uint32_t, base_addr + 0x28, wo, 0x00000000 >
  {
    ...
    using BR0   = regbits< type,  0,  1 >;  /**< Port x Reset bit y  */
    using BR1   = regbits< type,  1,  1 >;  /**< Port x Reset bit y  */
    using BR2   = regbits< type,  2,  1 >;  /**< Port x Reset bit y  */
    using BR3   = regbits< type,  3,  1 >;  /**< Port x Reset bit y  */
    using BR4   = regbits< type,  4,  1 >;  /**< Port x Reset bit y  */
    using BR5   = regbits< type,  5,  1 >;  /**< Port x Reset bit y  */
    using BR6   = regbits< type,  6,  1 >;  /**< Port x Reset bit y  */
    using BR7   = regbits< type,  7,  1 >;  /**< Port x Reset bit y  */
    using BR8   = regbits< type,  8,  1 >;  /**< Port x Reset bit y  */
    using BR9   = regbits< type,  9,  1 >;  /**< Port x Reset bit y  */
    using BR10  = regbits< type, 10,  1 >;  /**< Port x Reset bit y  */
    using BR11  = regbits< type, 11,  1 >;  /**< Port x Reset bit y  */
    using BR12  = regbits< type, 12,  1 >;  /**< Port x Reset bit y  */
    using BR13  = regbits< type, 13,  1 >;  /**< Port x Reset bit y  */
    using BR14  = regbits< type, 14,  1 >;  /**< Port x Reset bit y  */
    using BR15  = regbits< type, 15,  1 >;  /**< Port x Reset bit y  */
  };
};
} // namespace mptl
