...
struct I2C3
{
  ...
  : public reg< uint32_t, base_addr + 0x0, rw, 0x00000000 >
  {
    ...
    using SWRST      = regbits< type, 13,  1 >;  /**< Software reset                               */
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0x00000000 >
  {
    ...
    using SADD8    = regbits< type,  8,  2 >;  /**< Slave address bit 9:8 (master mode)                               */
    using SADD1    = regbits< type,  1,  7 >;  /**< Slave address bit 7:1 (master mode)                               */
    using SADD0    = regbits< type,  0,  1 >;  /**< Slave address bit 0 (master mode)                                 */
  };
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x00000000 >
  {
    ...
    using OA1_0    = regbits< type,  0,  1 >;  /**< Interface address          */
    using OA1_1    = regbits< type,  1,  7 >;  /**< Interface address          */
    using OA1_8    = regbits< type,  8,  2 >;  /**< Interface address          */
