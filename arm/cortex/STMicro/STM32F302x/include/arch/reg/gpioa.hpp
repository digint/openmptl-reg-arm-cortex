...
struct GPIOA
{
  static constexpr reg_addr_t base_addr = 0x48000000;

  /**
   * GPIO port mode register
   */
  struct MODER
  : public reg< uint32_t, base_addr + 0x0, rw, 0xA8000000 >
  {
    using type = reg< uint32_t, base_addr + 0x0, rw, 0xA8000000 >;
   ...
   */
  struct OSPEEDR
  : public reg< uint32_t, base_addr + 0x8, rw, 0xC0000000 >
  {
    using type = reg< uint32_t, base_addr + 0x8, rw, 0xC0000000 >;
   ...
   */
  struct PUPDR
  : public reg< uint32_t, base_addr + 0xc, rw, 0x64000000 >
  {
    using type = reg< uint32_t, base_addr + 0xc, rw, 0x64000000 >;
