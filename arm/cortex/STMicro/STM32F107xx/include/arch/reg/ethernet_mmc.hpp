...
struct ETHERNET_MMC
{
  ...
  : public reg< uint32_t, base_addr + 0x0, rw, 0x00000000 >
  {
    ...
    using MCF  = regbits< type, 31,  1 >;  /**< MMC counter freeze     */
  };
  ...
  : public reg< uint32_t, base_addr + 0x4c, ro, 0x00000000 >
  {
    ...
    using TGFSCC  = regbits< type,  0, 32 >;  /**< Transmitted good frames after a single collision counter  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x50, ro, 0x00000000 >
  {
    ...
    using TGFMSCC  = regbits< type,  0, 32 >;  /**< Transmitted good frames after more than a single collision counter  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x94, ro, 0x00000000 >
  {
    ...
    using RFCFC  = regbits< type,  0, 32 >;  /**< Received frames with CRC error counter  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x98, ro, 0x00000000 >
  {
    ...
    using RFAEC  = regbits< type,  0, 32 >;  /**< Received frames with alignment error counter  */
  };
