...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0x14, rw, 0x00000014 >
  {
    ...
    using ETHMACEN    = regbits< type, 14,  1 >;  /**< Ethernet MAC clock enable     */
    using ETHMACTXEN  = regbits< type, 15,  1 >;  /**< Ethernet MAC TX clock enable  */
    using ETHMACRXEN  = regbits< type, 16,  1 >;  /**< Ethernet MAC RX clock enable  */
  };
