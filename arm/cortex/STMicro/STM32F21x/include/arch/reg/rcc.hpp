...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x00000000 >
  {
    ...
    using MCO21     = regbits< type, 31,  1 >;  /**< Microcontroller clock output 2     */
    using MCO20     = regbits< type, 30,  1 >;  /**< Microcontroller clock output 2     */
    using MCO2PRE2  = regbits< type, 29,  1 >;  /**< MCO2 prescaler                     */
    using MCO2PRE1  = regbits< type, 28,  1 >;  /**< MCO2 prescaler                     */
    using MCO2PRE0  = regbits< type, 27,  1 >;  /**< MCO2 prescaler                     */
    using MCO1PRE2  = regbits< type, 26,  1 >;  /**< MCO1 prescaler                     */
    using MCO1PRE1  = regbits< type, 25,  1 >;  /**< MCO1 prescaler                     */
    using MCO1PRE0  = regbits< type, 24,  1 >;  /**< MCO1 prescaler                     */
    using I2SSRC    = regbits< type, 23,  1 >;  /**< I2S clock selection                */
    using MCO11     = regbits< type, 22,  1 >;  /**< Microcontroller clock output 1     */
    using MCO10     = regbits< type, 21,  1 >;  /**< Microcontroller clock output 1     */
    using RTCPRE4   = regbits< type, 20,  1 >;  /**< HSE division factor for RTC clock  */
    using RTCPRE3   = regbits< type, 19,  1 >;  /**< HSE division factor for RTC clock  */
    using RTCPRE2   = regbits< type, 18,  1 >;  /**< HSE division factor for RTC clock  */
    using RTCPRE1   = regbits< type, 17,  1 >;  /**< HSE division factor for RTC clock  */
    using RTCPRE0   = regbits< type, 16,  1 >;  /**< HSE division factor for RTC clock  */
    using PPRE22    = regbits< type, 15,  1 >;  /**< APB high-speed prescaler (APB2)    */
    using PPRE21    = regbits< type, 14,  1 >;  /**< APB high-speed prescaler (APB2)    */
    using PPRE20    = regbits< type, 13,  1 >;  /**< APB high-speed prescaler (APB2)    */
    using PPRE12    = regbits< type, 12,  1 >;  /**< APB Low speed prescaler (APB1)     */
    using PPRE11    = regbits< type, 11,  1 >;  /**< APB Low speed prescaler (APB1)     */
    using PPRE10    = regbits< type, 10,  1 >;  /**< APB Low speed prescaler (APB1)     */
    using HPRE3     = regbits< type,  7,  1 >;  /**< AHB prescaler                      */
    using HPRE2     = regbits< type,  6,  1 >;  /**< AHB prescaler                      */
    using HPRE1     = regbits< type,  5,  1 >;  /**< AHB prescaler                      */
    using HPRE0     = regbits< type,  4,  1 >;  /**< AHB prescaler                      */
  ...
  : public reg< uint32_t, base_addr + 0x84, rw, 0x20003000 >
  {
    ...
    using PLLI2SN0  = regbits< type,  6,  1 >;  /**< PLLI2S multiplication factor for VCO   */
    using PLLI2SN1  = regbits< type,  7,  1 >;  /**< PLLI2S multiplication factor for VCO   */
    using PLLI2SN2  = regbits< type,  8,  1 >;  /**< PLLI2S multiplication factor for VCO   */
    using PLLI2SN3  = regbits< type,  9,  1 >;  /**< PLLI2S multiplication factor for VCO   */
    using PLLI2SN4  = regbits< type, 10,  1 >;  /**< PLLI2S multiplication factor for VCO   */
    using PLLI2SN5  = regbits< type, 11,  1 >;  /**< PLLI2S multiplication factor for VCO   */
    using PLLI2SN6  = regbits< type, 12,  1 >;  /**< PLLI2S multiplication factor for VCO   */
    using PLLI2SN7  = regbits< type, 13,  1 >;  /**< PLLI2S multiplication factor for VCO   */
    using PLLI2SN8  = regbits< type, 14,  1 >;  /**< PLLI2S multiplication factor for VCO   */
    using PLLI2SR0  = regbits< type, 28,  1 >;  /**< PLLI2S division factor for I2S clocks  */
    using PLLI2SR1  = regbits< type, 29,  1 >;  /**< PLLI2S division factor for I2S clocks  */
    using PLLI2SR2  = regbits< type, 30,  1 >;  /**< PLLI2S division factor for I2S clocks  */
  };
};
} // namespace mptl
