...
#ifndef ARCH_REG_TIM16_HPP_INCLUDED
#define ARCH_REG_TIM16_HPP_INCLUDED
...
struct TIM16
{
  static constexpr reg_addr_t base_addr = 0x40014400;
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
    ...
    using OC1M_2  = regbits< type, 16,  1 >;  /**< Output Compare 1 mode            */
  ...
  : public reg< uint32_t, base_addr + 0x50, rw, 0x0000 >
  {
    ...
    using TI1_RMP  = regbits< type,  0,  2 >;  /**< Input capture 1 remap  */
  };
   ...
   */
  struct OR2
  : public reg< uint32_t, base_addr + 0x60, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0x60, rw, 0x0000 >;
    ...
    using BKDFBK1E  = regbits< type,  8,  1 >;  /**< BRK DFSDM_BREAK1 enable   */
    using BKINP     = regbits< type,  9,  1 >;  /**< BRK BKIN input polarity   */
    using BKCMP1P   = regbits< type, 10,  1 >;  /**< BRK COMP1 input polarity  */
    using BKCMP2P   = regbits< type, 11,  1 >;  /**< BRK COMP2 input polarit   */
  };
};
} // namespace mptl

#endif // ARCH_REG_TIM16_HPP_INCLUDED
