...
struct TIM8
{
  ...
  : public reg< uint32_t, base_addr + 0x50, rw, 0x0000 >
  {
    ...
    using ETR_ADC2_RMP  = regbits< type,  0,  2 >;  /**< External trigger remap on ADC2 analog watchdog  */
  ...
  : public reg< uint32_t, base_addr + 0x60, rw, 0x00000001 >
  {
    ...
    using BKDFBK2E  = regbits< type,  8,  1 >;  /**< BRK DFSDM_BREAK2 enable   */
  ...
  : public reg< uint32_t, base_addr + 0x64, rw, 0x00000001 >
  {
    ...
    using BK2DFBK3E  = regbits< type,  8,  1 >;  /**< BRK2 DFSDM_BREAK3 enable   */
