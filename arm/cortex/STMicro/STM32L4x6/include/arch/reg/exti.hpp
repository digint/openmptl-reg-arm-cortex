...
struct EXTI
{
   ...
   */
  struct IMR1
  : public reg< uint32_t, base_addr + 0x0, rw, 0xFF820000 >
  {
    using type = reg< uint32_t, base_addr + 0x0, rw, 0xFF820000 >;
   ...
   */
  struct IMR2
  : public reg< uint32_t, base_addr + 0x20, rw, 0xFFFFFF87 >
  {
    using type = reg< uint32_t, base_addr + 0x20, rw, 0xFFFFFF87 >;
    ...
    using MR36  = regbits< type,  4,  1 >;  /**< Interrupt Mask on external/internal line 36  */
    using MR37  = regbits< type,  5,  1 >;  /**< Interrupt Mask on external/internal line 37  */
    using MR38  = regbits< type,  6,  1 >;  /**< Interrupt Mask on external/internal line 38  */
    using MR39  = regbits< type,  7,  1 >;  /**< Interrupt Mask on external/internal line 39  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x00000000 >
  {
    ...
    using MR36  = regbits< type,  4,  1 >;  /**< Event mask on external/internal line 36  */
    using MR37  = regbits< type,  5,  1 >;  /**< Event mask on external/internal line 37  */
    using MR38  = regbits< type,  6,  1 >;  /**< Event mask on external/internal line 38  */
    using MR39  = regbits< type,  7,  1 >;  /**< Event mask on external/internal line 39  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x28, rw, 0x00000000 >
  {
    ...
    using RT35  = regbits< type,  3,  1 >;  /**< Rising trigger event configuration bit of line 35  */
    using RT36  = regbits< type,  4,  1 >;  /**< Rising trigger event configuration bit of line 36  */
    using RT37  = regbits< type,  5,  1 >;  /**< Rising trigger event configuration bit of line 37  */
    using RT38  = regbits< type,  6,  1 >;  /**< Rising trigger event configuration bit of line 38  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x2c, rw, 0x00000000 >
  {
    ...
    using FT35  = regbits< type,  3,  1 >;  /**< Falling trigger event configuration bit of line 35  */
    using FT36  = regbits< type,  4,  1 >;  /**< Falling trigger event configuration bit of line 36  */
    using FT37  = regbits< type,  5,  1 >;  /**< Falling trigger event configuration bit of line 37  */
    using FT38  = regbits< type,  6,  1 >;  /**< Falling trigger event configuration bit of line 38  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x30, rw, 0x00000000 >
  {
    ...
    using SWI35  = regbits< type,  3,  1 >;  /**< Software interrupt on line 35  */
    using SWI36  = regbits< type,  4,  1 >;  /**< Software interrupt on line 36  */
    using SWI37  = regbits< type,  5,  1 >;  /**< Software interrupt on line 37  */
    using SWI38  = regbits< type,  6,  1 >;  /**< Software interrupt on line 38  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x34, rw, 0x00000000 >
  {
    ...
    using PIF35  = regbits< type,  3,  1 >;  /**< Pending interrupt flag on line 35  */
    using PIF36  = regbits< type,  4,  1 >;  /**< Pending interrupt flag on line 36  */
    using PIF37  = regbits< type,  5,  1 >;  /**< Pending interrupt flag on line 37  */
    using PIF38  = regbits< type,  6,  1 >;  /**< Pending interrupt flag on line 38  */
  };
};
} // namespace mptl
