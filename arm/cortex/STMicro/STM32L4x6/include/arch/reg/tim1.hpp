...
struct TIM1
{
  ...
  : public reg< uint32_t, base_addr + 0x50, rw, 0x0000 >
  {
    ...
    using ETR_ADC1_RMP  = regbits< type,  0,  2 >;  /**< External trigger remap on ADC1 analog watchdog  */
    using ETR_ADC3_RMP  = regbits< type,  2,  2 >;  /**< External trigger remap on ADC3 analog watchdog  */
    using TI1_RMP       = regbits< type,  4,  1 >;  /**< Input Capture 1 remap                           */
  };
  ...
  : public reg< uint32_t, base_addr + 0x54, rw, 0x00000000 >
  {
    ...
    using OC6M_bit3  = regbits< type, 24,  1 >;  /**< Output Compare 6 mode bit 3      */
    using OC5M_bit3  = regbits< type, 16,  3 >;  /**< Output Compare 5 mode bit 3      */
  ...
  : public reg< uint32_t, base_addr + 0x58, rw, 0x00000000 >
  {
    ...
    using CCR5_  = regbits< type,  0, 16 >;  /**< Capture/Compare value          */
  ...
  : public reg< uint32_t, base_addr + 0x5c, rw, 0x00000000 >
  {
    ...
    using CCR6_ = regbits< type,  0, 16 >;  /**< Capture/Compare value  */
  };
   ...
   */
  struct OR2
  : public reg< uint32_t, base_addr + 0x60, rw, 0x00000001 >
  {
    using type = reg< uint32_t, base_addr + 0x60, rw, 0x00000001 >;

    using BKINE     = regbits< type,  0,  1 >;  /**< BRK BKIN input enable     */
    using BKCMP1E   = regbits< type,  1,  1 >;  /**< BRK COMP1 enable          */
    using BKCMP2E   = regbits< type,  2,  1 >;  /**< BRK COMP2 enable          */
    using BKDFBK0E  = regbits< type,  8,  1 >;  /**< BRK DFSDM_BREAK0 enable   */
    using BKINP     = regbits< type,  9,  1 >;  /**< BRK BKIN input polarity   */
    using BKCMP1P   = regbits< type, 10,  1 >;  /**< BRK COMP1 input polarity  */
    using BKCMP2P   = regbits< type, 11,  1 >;  /**< BRK COMP2 input polarity  */
    using ETRSEL    = regbits< type, 14,  3 >;  /**< ETR source selection      */
  };
   ...
   */
  struct OR3
  : public reg< uint32_t, base_addr + 0x64, rw, 0x00000001 >
  {
    using type = reg< uint32_t, base_addr + 0x64, rw, 0x00000001 >;

    using BK2INE     = regbits< type,  0,  1 >;  /**< BRK2 BKIN input enable     */
    using BK2CMP1E   = regbits< type,  1,  1 >;  /**< BRK2 COMP1 enable          */
    using BK2CMP2E   = regbits< type,  2,  1 >;  /**< BRK2 COMP2 enable          */
    using BK2DFBK0E  = regbits< type,  8,  1 >;  /**< BRK2 DFSDM_BREAK0 enable   */
    using BK2INP     = regbits< type,  9,  1 >;  /**< BRK2 BKIN input polarity   */
    using BK2CMP1P   = regbits< type, 10,  1 >;  /**< BRK2 COMP1 input polarity  */
    using BK2CMP2P   = regbits< type, 11,  1 >;  /**< BRK2 COMP2 input polarity  */
  };
};
} // namespace mptl
