...
struct AFIO
{
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0x00000000 >
  {
    ...
    using CAN_REMAP           = regbits< type, 13,  2 >;  /**< CAN1 remapping                                        */
    ...
    using ADC1_ETRGINJ_REMAP  = regbits< type, 17,  1 >;  /**< ADC 1 External trigger injected conversion remapping  */
    using ADC1_ETRGREG_REMAP  = regbits< type, 18,  1 >;  /**< ADC 1 external trigger regular conversion remapping   */
    using ADC2_ETRGINJ_REMAP  = regbits< type, 19,  1 >;  /**< ADC 2 external trigger injected conversion remapping  */
    using ADC2_ETRGREG_REMAP  = regbits< type, 20,  1 >;  /**< ADC 2 external trigger regular conversion remapping   */
