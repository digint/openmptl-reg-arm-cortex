...
struct DBG
{
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0x0 >
  {
    ...
    using DBG_TIM15_STOP          = regbits< type, 22,  1 >;  /**< TIM15 counter stopped when core is halted  */
    using DBG_TIM16_STOP          = regbits< type, 23,  1 >;  /**< TIM16 counter stopped when core is halted  */
    using DBG_TIM17_STOP          = regbits< type, 24,  1 >;  /**< TIM17 counter stopped when core is halted  */
    using DBG_TIM12_STOP          = regbits< type, 25,  1 >;  /**< TIM12 counter stopped when core is halted  */
    using DBG_TIM13_STOP          = regbits< type, 26,  1 >;  /**< TIM13 counter stopped when core is halted  */
    using DBG_TIM14_STOP          = regbits< type, 27,  1 >;  /**< TIM14 counter stopped when core is halted  */
  };
};
} // namespace mptl
