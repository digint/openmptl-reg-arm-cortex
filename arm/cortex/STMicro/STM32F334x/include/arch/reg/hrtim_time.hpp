...
#ifndef ARCH_REG_HRTIM_TIME_HPP_INCLUDED
#define ARCH_REG_HRTIM_TIME_HPP_INCLUDED
...
struct HRTIM_TIME
{
  static constexpr reg_addr_t base_addr = 0x40017680;
  ...
  : public reg< uint32_t, base_addr + 0x54, rw, 0x00000000 >
  {
    ...
    using TIMDCMP4   = regbits< type, 30,  1 >;  /**< Timer D Compare 4        */
    using TIMDCMP2   = regbits< type, 29,  1 >;  /**< Timer D Compare 2        */
    using TIMDCMP1   = regbits< type, 28,  1 >;  /**< Timer D Compare 1        */
    using TIMCCMP4   = regbits< type, 27,  1 >;  /**< Timer C Compare 4        */
    using TIMCCMP2   = regbits< type, 26,  1 >;  /**< Timer C Compare 2        */
    using TIMCCMP1   = regbits< type, 25,  1 >;  /**< Timer C Compare 1        */
    using TIMBCMP4   = regbits< type, 24,  1 >;  /**< Timer B Compare 4        */
    using TIMBCMP2   = regbits< type, 23,  1 >;  /**< Timer B Compare 2        */
    using TIMBCMP1   = regbits< type, 22,  1 >;  /**< Timer B Compare 1        */
    using TIMACMP4   = regbits< type, 21,  1 >;  /**< Timer A Compare 4        */
    using TIMACMP2   = regbits< type, 20,  1 >;  /**< Timer A Compare 2        */
    using TIMACMP1   = regbits< type, 19,  1 >;  /**< Timer A Compare 1        */
  ...
  : public reg< uint32_t, base_addr + 0x5c, rw, 0x00000000 >
  {
    ...
    using TACMP2     = regbits< type, 15,  1 >;  /**< Timer A Compare 2          */
    using TACMP1     = regbits< type, 14,  1 >;  /**< Timer A Compare 1          */
    using TA1RST     = regbits< type, 13,  1 >;  /**< Timer A output 1 Reset     */
    using TA1SET     = regbits< type, 12,  1 >;  /**< Timer A output 1 Set       */
...
#endif // ARCH_REG_HRTIM_TIME_HPP_INCLUDED
