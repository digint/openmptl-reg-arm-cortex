...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0x00000000 >
  {
    ...
    using MCOPRE    = regbits< type, 28,  3 >;  /**< MCOPRE                               */
    using PLLNODIV  = regbits< type, 31,  1 >;  /**< PLLNODIV                             */
  };
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0x00000000 >
  {
    ...
    using HRTIM1RST  = regbits< type, 29,  1 >;  /**< HRTIM1 reset           */
  };
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0x00000000 >
  {
    ...
    using DAC2RST    = regbits< type, 26,  1 >;  /**< DAC2 interface reset   */
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
    ...
    using HRTIM1EN  = regbits< type, 29,  1 >;  /**< HRTIM1 clock enable       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x00000000 >
  {
    ...
    using DAC2EN    = regbits< type, 26,  1 >;  /**< DAC2 clock enable             */
  };
  ...
  : public reg< uint32_t, base_addr + 0x30, rw, 0x00000000 >
  {
    ...
    using HRTIM1SW  = regbits< type, 12,  1 >;  /**< HRTIM1 clock selection         */
  };
};
} // namespace mptl
