...
struct GPIOA
{
   ...
   */
  struct MODER
  : public reg< uint32_t, base_addr + 0x0, rw, 0x28000000 >
  {
    using type = reg< uint32_t, base_addr + 0x0, rw, 0x28000000 >;
   ...
   */
  struct PUPDR
  : public reg< uint32_t, base_addr + 0xc, rw, 0x24000000 >
  {
    using type = reg< uint32_t, base_addr + 0xc, rw, 0x24000000 >;
