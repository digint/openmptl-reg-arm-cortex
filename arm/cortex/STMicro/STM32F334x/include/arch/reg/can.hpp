...
#ifndef ARCH_REG_CAN_HPP_INCLUDED
#define ARCH_REG_CAN_HPP_INCLUDED
...
struct CAN
{
  static constexpr reg_addr_t base_addr = 0x40006400;

  /**
   * master control register
   */
  struct MCR
  : public reg< uint32_t, base_addr + 0x0, rw, 0x00010002 >
  {
    using type = reg< uint32_t, base_addr + 0x0, rw, 0x00010002 >;
   ...
   */
  struct MSR
  : public reg< uint32_t, base_addr + 0x4, rw, 0x00000C02 >
  {
    using type = reg< uint32_t, base_addr + 0x4, rw, 0x00000C02 >;
   ...
   */
  struct TSR
  : public reg< uint32_t, base_addr + 0x8, rw, 0x1C000000 >
  {
    using type = reg< uint32_t, base_addr + 0x8, rw, 0x1C000000 >;
   ...
   */
  struct BTR
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x01230000 >
  {
    using type = reg< uint32_t, base_addr + 0x1c, rw, 0x01230000 >;
   ...
   */
  struct FMR
  : public reg< uint32_t, base_addr + 0x200, rw, 0x2A1C0E01 >
  {
    using type = reg< uint32_t, base_addr + 0x200, rw, 0x2A1C0E01 >;

    using CAN2SB  = regbits< type,  8,  6 >;  /**< CAN2 start bank   */
    using FINIT   = regbits< type,  0,  1 >;  /**< Filter init mode  */
  };
...
#endif // ARCH_REG_CAN_HPP_INCLUDED
