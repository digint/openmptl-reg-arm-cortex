...
#ifndef ARCH_REG_TIM15_HPP_INCLUDED
#define ARCH_REG_TIM15_HPP_INCLUDED
...
struct TIM15
{
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x0000 >
  {
    ...
    using SMS_3  = regbits< type, 16,  1 >;  /**< Slave mode selection bit 3  */
  };
...
#endif // ARCH_REG_TIM15_HPP_INCLUDED
