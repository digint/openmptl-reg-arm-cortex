...
struct DCMI
{
  ...
  : public reg< uint32_t, base_addr + 0x0, rw, 0x0000 >
  {
    ...
    using BSM      = regbits< type, 16,  2 >;  /**< Byte Select mode                     */
    using OEBS     = regbits< type, 18,  1 >;  /**< Odd/Even Byte Select                 */
    using LSM      = regbits< type, 19,  1 >;  /**< Line Select mode                     */
    using OELS     = regbits< type, 20,  1 >;  /**< Odd/Even Line Select                 */
