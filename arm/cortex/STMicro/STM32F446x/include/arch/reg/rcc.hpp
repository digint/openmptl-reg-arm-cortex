...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0x20, rw, 0x00000000 >
  {
    ...
    using SPDIFRST    = regbits< type, 16,  1 >;  /**< SPDIF-IN reset         */
    ...
    using I2CFMP1RST  = regbits< type, 24,  1 >;  /**< I2CFMP1 reset          */
  ...
  : public reg< uint32_t, base_addr + 0x40, rw, 0x00000000 >
  {
    ...
    using SPDIFEN    = regbits< type, 16,  1 >;  /**< SPDIF-IN clock enable         */
    ...
    using I2CFMP1EN  = regbits< type, 24,  1 >;  /**< I2CFMP1 clock enable          */
    using CAN1EN     = regbits< type, 25,  1 >;  /**< CAN 1 clock enable            */
    using CAN2EN     = regbits< type, 26,  1 >;  /**< CAN 2 clock enable            */
    using CEC        = regbits< type, 27,  1 >;  /**< CEC interface clock enable    */
  ...
  : public reg< uint32_t, base_addr + 0x60, rw, 0x36FEC9FF >
  {
    ...
    using SPDIFLPEN    = regbits< type, 16,  1 >;  /**< SPDIF clock enable during Sleep mode            */
    ...
    using I2CFMP1LPEN  = regbits< type, 24,  1 >;  /**< I2CFMP1 clock enable during Sleep mode          */
    ...
    using CECLPEN      = regbits< type, 27,  1 >;  /**< CEC clock enable during Sleep mode              */
  ...
  : public reg< uint32_t, base_addr + 0x64, rw, 0x00075F33 >
  {
    ...
    using SAI2LPEN    = regbits< type, 23,  1 >;  /**< SAI2 clock enable                                               */
  };
  ...
  : public reg< uint32_t, base_addr + 0x84, rw, 0x20003000 >
  {
    ...
    using PLLI2SM  = regbits< type,  0,  6 >;  /**< Division factor for audio PLL (PLLI2S) input clock  */
    using PLLI2SN  = regbits< type,  6,  9 >;  /**< PLLI2S multiplication factor for VCO                */
    using PLLI2SP  = regbits< type, 16,  2 >;  /**< PLLI2S division factor for SPDIF-IN clock           */
  ...
  : public reg< uint32_t, base_addr + 0x88, rw, 0x24003000 >
  {
    ...
    using PLLSAIM  = regbits< type,  0,  6 >;  /**< Division factor for audio PLLSAI input clock  */
    ...
    using PLLSAIQ  = regbits< type, 24,  4 >;  /**< PLLSAI division factor for SAIs clock         */
  };
  ...
  : public reg< uint32_t, base_addr + 0x8c, rw, 0x00000000 >
  {
    ...
    using PLLI2SDIVQ  = regbits< type,  0,  5 >;  /**< PLLI2S division factor for SAIs clock  */
    using PLLSAIDIVQ  = regbits< type,  8,  5 >;  /**< PLLSAI division factor for SAIs clock  */
    using SAI1SRC     = regbits< type, 20,  2 >;  /**< SAI1 clock source selection            */
    using SAI2SRC     = regbits< type, 22,  2 >;  /**< SAI2 clock source selection            */
    using TIMPRE      = regbits< type, 24,  1 >;  /**< Timers clocks prescalers selection     */
    using I2S1SRC     = regbits< type, 25,  2 >;  /**< I2S APB1 clock source selection        */
    using I2S2SRC     = regbits< type, 27,  2 >;  /**< I2S APB2 clock source selection        */
  };
  ...
  : public reg< uint32_t, base_addr + 0x94, rw, 0x00000000 >
  {
    ...
    using FMPI2C1SEL  = regbits< type, 22,  2 >;  /**< I2C4 kernel clock source selection  */
    using CECSEL      = regbits< type, 26,  1 >;  /**< HDMI CEC clock source selection     */
    using CK48MSEL    = regbits< type, 27,  1 >;  /**< SDIO/USBFS/HS clock selection       */
    using SDIOSEL     = regbits< type, 28,  1 >;  /**< SDIO clock selection                */
    using SPDIFSEL    = regbits< type, 29,  1 >;  /**< SPDIF clock selection               */
  };
};
} // namespace mptl
