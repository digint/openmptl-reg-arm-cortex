...
struct PWR
{
  ...
  : public reg< uint32_t, base_addr + 0x0, rw, 0x0000C000 >
  {
    ...
    using LPLVDS  = regbits< type, 10,  1 >;  /**< Low-Power Regulator Low Voltage in deepsleep  */
    using MRLVDS  = regbits< type, 11,  1 >;  /**< Main regulator low voltage in deepsleep mode  */
    ...
    using FMSSR   = regbits< type, 20,  1 >;  /**< Flash Memory Stop while System Run            */
    using FISSR   = regbits< type, 21,  1 >;  /**< Flash Interface Stop while System Run         */
  };
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0x00000000 >
  {
    ...
    using EWUP2    = regbits< type,  7,  1 >;  /**< Enable WKUP2 pin                                      */
