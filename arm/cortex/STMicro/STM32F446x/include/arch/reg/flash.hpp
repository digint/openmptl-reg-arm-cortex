...
struct FLASH
{
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0x00000000 >
  {
    ...
    using RDERR   = regbits< type,  8,  1 >;  /**< Read Protection Error          */
  ...
  : public reg< uint32_t, base_addr + 0x14, rw, 0x0FFFAAED >
  {
    ...
    using nWRP        = regbits< type, 16,  8 >;  /**< Not write protect                           */
    using SPRMOD      = regbits< type, 31,  1 >;  /**< Selection of Protection Mode of nWPRi bits  */
  };
};
} // namespace mptl
