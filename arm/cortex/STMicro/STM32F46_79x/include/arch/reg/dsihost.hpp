...
#ifndef ARCH_REG_DSIHOST_HPP_INCLUDED
#define ARCH_REG_DSIHOST_HPP_INCLUDED
...
struct DSIHOST
{
   ...
   */
  struct DSI_VR
  : public reg< uint32_t, base_addr + 0x0, rw, 0x3133302A >
  {
    using type = reg< uint32_t, base_addr + 0x0, rw, 0x3133302A >;
   ...
   */
  struct DSIHSOT_CCR
  : public reg< uint32_t, base_addr + 0x8, rw, 0x3133302A >
  {
    using type = reg< uint32_t, base_addr + 0x8, rw, 0x3133302A >;

    using TOCKDIV   = regbits< type,  8,  8 >;  /**< TOCKDIV   */
    using TXECKDIV  = regbits< type,  0,  8 >;  /**< TXECKDIV  */
  };
   ...
   */
  struct DSI_MCR
  : public reg< uint32_t, base_addr + 0x34, rw, 0x00000001 >
  {
    using type = reg< uint32_t, base_addr + 0x34, rw, 0x00000001 >;
  ...
  : public reg< uint32_t, base_addr + 0x38, rw, 0x00000000 >
  {
    ...
    using LPHFE   = regbits< type, 13,  1 >;  /**< Low-Power Horizontal Front-Porch Enable   */
    using LPHBPE  = regbits< type, 12,  1 >;  /**< Low-Power Horizontal Back-Porch Enable    */
    using LVAE    = regbits< type, 11,  1 >;  /**< Low-Power Vertical Active Enable          */
  ...
  : public reg< uint32_t, base_addr + 0x3c, rw, 0x00000000 >
  {
    ...
    using VPSIZE  = regbits< type,  0, 15 >;  /**< Video Packet Size  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x40, rw, 0x00000000 >
  {
    ...
    using NUMC  = regbits< type,  0, 14 >;  /**< Number of Chunks  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x44, rw, 0x00000000 >
  {
    ...
    using NPSIZE  = regbits< type,  0, 14 >;  /**< Null Packet Size  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x48, rw, 0x00000000 >
  {
    ...
    using HSA  = regbits< type,  0, 13 >;  /**< Horizontal Synchronism Active duration  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x4c, rw, 0x00000000 >
  {
    ...
    using HBP  = regbits< type,  0, 13 >;  /**< Horizontal Back-Porch duration  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x74, rw, 0x00000000 >
  {
    ...
    using RCB    = regbits< type,  6,  1 >;  /**< RCB                                        */
    using PRDFF  = regbits< type,  5,  1 >;  /**< PRDFF                                      */
    using PRDFE  = regbits< type,  4,  1 >;  /**< PRDFE                                      */
    using PWRFF  = regbits< type,  3,  1 >;  /**< PWRFF                                      */
    using PWRFE  = regbits< type,  2,  1 >;  /**< PWRFE                                      */
    using CMDFF  = regbits< type,  1,  1 >;  /**< Acknowledge Request Enable                 */
    using CMDFE  = regbits< type,  0,  1 >;  /**< Tearing Effect Acknowledge Request Enable  */
  };
   ...
   */
  struct DSI_PCCONFR
  : public reg< uint32_t, base_addr + 0xa4, rw, 0x3133302A >
  {
    using type = reg< uint32_t, base_addr + 0xa4, rw, 0x3133302A >;

    using SW_TIME  = regbits< type,  8,  8 >;  /**< SW_TIME  */
    using NL       = regbits< type,  0,  2 >;  /**< NL       */
  };
   ...
   */
  struct DSI_PSR
  : public reg< uint32_t, base_addr + 0xb0, rw, 0x00001528 >
  {
    using type = reg< uint32_t, base_addr + 0xb0, rw, 0x00001528 >;
  ...
  : public reg< uint32_t, base_addr + 0x138, rw, 0x00000000 >
  {
    ...
    using LPCE    = regbits< type, 15,  1 >;  /**< Low-Power Command Enable                 */
    using FBTAAE  = regbits< type, 14,  1 >;  /**< Frame BTA Acknowledge Enable             */
    using LPHFE   = regbits< type, 13,  1 >;  /**< Low-Power Horizontal Front-Porch Enable  */
    using LPHBPE  = regbits< type, 12,  1 >;  /**< Low-power Horizontal Back-Porch Enable   */
    using LVAE    = regbits< type, 11,  1 >;  /**< Low-Power Vertical Active Enable         */
    using LPVFPE  = regbits< type, 10,  1 >;  /**< Low-power Vertical Front-Porch Enable    */
    using LPVBPE  = regbits< type,  9,  1 >;  /**< Low-power Vertical Back-Porch Enable     */
    using LPVSAE  = regbits< type,  8,  1 >;  /**< Low-Power Vertical Sync time Enable      */
    using VMT     = regbits< type,  0,  2 >;  /**< Video mode Type                          */
  };
...
#endif // ARCH_REG_DSIHOST_HPP_INCLUDED
