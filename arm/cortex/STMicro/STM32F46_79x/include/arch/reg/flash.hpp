...
struct FLASH
{
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0x00000000 >
  {
    ...
    using RDERR   = regbits< type,  8,  1 >;  /**< Proprietary readout protection (PCROP) error  */
  ...
  : public reg< uint32_t, base_addr + 0x14, rw, 0x0FFFAAED >
  {
    ...
    using BFB2        = regbits< type,  4,  1 >;  /**< Dual-bank Boot option byte                   */
    ...
    using DB1M        = regbits< type, 30,  1 >;  /**< Dual-bank on 1 Mbyte Flash memory devices    */
    using SPRMOD      = regbits< type, 31,  1 >;  /**< Selection of protection mode for nWPRi bits  */
  };
