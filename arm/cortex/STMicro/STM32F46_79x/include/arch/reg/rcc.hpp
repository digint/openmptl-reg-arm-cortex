...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0x0, rw, 0x00000083 >
  {
    ...
    using PLLSAION   = regbits< type, 28,  1 >;  /**< PLLSAI enable                          */
    using PLLSAIRDY  = regbits< type, 29,  1 >;  /**< PLLSAI clock ready flag                */
  };
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0x24003010 >
  {
    ...
    using PLLM    = regbits< type,  0,  6 >;  /**< Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock               */
    using PLLN    = regbits< type,  6,  9 >;  /**< Main PLL (PLL) multiplication factor for VCO                                            */
    using PLLP    = regbits< type, 16,  2 >;  /**< Main PLL (PLL) division factor for main system clock                                    */
    using PLLSRC  = regbits< type, 22,  1 >;  /**< Main PLL(PLL) and audio PLL (PLLI2S) entry clock source                                 */
    using PLLQ    = regbits< type, 24,  4 >;  /**< Main PLL (PLL) division factor for USB OTG FS, SDIO and random number generator clocks  */
    using PLLR    = regbits< type, 28,  3 >;  /**< Main PLL division factor for DSI clock                                                  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
    ...
    using QSPIRST  = regbits< type,  1,  1 >;  /**< QUADSPI memory controller reset          */
  };
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x00000000 >
  {
    ...
    using DSIRST     = regbits< type, 27,  1 >;  /**< DSI host reset                            */
  };
  ...
  : public reg< uint32_t, base_addr + 0x38, rw, 0x00000000 >
  {
    ...
    using QSPIEN  = regbits< type,  1,  1 >;  /**< QUADSPI memory controller module clock enable   */
  };
  ...
  : public reg< uint32_t, base_addr + 0x44, rw, 0x00000000 >
  {
    ...
    using DSIEN     = regbits< type, 27,  1 >;  /**< DSI clocks enable                             */
  };
  ...
  : public reg< uint32_t, base_addr + 0x58, rw, 0x00000001 >
  {
    ...
    using QSPILPEN  = regbits< type,  1,  1 >;  /**< QUADSPI memory controller module clock enable during Sleep mode   */
  };
  ...
  : public reg< uint32_t, base_addr + 0x64, rw, 0x00075F33 >
  {
    ...
    using SAI1LPEN    = regbits< type, 22,  1 >;  /**< SAI1 clock enable                                               */
    using LTDCLPEN    = regbits< type, 26,  1 >;  /**< LTDC clock enable                                               */
    using DSILPEN     = regbits< type, 27,  1 >;  /**< DSI clocks enable during Sleep mode                             */
  };
  ...
  : public reg< uint32_t, base_addr + 0x70, rw, 0x00000000 >
  {
    ...
    using LSEMOD   = regbits< type,  3,  1 >;  /**< External low-speed oscillator mode    */
   ...
   */
  struct PLLSAICFGR
  : public reg< uint32_t, base_addr + 0x88, rw, 0x24003000 >
  {
    using type = reg< uint32_t, base_addr + 0x88, rw, 0x24003000 >;

    using PLLSAIN  = regbits< type,  6,  9 >;  /**< PLLSAI division factor for VCO           */
    using PLLSAIP  = regbits< type, 16,  2 >;  /**< PLLSAI division factor for 48 MHz clock  */
    using PLLSAIQ  = regbits< type, 24,  4 >;  /**< PLLSAI division factor for SAI1 clock    */
  ...
  : public reg< uint32_t, base_addr + 0x8c, rw, 0x00000000 >
  {
    ...
    using PLLIS2DIVQ  = regbits< type,  0,  5 >;  /**< PLLI2S division factor for SAIs clock  */
    using PLLSAIDIVQ  = regbits< type,  8,  5 >;  /**< PLLSAI division factor for SAIs clock  */
    using PLLSAIDIVR  = regbits< type, 16,  2 >;  /**< PLLSAIDIVR                             */
    using SAI1ASRC    = regbits< type, 20,  2 >;  /**< SAI1 clock source selection            */
    using SAI1BSRC    = regbits< type, 22,  2 >;  /**< SAI1-B clock source selection          */
    using TIMPRE      = regbits< type, 24,  1 >;  /**< Timers clocks prescalers selection     */
    using MSEL        = regbits< type, 27,  1 >;  /**< 48 MHz clock source selection          */
    using SDMMCSEL    = regbits< type, 28,  1 >;  /**< SDIO clock source selection            */
    using DSISEL      = regbits< type, 29,  1 >;  /**< DSI clock source selection             */
  };
};
} // namespace mptl
