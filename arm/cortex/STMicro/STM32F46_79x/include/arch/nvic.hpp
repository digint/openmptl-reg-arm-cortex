...
using uart7               = irq_channel<82>;    /**< UART 7 global interrupt                                                  */
...
using lcd_tft_1           = irq_channel<89>;    /**< LTDC global error interrupt                                              */
using dma2d               = irq_channel<90>;    /**< DMA2D global interrupt                                                   */
using quadspi             = irq_channel<91>;    /**< QuadSPI global interrupt                                                 */
