...
struct TIM3
{
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x0000 >
  {
    ...
    using SMS_3  = regbits< type, 16,  1 >;  /**< Slave mode selection bit3   */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x00000000 >
  {
    ...
    using O24CE   = regbits< type, 15,  1 >;  /**< Output compare 4 clear enable    */
    using OC3M_3  = regbits< type, 16,  1 >;  /**< Output compare 3 mode bit3       */
    using OC4M_3  = regbits< type, 24,  1 >;  /**< Output compare 4 mode bit3       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x20, rw, 0x0000 >
  {
    ...
    using CC4NP  = regbits< type, 15,  1 >;  /**< Capture/Compare 3 output Polarity  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x00000000 >
  {
    ...
    using CNTL           = regbits< type,  0, 16 >;  /**< Low counter value                                                                */
    using CNTH           = regbits< type, 16, 15 >;  /**< High counter value                                                               */
    using CNT_or_UIFCPY  = regbits< type, 31,  1 >;  /**< if IUFREMAP=0 than CNT with read write access else UIFCPY with read only access  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x2c, rw, 0x00000000 >
  {
    ...
    using ARRL  = regbits< type,  0, 16 >;  /**< Low Auto-reload value   */
    using ARRH  = regbits< type, 16, 16 >;  /**< High Auto-reload value  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x34, rw, 0x00000000 >
  {
    ...
    using CCR1L  = regbits< type,  0, 16 >;  /**< Low Capture/Compare 1 value             */
    using CCR1H  = regbits< type, 16, 16 >;  /**< High Capture/Compare 1 value (on TIM2)  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x38, rw, 0x00000000 >
  {
    ...
    using CCR2L  = regbits< type,  0, 16 >;  /**< Low Capture/Compare 2 value             */
    using CCR2H  = regbits< type, 16, 16 >;  /**< High Capture/Compare 2 value (on TIM2)  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x3c, rw, 0x00000000 >
  {
    ...
    using CCR3L  = regbits< type,  0, 16 >;  /**< Low Capture/Compare value             */
    using CCR3H  = regbits< type, 16, 16 >;  /**< High Capture/Compare value (on TIM2)  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x40, rw, 0x00000000 >
  {
    ...
    using CCR4L  = regbits< type,  0, 16 >;  /**< Low Capture/Compare value             */
    using CCR4H  = regbits< type, 16, 16 >;  /**< High Capture/Compare value (on TIM2)  */
  };
