...
struct RTC
{
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x00000000 >
  {
    ...
    using SUB1H    = regbits< type, 17,  1 >;  /**< Subtract 1 hour                    */
    using ADD1H    = regbits< type, 16,  1 >;  /**< Add 1 hour                         */
    ...
    using REFCKON  = regbits< type,  4,  1 >;  /**< Reference clock detection enable   */
    using TSEDGE   = regbits< type,  3,  1 >;  /**< Time-stamp event active edge       */
    using WCKSEL   = regbits< type,  0,  3 >;  /**< WCKSEL                             */
  };
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0x00000007 >
  {
    ...
    using TAMP3F   = regbits< type, 15,  1 >;  /**< TAMPER3 detection flag          */
    using TAMP2F   = regbits< type, 14,  1 >;  /**< TAMPER2 detection flag          */
    using TAMP1F   = regbits< type, 13,  1 >;  /**< Tamper detection flag           */
    using TSOVF    = regbits< type, 12,  1 >;  /**< Timestamp overflow flag         */
    using TSF      = regbits< type, 11,  1 >;  /**< Timestamp flag                  */
  ...
  : public reg< uint32_t, base_addr + 0x2c, wo, 0x00000000 >
  {
    ...
    using ADD1S  = regbits< type, 31,  1 >;  /**< ADD1S                            */
  ...
  : public reg< uint32_t, base_addr + 0x3c, rw, 0x00000000 >
  {
    ...
    using CALW16  = regbits< type, 13,  1 >;  /**< CALW16                                    */
  ...
  : public reg< uint32_t, base_addr + 0x40, rw, 0x00000000 >
  {
    ...
    using TAMP3TRG      = regbits< type,  6,  1 >;  /**< TAMPER1 mapping                               */
    using TAMP3E        = regbits< type,  5,  1 >;  /**< TIMESTAMP mapping                             */
    ...
    using TAMP1ETRG     = regbits< type,  1,  1 >;  /**< Active level for tamper 1                     */
