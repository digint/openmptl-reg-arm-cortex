...
struct I2C3
{
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x0000 >
  {
    ...
    using ADDMODE  = regbits< type, 15,  1 >;  /**< Addressing mode (slave mode)  */
    using ADD10    = regbits< type,  8,  2 >;  /**< Interface address             */
    using ADD7     = regbits< type,  1,  7 >;  /**< Interface address             */
    using ADD0     = regbits< type,  0,  1 >;  /**< Interface address             */
  };
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0x0000 >
  {
    ...
    using DR_ = regbits< type,  0,  8 >;  /**< 8-bit data register  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0x0000 >
  {
    ...
    using DNF    = regbits< type,  0,  4 >;  /**< Digital noise filter     */
    using ANOFF  = regbits< type,  4,  1 >;  /**< Analog noise filter OFF  */
  };
};
} // namespace mptl
