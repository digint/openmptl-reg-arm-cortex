...
struct TIM2
{
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x0000 >
  {
    ...
    using SMS_3  = regbits< type, 16,  1 >;  /**< Slave model selection - bit[3]  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x50, rw, 0x0000 >
  {
    ...
    using TI4_RMP   = regbits< type,  2,  2 >;  /**< Input Capture 4 remap     */
    using ETR1_RMP  = regbits< type,  1,  1 >;  /**< External trigger remap    */
    using ITR1_RMP  = regbits< type,  0,  1 >;  /**< Internal trigger 1 remap  */
  };
