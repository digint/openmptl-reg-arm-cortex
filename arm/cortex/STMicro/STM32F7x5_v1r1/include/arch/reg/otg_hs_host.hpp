...
struct OTG_HS_HOST
{
   ...
   */
  struct OTG_HS_HCCHAR12
  : public reg< uint32_t, base_addr + 0x278, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x278, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCSPLT12
  : public reg< uint32_t, base_addr + 0x27c, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x27c, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCINT12
  : public reg< uint32_t, base_addr + 0x280, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x280, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCINTMSK12
  : public reg< uint32_t, base_addr + 0x284, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x284, rw, 0x0 >;
    ...
    using ACKM    = regbits< type,  5,  1 >;  /**< ACK response received/transmitted interrupt mask  */
    using NYET    = regbits< type,  6,  1 >;  /**< Response received interrupt                       */
    using TXERRM  = regbits< type,  7,  1 >;  /**< Transaction error                                 */
    using BBERRM  = regbits< type,  8,  1 >;  /**< Babble error                                      */
    using FRMORM  = regbits< type,  9,  1 >;  /**< Frame overrun mask                                */
    using DTERRM  = regbits< type, 10,  1 >;  /**< Data toggle error mask                            */
  };
   ...
   */
  struct OTG_HS_HCTSIZ12
  : public reg< uint32_t, base_addr + 0x288, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x288, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCDMA12
  : public reg< uint32_t, base_addr + 0x28c, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x28c, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCCHAR13
  : public reg< uint32_t, base_addr + 0x290, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x290, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCSPLT13
  : public reg< uint32_t, base_addr + 0x294, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x294, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCINT13
  : public reg< uint32_t, base_addr + 0x298, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x298, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCINTMSK13
  : public reg< uint32_t, base_addr + 0x29c, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x29c, rw, 0x0 >;

    using XFRCM   = regbits< type,  0,  1 >;  /**< Transfer completed mask                           */
    using CHHM    = regbits< type,  1,  1 >;  /**< Channel halted mask                               */
    using AHBERR  = regbits< type,  2,  1 >;  /**< AHB error                                         */
    using STALLM  = regbits< type,  3,  1 >;  /**< STALLM response received interrupt mask           */
    using NAKM    = regbits< type,  4,  1 >;  /**< NAK response received interrupt mask              */
    using ACKM    = regbits< type,  5,  1 >;  /**< ACK response received/transmitted interrupt mask  */
    using NYET    = regbits< type,  6,  1 >;  /**< Response received interrupt                       */
    using TXERRM  = regbits< type,  7,  1 >;  /**< Transaction error                                 */
   ...
   */
  struct OTG_HS_HCTSIZ13
  : public reg< uint32_t, base_addr + 0x2a0, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2a0, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCDMA13
  : public reg< uint32_t, base_addr + 0x2a4, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2a4, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCCHAR14
  : public reg< uint32_t, base_addr + 0x2a8, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2a8, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCSPLT14
  : public reg< uint32_t, base_addr + 0x2ac, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2ac, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCINT14
  : public reg< uint32_t, base_addr + 0x2b0, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2b0, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCINTMSK14
  : public reg< uint32_t, base_addr + 0x2b4, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2b4, rw, 0x0 >;

    using XFRCM   = regbits< type,  0,  1 >;  /**< Transfer completed mask                            */
    using CHHM    = regbits< type,  1,  1 >;  /**< Channel halted mask                                */
    using AHBERR  = regbits< type,  2,  1 >;  /**< AHB error                                          */
    using STALLM  = regbits< type,  3,  1 >;  /**< STALL response received interrupt mask             */
    using NAKM    = regbits< type,  4,  1 >;  /**< NAKM response received interrupt mask              */
    using ACKM    = regbits< type,  5,  1 >;  /**< ACKM response received/transmitted interrupt mask  */
    using NYET    = regbits< type,  6,  1 >;  /**< Response received interrupt                        */
    using TXERRM  = regbits< type,  7,  1 >;  /**< Transaction error                                  */
    using BBERRM  = regbits< type,  8,  1 >;  /**< Babble error                                       */
    using FRMORM  = regbits< type,  9,  1 >;  /**< Frame overrun mask                                 */
   ...
   */
  struct OTG_HS_HCTSIZ14
  : public reg< uint32_t, base_addr + 0x2b8, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2b8, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCDMA14
  : public reg< uint32_t, base_addr + 0x2bc, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2bc, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCCHAR15
  : public reg< uint32_t, base_addr + 0x2c0, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2c0, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCSPLT15
  : public reg< uint32_t, base_addr + 0x2c4, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2c4, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCINT15
  : public reg< uint32_t, base_addr + 0x2c8, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2c8, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCINTMSK15
  : public reg< uint32_t, base_addr + 0x2cc, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2cc, rw, 0x0 >;

    using XFRCM   = regbits< type,  0,  1 >;  /**< Transfer completed mask                           */
    using CHHM    = regbits< type,  1,  1 >;  /**< Channel halted mask                               */
    using AHBERR  = regbits< type,  2,  1 >;  /**< AHB error                                         */
    using STALL   = regbits< type,  3,  1 >;  /**< STALL response received interrupt mask            */
    using NAKM    = regbits< type,  4,  1 >;  /**< NAK response received interrupt mask              */
    using ACKM    = regbits< type,  5,  1 >;  /**< ACK response received/transmitted interrupt mask  */
    using NYET    = regbits< type,  6,  1 >;  /**< Response received interrupt                       */
    using TXERRM  = regbits< type,  7,  1 >;  /**< Transaction error                                 */
   ...
   */
  struct OTG_HS_HCTSIZ15
  : public reg< uint32_t, base_addr + 0x2d0, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2d0, rw, 0x0 >;
   ...
   */
  struct OTG_HS_HCDMA15
  : public reg< uint32_t, base_addr + 0x2d4, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x2d4, rw, 0x0 >;
