...
struct TIM1
{
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0x0000 >
  {
    ...
    using SMS    = regbits< type,  0,  3 >;  /**< Slave mode selection - bit[2:0]  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x54, rw, 0x0000 >
  {
    ...
    using OC5M3  = regbits< type, 16,  1 >;  /**< Output Compare 5 mode            */
    using OC6M3  = regbits< type, 24,  1 >;  /**< Output Compare 6 mode            */
  };
   ...
   */
  struct CRR6
  : public reg< uint32_t, base_addr + 0x5c, rw, 0x0000 >
  {
    using type = reg< uint32_t, base_addr + 0x5c, rw, 0x0000 >;

    using CCR6  = regbits< type,  0, 16 >;  /**< Capture/Compare 6 value  */
  };
};
} // namespace mptl
