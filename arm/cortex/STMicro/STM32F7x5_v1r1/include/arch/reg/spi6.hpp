...
#ifndef ARCH_REG_SPI6_HPP_INCLUDED
#define ARCH_REG_SPI6_HPP_INCLUDED
...
struct SPI6
{
  static constexpr reg_addr_t base_addr = 0x40015400;
   ...
   */
  struct CR2
  : public reg< uint32_t, base_addr + 0x4, rw, 0x0700 >
  {
    using type = reg< uint32_t, base_addr + 0x4, rw, 0x0700 >;
    ...
    using NSSP     = regbits< type,  3,  1 >;  /**< NSS pulse management                  */
    ...
    using DS       = regbits< type,  8,  4 >;  /**< Data size                             */
    using FRXTH    = regbits< type, 12,  1 >;  /**< FIFO reception threshold              */
    using LDMA_RX  = regbits< type, 13,  1 >;  /**< Last DMA transfer for reception       */
    using LDMA_TX  = regbits< type, 14,  1 >;  /**< Last DMA transfer for transmission    */
  };
   ...
   */
  struct I2SPR
  : public reg< uint32_t, base_addr + 0x20, rw, 00000010 >
  {
    using type = reg< uint32_t, base_addr + 0x20, rw, 00000010 >;
...
#endif // ARCH_REG_SPI6_HPP_INCLUDED
