...
struct GPIOB
{
  static constexpr reg_addr_t base_addr = 0x40020400;
  ...
  : public reg< uint32_t, base_addr + 0x28, rw, 0x00000000 >
  {
    ...
    using BR0   = regbits< type,  0,  1 >;  /**< Port B Reset bit 0   */
    using BR1   = regbits< type,  1,  1 >;  /**< Port B Reset bit 1   */
    using BR2   = regbits< type,  2,  1 >;  /**< Port B Reset bit 2   */
    using BR3   = regbits< type,  3,  1 >;  /**< Port B Reset bit 3   */
    using BR4   = regbits< type,  4,  1 >;  /**< Port B Reset bit 4   */
    using BR5   = regbits< type,  5,  1 >;  /**< Port B Reset bit 5   */
    using BR6   = regbits< type,  6,  1 >;  /**< Port B Reset bit 6   */
    using BR7   = regbits< type,  7,  1 >;  /**< Port B Reset bit 7   */
    using BR8   = regbits< type,  8,  1 >;  /**< Port B Reset bit 8   */
    using BR9   = regbits< type,  9,  1 >;  /**< Port B Reset bit 9   */
    using BR10  = regbits< type, 10,  1 >;  /**< Port B Reset bit 10  */
    using BR11  = regbits< type, 11,  1 >;  /**< Port B Reset bit 11  */
    using BR12  = regbits< type, 12,  1 >;  /**< Port B Reset bit 12  */
    using BR13  = regbits< type, 13,  1 >;  /**< Port B Reset bit 13  */
    using BR14  = regbits< type, 14,  1 >;  /**< Port B Reset bit 14  */
    using BR15  = regbits< type, 15,  1 >;  /**< Port B Reset bit 15  */
  };
};
} // namespace mptl
