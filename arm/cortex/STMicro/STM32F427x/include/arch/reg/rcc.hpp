...
struct RCC
{
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
    ...
    using FMCRST  = regbits< type,  0,  1 >;  /**< Flexible static memory controller module reset  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x38, rw, 0x00000000 >
  {
    ...
    using FMCEN  = regbits< type,  0,  1 >;  /**< Flexible static memory controller module clock enable  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x58, rw, 0x00000001 >
  {
    ...
    using FMCLPEN  = regbits< type,  0,  1 >;  /**< Flexible static memory controller module clock enable during Sleep mode  */
  };
