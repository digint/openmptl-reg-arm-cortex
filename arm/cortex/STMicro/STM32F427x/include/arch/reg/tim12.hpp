...
#ifndef ARCH_REG_TIM12_HPP_INCLUDED
#define ARCH_REG_TIM12_HPP_INCLUDED
...
struct TIM12
{
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x00000000 >
  {
    ...
    using IC2F    = regbits< type, 12,  3 >;  /**< Input capture 2 filter       */
    using IC2PCS  = regbits< type, 10,  2 >;  /**< Input capture 2 prescaler    */
    using CC2S    = regbits< type,  8,  2 >;  /**< Capture/Compare 2 selection  */
    using IC1F    = regbits< type,  4,  3 >;  /**< Input capture 1 filter       */
...
#endif // ARCH_REG_TIM12_HPP_INCLUDED
