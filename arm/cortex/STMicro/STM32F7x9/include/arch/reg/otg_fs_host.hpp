...
struct OTG_FS_HOST
{
   ...
   */
  struct OTG_FS_HCCHAR8
  : public reg< uint32_t, base_addr + 0x1f4, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0x1f4, rw, 0x00000000 >;
   ...
   */
  struct OTG_FS_HCINT8
  : public reg< uint32_t, base_addr + 0x1f8, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0x1f8, rw, 0x00000000 >;
   ...
   */
  struct OTG_FS_HCINTMSK8
  : public reg< uint32_t, base_addr + 0x1fc, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0x1fc, rw, 0x00000000 >;
   ...
   */
  struct OTG_FS_HCTSIZ9
  : public reg< uint32_t, base_addr + 0x210, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0x210, rw, 0x00000000 >;
   ...
   */
  struct OTG_FS_HCINT10
  : public reg< uint32_t, base_addr + 0x218, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0x218, rw, 0x00000000 >;
   ...
   */
  struct OTG_FS_HCINT11
  : public reg< uint32_t, base_addr + 0x228, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0x228, rw, 0x00000000 >;
   ...
   */
  struct OTG_FS_HCTSIZ11
  : public reg< uint32_t, base_addr + 0x230, rw, 0x00000000 >
  {
    using type = reg< uint32_t, base_addr + 0x230, rw, 0x00000000 >;
