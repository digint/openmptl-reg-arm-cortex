...
struct OTG_HS_DEVICE
{
   ...
   * OTG device endpoint-4 control register
   */
  struct OTG_HS_DOEPCTL4
  : public reg< uint32_t, base_addr + 0x380, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x380, rw, 0x0 >;
   ...
   * OTG device endpoint-5 control register
   */
  struct OTG_HS_DOEPCTL5
  : public reg< uint32_t, base_addr + 0x3a0, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x3a0, rw, 0x0 >;
   ...
   * OTG device endpoint-6 control register
   */
  struct OTG_HS_DOEPCTL6
  : public reg< uint32_t, base_addr + 0x3c0, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x3c0, rw, 0x0 >;
   ...
   * OTG device endpoint-7 control register
   */
  struct OTG_HS_DOEPCTL7
  : public reg< uint32_t, base_addr + 0x3e0, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x3e0, rw, 0x0 >;
   ...
   */
  struct OTG_HS_DOEPTSIZ5
  : public reg< uint32_t, base_addr + 0x3b0, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x3b0, rw, 0x0 >;
   ...
   */
  struct OTG_HS_DOEPTSIZ6
  : public reg< uint32_t, base_addr + 0x3d0, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x3d0, rw, 0x0 >;
   ...
   */
  struct OTG_HS_DOEPTSIZ7
  : public reg< uint32_t, base_addr + 0x3f0, rw, 0x0 >
  {
    using type = reg< uint32_t, base_addr + 0x3f0, rw, 0x0 >;
