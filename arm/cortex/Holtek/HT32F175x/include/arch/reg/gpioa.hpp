...
struct GPIOA
{
  static constexpr reg_addr_t base_addr = 0x4001a000;
  ...
  : public reg< uint32_t, base_addr + 0x00000014, rw, 0 /* svd2hpp: missing resetValue! */ >
  {
    ...
    using DV0       = regbits< type,  0,  1 >;  /**< DV0        */
    using DV1       = regbits< type,  1,  1 >;  /**< DV1        */
    using DV2       = regbits< type,  2,  1 >;  /**< DV2        */
    using DV3       = regbits< type,  3,  1 >;  /**< DV3        */
    using DV4       = regbits< type,  4,  1 >;  /**< DV4        */
    using DV5       = regbits< type,  5,  1 >;  /**< DV5        */
    using DV6       = regbits< type,  6,  1 >;  /**< DV6        */
    using DV7       = regbits< type,  7,  1 >;  /**< DV7        */
