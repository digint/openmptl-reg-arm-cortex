...
using can1_ored                 = irq_channel<85>;    
using can1_error                = irq_channel<86>;    
using can1_wake_up              = irq_channel<87>;    
using can1_ored_message_buffer  = irq_channel<88>;    
using can1_reserved1            = irq_channel<89>;    
using can1_reserved2            = irq_channel<90>;    
using can1_reserved3            = irq_channel<91>;    
