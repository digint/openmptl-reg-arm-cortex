...
struct PORTA
{
   ...
   */
  struct PCR1
  : public reg< uint32_t, base_addr + 0x4, rw, 0x3 >
  {
    using type = reg< uint32_t, base_addr + 0x4, rw, 0x3 >;
   ...
   */
  struct PCR2
  : public reg< uint32_t, base_addr + 0x8, rw, 0x3 >
  {
    using type = reg< uint32_t, base_addr + 0x8, rw, 0x3 >;
   ...
   */
  struct PCR3
  : public reg< uint32_t, base_addr + 0xc, rw, 0x3 >
  {
    using type = reg< uint32_t, base_addr + 0xc, rw, 0x3 >;
