...
struct NVIC
{
  ...
  : public reg< uint32_t, base_addr + 0x300, rw, 0 >
  {
    ...
    using PRI_0  = regbits< type,  6,  2 >;  /**< Priority of the Reserved iv 16 interrupt  */
    using PRI_1  = regbits< type, 14,  2 >;  /**< Priority of the Reserved iv 17 interrupt  */
    using PRI_2  = regbits< type, 22,  2 >;  /**< Priority of the Reserved iv 18 interrupt  */
    using PRI_3  = regbits< type, 30,  2 >;  /**< Priority of the Reserved iv 19 interrupt  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x304, rw, 0 >
  {
    ...
    using PRI_7  = regbits< type, 30,  2 >;  /**< Priority of the External Interrupt interrupt                       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x308, rw, 0 >
  {
    ...
    using PRI_9   = regbits< type, 14,  2 >;  /**< Priority of the Inter-Integrated Circuit 1 interrupt     */
  ...
  : public reg< uint32_t, base_addr + 0x30c, rw, 0 >
  {
    ...
    using PRI_13  = regbits< type, 14,  2 >;  /**< Priority of the UART1 status and error interrupt         */
    using PRI_14  = regbits< type, 22,  2 >;  /**< Priority of the UART2 status and error interrupt         */
  ...
  : public reg< uint32_t, base_addr + 0x310, rw, 0 >
  {
    ...
    using PRI_16  = regbits< type,  6,  2 >;  /**< Priority of the Analog comparator 0 interrupt interrupt  */
    using PRI_17  = regbits< type, 14,  2 >;  /**< Priority of the FlexTimer Module 0 interrupt             */
    using PRI_18  = regbits< type, 22,  2 >;  /**< Priority of the FlexTimer Module 1 interrupt             */
    using PRI_19  = regbits< type, 30,  2 >;  /**< Priority of the FlexTimer Module 2 interrupt             */
  };
  ...
  : public reg< uint32_t, base_addr + 0x314, rw, 0 >
  {
    ...
    using PRI_21  = regbits< type, 14,  2 >;  /**< Priority of the Analog comparator 1 interrupt interrupt      */
    using PRI_22  = regbits< type, 22,  2 >;  /**< Priority of the Periodic timer overflow channel 0 interrupt  */
    using PRI_23  = regbits< type, 30,  2 >;  /**< Priority of the Periodic timer overflow channel 1 interrupt  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x318, rw, 0 >
  {
    ...
    using PRI_24  = regbits< type,  6,  2 >;  /**< Priority of the Keyboard interrupt interrupt  */
    using PRI_25  = regbits< type, 14,  2 >;  /**< Priority of the Keyboard interrupt interrupt  */
    using PRI_26  = regbits< type, 22,  2 >;  /**< Priority of the Reserved iv 42 interrupt      */
    using PRI_27  = regbits< type, 30,  2 >;  /**< Priority of the Clock loss of lock interrupt  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x31c, rw, 0 >
  {
    ...
    using PRI_28  = regbits< type,  6,  2 >;  /**< Priority of the WDOG interrupt                                                       */
    using PRI_29  = regbits< type, 14,  2 >;  /**< Priority of the Pulse width timer interrupt                                          */
    using PRI_30  = regbits< type, 22,  2 >;  /**< Priority of the Freescale's Scalable Controller Area Network Rx interrupt            */
    using PRI_31  = regbits< type, 30,  2 >;  /**< Priority of the Freescale's Scalable Controller Area Network Tx and error interrupt  */
  };
};
} // namespace mptl
