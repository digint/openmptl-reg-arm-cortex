...
struct PORT
{
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0 >
  {
    ...
    using FLTI     = regbits< type,  0,  2 >;  /**< Filter Selection for Input from PTI              */
    using FLTIRQ   = regbits< type,  4,  2 >;  /**< Filter Selection for Input from IRQ              */
    using FLTFTM0  = regbits< type,  6,  2 >;  /**< Filter Selection For Input from FTM0CH0/FTM0CH1  */
    using FLTFTM1  = regbits< type,  8,  2 >;  /**< Filter Selection For Input from FTM1CH0/FTM1CH1  */
    using FLTPWT   = regbits< type, 10,  2 >;  /**< Filter Selection For Input from PWT_IN1/PWT_IN0  */
    using FLTI2C0  = regbits< type, 12,  2 >;  /**< Filter Selection For Input from SCL0/SDA0        */
    using FLTI2C1  = regbits< type, 14,  2 >;  /**< Filter Selection For Input from SCL1/SDA1        */
  };
   ...
   */
  struct PUE0
  : public reg< uint32_t, base_addr + 0x8, rw, 0x100000 >
  {
    using type = reg< uint32_t, base_addr + 0x8, rw, 0x100000 >;
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0 >
  {
    ...
    using PTGPE4  = regbits< type, 20,  1 >;  /**< Pull Enable for Port G Bit 4  */
    using PTGPE5  = regbits< type, 21,  1 >;  /**< Pull Enable for Port G Bit 5  */
    using PTGPE6  = regbits< type, 22,  1 >;  /**< Pull Enable for Port G Bit 6  */
    using PTGPE7  = regbits< type, 23,  1 >;  /**< Pull Enable for Port G Bit 7  */
    ...
    using PTHPE3  = regbits< type, 27,  1 >;  /**< Pull Enable for Port H Bit 3  */
    using PTHPE4  = regbits< type, 28,  1 >;  /**< Pull Enable for Port H Bit 4  */
    using PTHPE5  = regbits< type, 29,  1 >;  /**< Pull Enable for Port H Bit 5  */
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0 >
  {
    ...
    using PTIPE0  = regbits< type,  0,  1 >;  /**< Pull Enable for Port I Bit 0  */
    using PTIPE1  = regbits< type,  1,  1 >;  /**< Pull Enable for Port I Bit 1  */
    using PTIPE2  = regbits< type,  2,  1 >;  /**< Pull Enable for Port I Bit 2  */
    using PTIPE3  = regbits< type,  3,  1 >;  /**< Pull Enable for Port I Bit 3  */
    using PTIPE4  = regbits< type,  4,  1 >;  /**< Pull Enable for Port I Bit 4  */
    using PTIPE5  = regbits< type,  5,  1 >;  /**< Pull Enable for Port I Bit 5  */
    using PTIPE6  = regbits< type,  6,  1 >;  /**< Pull Enable for Port I Bit 6  */
  };
