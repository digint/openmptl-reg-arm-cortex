...
struct MTB
{
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0 >
  {
    ...
    using WRAP     = regbits< type,  2,  1 >;  /**< This bit is set to 1 automatically when the POINTER value wraps as determined by the MTB_MASTER[MASK] field in the MASTER Trace Control Register  */
