...
struct SCG
{
  static constexpr reg_addr_t base_addr = 0x4007b000;
   ...
   */
  struct CSR
  : public reg< uint32_t, base_addr + 0x10, ro, 0x2000001 >
  {
    using type = reg< uint32_t, base_addr + 0x10, ro, 0x2000001 >;
   ...
   */
  struct RCCR
  : public reg< uint32_t, base_addr + 0x14, rw, 0x2000001 >
  {
    using type = reg< uint32_t, base_addr + 0x14, rw, 0x2000001 >;
   ...
   */
  struct HCCR
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x2000001 >
  {
    using type = reg< uint32_t, base_addr + 0x1c, rw, 0x2000001 >;
   ...
   */
  struct CLKOUTCNFG
  : public reg< uint32_t, base_addr + 0x20, rw, 0x2000000 >
  {
    using type = reg< uint32_t, base_addr + 0x20, rw, 0x2000000 >;
  ...
  : public reg< uint32_t, base_addr + 0x104, rw, 0 >
  {
    ...
    using SOSCDIV3  = regbits< type, 16,  3 >;  /**< System OSC Clock Divide 3  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x108, rw, 0x10 >
  {
    ...
    using SC16P  = regbits< type,  8,  1 >;  /**< Oscillator 16 pF Capacitor Load           */
    using SC8P   = regbits< type,  9,  1 >;  /**< Oscillator 8 pF Capacitor Load Configure  */
    using SC4P   = regbits< type, 10,  1 >;  /**< Oscillator 4 pF Capacitor Load            */
    using SC2P   = regbits< type, 11,  1 >;  /**< Oscillator 2 pF Capacitor Load            */
  };
   ...
   */
  struct SIRCCSR
  : public reg< uint32_t, base_addr + 0x200, rw, 0x3000005 >
  {
    using type = reg< uint32_t, base_addr + 0x200, rw, 0x3000005 >;
  ...
  : public reg< uint32_t, base_addr + 0x204, rw, 0 >
  {
    ...
    using SIRCDIV3  = regbits< type, 16,  3 >;  /**< Slow IRC Clock Divider 3  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x300, rw, 0 >
  {
    ...
    using LK          = regbits< type, 23,  1 >;  /**< Lock Register              */
    using FIRCVLD     = regbits< type, 24,  1 >;  /**< Fast IRC Valid             */
    using FIRCSEL     = regbits< type, 25,  1 >;  /**< Fast IRC Selected          */
  ...
  : public reg< uint32_t, base_addr + 0x304, rw, 0 >
  {
    ...
    using FIRCDIV3  = regbits< type, 16,  3 >;  /**< Fast IRC Clock Divider 3  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x604, rw, 0 >
  {
    ...
    using SPLLDIV3  = regbits< type, 16,  3 >;  /**< System PLL Clock Divide 3  */
  };
