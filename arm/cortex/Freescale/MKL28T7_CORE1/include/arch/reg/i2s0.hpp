...
struct I2S0
{
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0 >
  {
    ...
    using TFW  = regbits< type,  0,  2 >;  /**< Transmit FIFO Watermark  */
  };
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0 >
  {
    ...
    using WDFL  = regbits< type,  0,  4 >;  /**< Word Flag Configuration  */
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0 >
  {
    ...
    using FRSZ   = regbits< type, 16,  4 >;  /**< Frame size              */
  ...
  : public reg< uint32_t, base_addr + 0x40, ro, 0 >
  {
    ...
    using RFP  = regbits< type,  0,  3 >;  /**< Read FIFO Pointer   */
    using WFP  = regbits< type, 16,  3 >;  /**< Write FIFO Pointer  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x60, rw, 0 >
  {
    ...
    using TWM  = regbits< type,  0, 16 >;  /**< Transmit Word Mask  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x84, rw, 0 >
  {
    ...
    using RFW  = regbits< type,  0,  2 >;  /**< Receive FIFO Watermark  */
  };
  ...
  : public reg< uint32_t, base_addr + 0xe0, rw, 0 >
  {
    ...
    using RWM  = regbits< type,  0, 16 >;  /**< Receive Word Mask  */
  };
};
} // namespace mptl
