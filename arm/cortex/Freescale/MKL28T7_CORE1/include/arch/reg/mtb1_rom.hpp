...
#ifndef ARCH_REG_MTB1_ROM_HPP_INCLUDED
#define ARCH_REG_MTB1_ROM_HPP_INCLUDED
...
struct MTB1_ROM
{
  static constexpr reg_addr_t base_addr = 0xf1002000;
  ...
  : public reg< uint32_t, base_addr + 0x10, ro, 0 >
  {
    ...
    using MARK  = regbits< type,  0, 32 >;  /**< MARK  */
  };
  ...
  : public reg< uint32_t, base_addr + 0xfcc, ro, 0x1 >
  {
    ...
    using SYSACCESS_ = regbits< type,  0, 32 >;  /**< SYSACCESS  */
  };
...
#endif // ARCH_REG_MTB1_ROM_HPP_INCLUDED
