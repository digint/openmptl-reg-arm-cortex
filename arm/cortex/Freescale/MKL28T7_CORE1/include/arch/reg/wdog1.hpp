...
#ifndef ARCH_REG_WDOG1_HPP_INCLUDED
#define ARCH_REG_WDOG1_HPP_INCLUDED
...
struct WDOG1
{
  static constexpr reg_addr_t base_addr = 0x400f6000;

  /**
   * Watchdog Control and Status Register
   */
  struct CS
  : public reg< uint32_t, base_addr + 0, rw, 0x2180 >
  {
    using type = reg< uint32_t, base_addr + 0, rw, 0x2180 >;
    ...
    using PRES     = regbits< type, 12,  1 >;  /**< Watchdog Prescalar                                                                                   */
...
#endif // ARCH_REG_WDOG1_HPP_INCLUDED
