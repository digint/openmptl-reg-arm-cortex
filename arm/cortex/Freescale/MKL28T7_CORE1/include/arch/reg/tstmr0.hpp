...
#ifndef ARCH_REG_TSTMR0_HPP_INCLUDED
#define ARCH_REG_TSTMR0_HPP_INCLUDED
...
struct TSTMR0
{
  static constexpr reg_addr_t base_addr = 0x400750f0;
...
#endif // ARCH_REG_TSTMR0_HPP_INCLUDED
