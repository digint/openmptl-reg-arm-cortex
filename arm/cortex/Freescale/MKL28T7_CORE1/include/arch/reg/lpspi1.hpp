...
#ifndef ARCH_REG_LPSPI1_HPP_INCLUDED
#define ARCH_REG_LPSPI1_HPP_INCLUDED
...
struct LPSPI1
{
  static constexpr reg_addr_t base_addr = 0x400bd000;
...
#endif // ARCH_REG_LPSPI1_HPP_INCLUDED
