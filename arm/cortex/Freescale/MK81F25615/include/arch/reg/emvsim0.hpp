...
struct EMVSIM0
{
  static constexpr reg_addr_t base_addr = 0x400d4000;
  ...
  : public reg< uint32_t, base_addr + 0x20, rw, 0 >
  {
    ...
    using RX_CNT   = regbits< type, 24,  5 >;  /**< Receive FIFO Byte Count                */
  };
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0xB8 >
  {
    ...
    using TX_CNT     = regbits< type, 24,  5 >;  /**< Transmit FIFO Byte Count                */
  };
