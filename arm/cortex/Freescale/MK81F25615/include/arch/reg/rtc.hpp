...
struct RTC
{
  ...
  : public reg< uint32_t, base_addr + 0x38, rw, 0 >
  {
    ...
    using VDTH  = regbits< type,  0,  3 >;  /**< Voltage Detect Trim High      */
    using VDTL  = regbits< type,  3,  3 >;  /**< Voltage Detect Trim Low       */
    using CDTL  = regbits< type,  6,  3 >;  /**< Clock Detect Trim Low         */
    using CDTH  = regbits< type,  9,  3 >;  /**< Clock Detect Trim High        */
    using TDTL  = regbits< type, 12,  5 >;  /**< Temperature Detect Trim Low   */
    using TDTH  = regbits< type, 17,  5 >;  /**< Temperature Detect Trim High  */
  };
