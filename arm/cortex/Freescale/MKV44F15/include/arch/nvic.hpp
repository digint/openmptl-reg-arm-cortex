...
using pwma_cmp0                 = irq_channel<81>;    
using pwma_reload0              = irq_channel<82>;    
using pwma_cmp1                 = irq_channel<83>;    
using pwma_reload1              = irq_channel<84>;    
using pwma_cmp2                 = irq_channel<85>;    
using pwma_reload2              = irq_channel<86>;    
using pwma_cmp3                 = irq_channel<87>;    
using pwma_reload3              = irq_channel<88>;    
using pwma_cap                  = irq_channel<89>;    
using pwma_rerr                 = irq_channel<90>;    
using pwma_fault                = irq_channel<91>;    
using cmp3                      = irq_channel<92>;    

static constexpr int numof_interrupt_channels = 93
