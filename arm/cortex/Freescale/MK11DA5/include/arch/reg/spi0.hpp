...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Freescale/MK11DA5.svd"
//
...
//  series: Kinetis_K
//  version: 1.6
//  description: MK11DA5 Freescale Microcontroller
//  --------------------------------------------------------------------
//
...
struct SPI0
{
   ...
   */
  struct SR
  : public reg< uint32_t, base_addr + 0x2c, rw, 0x2010000 >
  {
    using type = reg< uint32_t, base_addr + 0x2c, rw, 0x2010000 >;
