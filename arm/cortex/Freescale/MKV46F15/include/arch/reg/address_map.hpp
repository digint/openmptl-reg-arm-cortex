...
template<> struct address_map< 0x4003f000 > { static constexpr const char * name_str = "DAC::DAT%sL"; };
template<> struct address_map< 0x4003f001 > { static constexpr const char * name_str = "DAC::DAT%sH"; };
template<> struct address_map< 0x4003f020 > { static constexpr const char * name_str = "DAC::SR"; };
template<> struct address_map< 0x4003f021 > { static constexpr const char * name_str = "DAC::C0"; };
template<> struct address_map< 0x4003f022 > { static constexpr const char * name_str = "DAC::C1"; };
template<> struct address_map< 0x4003f023 > { static constexpr const char * name_str = "DAC::C2"; };
