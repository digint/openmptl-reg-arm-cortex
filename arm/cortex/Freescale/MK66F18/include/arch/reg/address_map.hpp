...
template<> struct address_map< 0x40047008 > { static constexpr const char * name_str = "SIM::USBPHYCTL"; };
...
template<> struct address_map< 0x400a1000 > { static constexpr const char * name_str = "USBHS::ID"; };
template<> struct address_map< 0x400a1004 > { static constexpr const char * name_str = "USBHS::HWGENERAL"; };
template<> struct address_map< 0x400a1008 > { static constexpr const char * name_str = "USBHS::HWHOST"; };
template<> struct address_map< 0x400a100c > { static constexpr const char * name_str = "USBHS::HWDEVICE"; };
template<> struct address_map< 0x400a1010 > { static constexpr const char * name_str = "USBHS::HWTXBUF"; };
template<> struct address_map< 0x400a1014 > { static constexpr const char * name_str = "USBHS::HWRXBUF"; };
template<> struct address_map< 0x400a1080 > { static constexpr const char * name_str = "USBHS::GPTIMER%sLD"; };
template<> struct address_map< 0x400a1084 > { static constexpr const char * name_str = "USBHS::GPTIMER%sCTL"; };
template<> struct address_map< 0x400a1090 > { static constexpr const char * name_str = "USBHS::USB_SBUSCFG"; };
template<> struct address_map< 0x400a1100 > { static constexpr const char * name_str = "USBHS::HCIVERSION"; };
template<> struct address_map< 0x400a1104 > { static constexpr const char * name_str = "USBHS::HCSPARAMS"; };
template<> struct address_map< 0x400a1108 > { static constexpr const char * name_str = "USBHS::HCCPARAMS"; };
template<> struct address_map< 0x400a1122 > { static constexpr const char * name_str = "USBHS::DCIVERSION"; };
template<> struct address_map< 0x400a1124 > { static constexpr const char * name_str = "USBHS::DCCPARAMS"; };
template<> struct address_map< 0x400a1140 > { static constexpr const char * name_str = "USBHS::USBCMD"; };
template<> struct address_map< 0x400a1144 > { static constexpr const char * name_str = "USBHS::USBSTS"; };
template<> struct address_map< 0x400a1148 > { static constexpr const char * name_str = "USBHS::USBINTR"; };
template<> struct address_map< 0x400a114c > { static constexpr const char * name_str = "USBHS::FRINDEX"; };
template<> struct address_map< 0x400a1154 > { static constexpr const char * name_str = "USBHS::DEVICEADDR"; };  /* svd2hpp: duplicate address for: USBHS::DEVICEADDR, USBHS::PERIODICLISTBASE */
template<> struct address_map< 0x400a1158 > { static constexpr const char * name_str = "USBHS::EPLISTADDR"; };  /* svd2hpp: duplicate address for: USBHS::ASYNCLISTADDR, USBHS::EPLISTADDR */
template<> struct address_map< 0x400a115c > { static constexpr const char * name_str = "USBHS::TTCTRL"; };
template<> struct address_map< 0x400a1160 > { static constexpr const char * name_str = "USBHS::BURSTSIZE"; };
template<> struct address_map< 0x400a1164 > { static constexpr const char * name_str = "USBHS::TXFILLTUNING"; };
template<> struct address_map< 0x400a1178 > { static constexpr const char * name_str = "USBHS::ENDPTNAK"; };
template<> struct address_map< 0x400a117c > { static constexpr const char * name_str = "USBHS::ENDPTNAKEN"; };
template<> struct address_map< 0x400a1180 > { static constexpr const char * name_str = "USBHS::CONFIGFLAG"; };
template<> struct address_map< 0x400a1184 > { static constexpr const char * name_str = "USBHS::PORTSC1"; };
template<> struct address_map< 0x400a11a4 > { static constexpr const char * name_str = "USBHS::OTGSC"; };
template<> struct address_map< 0x400a11a8 > { static constexpr const char * name_str = "USBHS::USBMODE"; };
template<> struct address_map< 0x400a11ac > { static constexpr const char * name_str = "USBHS::EPSETUPSR"; };
template<> struct address_map< 0x400a11b0 > { static constexpr const char * name_str = "USBHS::EPPRIME"; };
template<> struct address_map< 0x400a11b4 > { static constexpr const char * name_str = "USBHS::EPFLUSH"; };
template<> struct address_map< 0x400a11b8 > { static constexpr const char * name_str = "USBHS::EPSR"; };
template<> struct address_map< 0x400a11bc > { static constexpr const char * name_str = "USBHS::EPCOMPLETE"; };
template<> struct address_map< 0x400a11c0 > { static constexpr const char * name_str = "USBHS::EPCR0"; };
template<> struct address_map< 0x400a11c4 > { static constexpr const char * name_str = "USBHS::EPCR%s"; };
template<> struct address_map< 0x400a1200 > { static constexpr const char * name_str = "USBHS::USBGENCTRL"; };
template<> struct address_map< 0x400a2000 > { static constexpr const char * name_str = "USBPHY::PWD"; };
template<> struct address_map< 0x400a2004 > { static constexpr const char * name_str = "USBPHY::PWD_SET"; };
template<> struct address_map< 0x400a2008 > { static constexpr const char * name_str = "USBPHY::PWD_CLR"; };
template<> struct address_map< 0x400a200c > { static constexpr const char * name_str = "USBPHY::PWD_TOG"; };
template<> struct address_map< 0x400a2010 > { static constexpr const char * name_str = "USBPHY::TX"; };
template<> struct address_map< 0x400a2014 > { static constexpr const char * name_str = "USBPHY::TX_SET"; };
template<> struct address_map< 0x400a2018 > { static constexpr const char * name_str = "USBPHY::TX_CLR"; };
template<> struct address_map< 0x400a201c > { static constexpr const char * name_str = "USBPHY::TX_TOG"; };
template<> struct address_map< 0x400a2020 > { static constexpr const char * name_str = "USBPHY::RX"; };
template<> struct address_map< 0x400a2024 > { static constexpr const char * name_str = "USBPHY::RX_SET"; };
template<> struct address_map< 0x400a2028 > { static constexpr const char * name_str = "USBPHY::RX_CLR"; };
template<> struct address_map< 0x400a202c > { static constexpr const char * name_str = "USBPHY::RX_TOG"; };
template<> struct address_map< 0x400a2030 > { static constexpr const char * name_str = "USBPHY::CTRL"; };
template<> struct address_map< 0x400a2034 > { static constexpr const char * name_str = "USBPHY::CTRL_SET"; };
template<> struct address_map< 0x400a2038 > { static constexpr const char * name_str = "USBPHY::CTRL_CLR"; };
template<> struct address_map< 0x400a203c > { static constexpr const char * name_str = "USBPHY::CTRL_TOG"; };
template<> struct address_map< 0x400a2040 > { static constexpr const char * name_str = "USBPHY::STATUS"; };
template<> struct address_map< 0x400a2050 > { static constexpr const char * name_str = "USBPHY::DEBUG"; };
template<> struct address_map< 0x400a2054 > { static constexpr const char * name_str = "USBPHY::DEBUG_SET"; };
template<> struct address_map< 0x400a2058 > { static constexpr const char * name_str = "USBPHY::DEBUG_CLR"; };
template<> struct address_map< 0x400a205c > { static constexpr const char * name_str = "USBPHY::DEBUG_TOG"; };
template<> struct address_map< 0x400a2060 > { static constexpr const char * name_str = "USBPHY::DEBUG0_STATUS"; };
template<> struct address_map< 0x400a2070 > { static constexpr const char * name_str = "USBPHY::DEBUG1"; };
template<> struct address_map< 0x400a2074 > { static constexpr const char * name_str = "USBPHY::DEBUG1_SET"; };
template<> struct address_map< 0x400a2078 > { static constexpr const char * name_str = "USBPHY::DEBUG1_CLR"; };
template<> struct address_map< 0x400a207c > { static constexpr const char * name_str = "USBPHY::DEBUG1_TOG"; };
template<> struct address_map< 0x400a2080 > { static constexpr const char * name_str = "USBPHY::VERSION"; };
template<> struct address_map< 0x400a20a0 > { static constexpr const char * name_str = "USBPHY::PLL_SIC"; };
template<> struct address_map< 0x400a20a4 > { static constexpr const char * name_str = "USBPHY::PLL_SIC_SET"; };
template<> struct address_map< 0x400a20a8 > { static constexpr const char * name_str = "USBPHY::PLL_SIC_CLR"; };
template<> struct address_map< 0x400a20ac > { static constexpr const char * name_str = "USBPHY::PLL_SIC_TOG"; };
template<> struct address_map< 0x400a20c0 > { static constexpr const char * name_str = "USBPHY::USB1_VBUS_DETECT"; };
template<> struct address_map< 0x400a20c4 > { static constexpr const char * name_str = "USBPHY::USB1_VBUS_DETECT_SET"; };
template<> struct address_map< 0x400a20c8 > { static constexpr const char * name_str = "USBPHY::USB1_VBUS_DETECT_CLR"; };
template<> struct address_map< 0x400a20cc > { static constexpr const char * name_str = "USBPHY::USB1_VBUS_DETECT_TOG"; };
template<> struct address_map< 0x400a20d0 > { static constexpr const char * name_str = "USBPHY::USB1_VBUS_DET_STAT"; };
template<> struct address_map< 0x400a20f0 > { static constexpr const char * name_str = "USBPHY::USB1_CHRG_DET_STAT"; };
template<> struct address_map< 0x400a2100 > { static constexpr const char * name_str = "USBPHY::ANACTRL"; };
template<> struct address_map< 0x400a2104 > { static constexpr const char * name_str = "USBPHY::ANACTRL_SET"; };
template<> struct address_map< 0x400a2108 > { static constexpr const char * name_str = "USBPHY::ANACTRL_CLR"; };
template<> struct address_map< 0x400a210c > { static constexpr const char * name_str = "USBPHY::ANACTRL_TOG"; };
template<> struct address_map< 0x400a2110 > { static constexpr const char * name_str = "USBPHY::USB1_LOOPBACK"; };
template<> struct address_map< 0x400a2114 > { static constexpr const char * name_str = "USBPHY::USB1_LOOPBACK_SET"; };
template<> struct address_map< 0x400a2118 > { static constexpr const char * name_str = "USBPHY::USB1_LOOPBACK_CLR"; };
template<> struct address_map< 0x400a211c > { static constexpr const char * name_str = "USBPHY::USB1_LOOPBACK_TOG"; };
template<> struct address_map< 0x400a2120 > { static constexpr const char * name_str = "USBPHY::USB1_LOOPBACK_HSFSCNT"; };
template<> struct address_map< 0x400a2124 > { static constexpr const char * name_str = "USBPHY::USB1_LOOPBACK_HSFSCNT_SET"; };
template<> struct address_map< 0x400a2128 > { static constexpr const char * name_str = "USBPHY::USB1_LOOPBACK_HSFSCNT_CLR"; };
template<> struct address_map< 0x400a212c > { static constexpr const char * name_str = "USBPHY::USB1_LOOPBACK_HSFSCNT_TOG"; };
template<> struct address_map< 0x400a2130 > { static constexpr const char * name_str = "USBPHY::TRIM_OVERRIDE_EN"; };
template<> struct address_map< 0x400a2134 > { static constexpr const char * name_str = "USBPHY::TRIM_OVERRIDE_EN_SET"; };
template<> struct address_map< 0x400a2138 > { static constexpr const char * name_str = "USBPHY::TRIM_OVERRIDE_EN_CLR"; };
template<> struct address_map< 0x400a213c > { static constexpr const char * name_str = "USBPHY::TRIM_OVERRIDE_EN_TOG"; };
template<> struct address_map< 0x400a3000 > { static constexpr const char * name_str = "USBHSDCD::CONTROL"; };
template<> struct address_map< 0x400a3004 > { static constexpr const char * name_str = "USBHSDCD::CLOCK"; };
template<> struct address_map< 0x400a3008 > { static constexpr const char * name_str = "USBHSDCD::STATUS"; };
template<> struct address_map< 0x400a300c > { static constexpr const char * name_str = "USBHSDCD::SIGNAL_OVERRIDE"; };
template<> struct address_map< 0x400a3010 > { static constexpr const char * name_str = "USBHSDCD::TIMER0"; };
template<> struct address_map< 0x400a3014 > { static constexpr const char * name_str = "USBHSDCD::TIMER1"; };
template<> struct address_map< 0x400a3018 > { static constexpr const char * name_str = "USBHSDCD::TIMER2_BC12"; };  /* svd2hpp: duplicate address for: USBHSDCD::TIMER2_BC11, USBHSDCD::TIMER2_BC12 */
