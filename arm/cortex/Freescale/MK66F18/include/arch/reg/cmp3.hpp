...
#ifndef ARCH_REG_CMP3_HPP_INCLUDED
#define ARCH_REG_CMP3_HPP_INCLUDED
...
struct CMP3
{
  static constexpr reg_addr_t base_addr = 0x40073018;
  ...
  : public reg< uint8_t, base_addr + 0x1, rw, 0 >
  {
    ...
    using TRIGM  = regbits< type,  5,  1 >;  /**< Trigger Mode Enable           */
  ...
  : public reg< uint8_t, base_addr + 0x5, rw, 0 >
  {
    ...
    using PSTM  = regbits< type,  7,  1 >;  /**< Pass Through Mode Enable  */
  };
};
} // namespace mptl

#endif // ARCH_REG_CMP3_HPP_INCLUDED
