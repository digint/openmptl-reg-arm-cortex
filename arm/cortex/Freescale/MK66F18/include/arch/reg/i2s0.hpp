...
struct I2S0
{
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0 >
  {
    ...
    using CFR   = regbits< type, 24,  2 >;  /**< Channel FIFO Reset       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0 >
  {
    ...
    using FCOMB  = regbits< type, 26,  2 >;  /**< FIFO Combine Mode       */
  ...
  : public reg< uint32_t, base_addr + 0x40, ro, 0 >
  {
    ...
    using WCP  = regbits< type, 31,  1 >;  /**< Write Channel Pointer  */
  };
  ...
  : public reg< uint32_t, base_addr + 0xc0, ro, 0 >
  {
    ...
    using RFP  = regbits< type,  0,  4 >;  /**< Read FIFO Pointer        */
    using RCP  = regbits< type, 15,  1 >;  /**< Receive Channel Pointer  */
    using WFP  = regbits< type, 16,  4 >;  /**< Write FIFO Pointer       */
  };
