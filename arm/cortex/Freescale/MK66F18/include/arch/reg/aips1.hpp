...
struct AIPS1
{
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0x77700000 >
  {
    ...
    using MPL6  = regbits< type,  4,  1 >;  /**< Master 6 Privilege Level     */
    using MTW6  = regbits< type,  5,  1 >;  /**< Master 6 Trusted for Writes  */
    using MTR6  = regbits< type,  6,  1 >;  /**< Master 6 Trusted for Read    */
