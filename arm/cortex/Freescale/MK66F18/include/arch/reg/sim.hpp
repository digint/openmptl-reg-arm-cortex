...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Freescale/MK66F18.svd"
//
...
//  series: Kinetis_K
//  version: 1.6
//  description: MK66F18 Freescale Microcontroller
//  --------------------------------------------------------------------
//
...
struct SIM
{
   ...
   */
  struct USBPHYCTL
  : public reg< uint32_t, base_addr + 0x8, rw, 0x600000 >
  {
    using type = reg< uint32_t, base_addr + 0x8, rw, 0x600000 >;

    using USBVREGSEL   = regbits< type,  8,  1 >;  /**< Selects the default input voltage source to the USB Regulator in case both VREG_IN0 and VREG_IN1 are powered  */
    using USBVREGPD    = regbits< type,  9,  1 >;  /**< Enables the pulldown on the output of the USB Regulator.                                                      */
    using USB3VOUTTRG  = regbits< type, 20,  3 >;  /**< USB 3.3V Output Target                                                                                        */
    using USBDISILIM   = regbits< type, 23,  1 >;  /**< USB Disable Inrush Current Limit                                                                              */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1004, rw, 0x1000 >
  {
    ...
    using USBSLSRC      = regbits< type,  0,  1 >;  /**< USB Slow Clock Source                    */
    using USBREGEN      = regbits< type,  1,  1 >;  /**< USB PHY PLL Regulator Enable             */
   ...
   */
  struct SDID
  : public reg< uint32_t, base_addr + 0x1024, ro, 0x380 >
  {
    using type = reg< uint32_t, base_addr + 0x1024, ro, 0x380 >;
  ...
  : public reg< uint32_t, base_addr + 0x1030, rw, 0 >
  {
    ...
    using USBHS     = regbits< type,  1,  1 >;  /**< USBHS Clock Gate Control      */
    using USBHSPHY  = regbits< type,  2,  1 >;  /**< USBHS PHY Clock Gate Control  */
    using USBHSDCD  = regbits< type,  3,  1 >;  /**< USBHS DCD Clock Gate Control  */
