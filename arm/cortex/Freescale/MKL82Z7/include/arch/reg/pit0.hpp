...
#ifndef ARCH_REG_PIT0_HPP_INCLUDED
#define ARCH_REG_PIT0_HPP_INCLUDED
...
struct PIT0
{
   ...
   */
  struct LTMR64H
  : public reg< uint32_t, base_addr + 0xe0, ro, 0 >
  {
    using type = reg< uint32_t, base_addr + 0xe0, ro, 0 >;

    using LTH  = regbits< type,  0, 32 >;  /**< Life Timer value  */
  };
   ...
   */
  struct LTMR64L
  : public reg< uint32_t, base_addr + 0xe4, ro, 0 >
  {
    using type = reg< uint32_t, base_addr + 0xe4, ro, 0 >;

    using LTL  = regbits< type,  0, 32 >;  /**< Life Timer value  */
  };
...
#endif // ARCH_REG_PIT0_HPP_INCLUDED
