...
struct LTC0
{
  static constexpr reg_addr_t base_addr = 0x40051000;
  ...
  : public reg< uint32_t, base_addr + 0x30, rw, 0 >
  {
    ...
    using MD   = regbits< type,  7,  1 >;  /**< Reset MDHA. Writing a 1 to this bit resets the Message Digest Hardware Accelerator.  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x48, rw, 0 >
  {
    ...
    using MB      = regbits< type,  7,  1 >;  /**< MDHA Busy                                                                                                                                          */
    using DI      = regbits< type, 16,  1 >;  /**< Done Interrupt                                                                                                                                     */
    using EI      = regbits< type, 20,  1 >;  /**< Error Interrupt                                                                                                                                    */
    using DPARRN  = regbits< type, 24,  1 >;  /**< This bit is asserted after POR and after every 50K blocks processed by AESA to indicate it is advisable for added security to write a new seed to  */
   ...
   */
  struct LTC0_CHAVID
  : public reg< uint32_t, base_addr + 0x4f8, ro, 0x40440251 >
  {
    using type = reg< uint32_t, base_addr + 0x4f8, ro, 0x40440251 >;

    using AESREV   = regbits< type,  0,  4 >;  /**< AES Revision Number                                                                                     */
    using AESVID   = regbits< type,  4,  4 >;  /**< AES Version ID                                                                                          */
    using DESREV   = regbits< type,  8,  4 >;  /**< DES Revision Number                                                                                     */
    using DESVID   = regbits< type, 12,  4 >;  /**< DES Version ID(0x0). 0000 - High-performance DESA 0001 - Low-performance DESA                           */
    using PKHAREV  = regbits< type, 16,  4 >;  /**< PK Revision Number                                                                                      */
    using PKHAVID  = regbits< type, 20,  4 >;  /**< PK Version ID 0001 - 32-bit PKHA-SD 0010 - 64-bit PKHA-SD 0011 - 128-bit PKHA-SD 0100 - 16-bit PKHA-SD  */
    using MDHAREV  = regbits< type, 24,  4 >;  /**< MDHA Revision Number                                                                                    */
    using MDHAVID  = regbits< type, 28,  4 >;  /**< MDHA Hashing Version ID                                                                                 */
  };
