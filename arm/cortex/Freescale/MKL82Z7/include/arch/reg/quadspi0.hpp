...
struct QuadSPI0
{
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0xF400C >
  {
    ...
    using END_CFG     = regbits< type,  2,  2 >;  /**< Defines the endianness of the QuadSPI module. For more details refer to Byte Ordering Endianess  */
    using DQS_LAT_EN  = regbits< type,  5,  1 >;  /**< DQS Latency Enable                                                                               */
    using DQS_EN      = regbits< type,  6,  1 >;  /**< DQS enable                                                                                       */
    using DDR_EN      = regbits< type,  7,  1 >;  /**< DDR mode enable                                                                                  */
    using CLR_RXF     = regbits< type, 10,  1 >;  /**< Clear RX FIFO. Invalidates the RX Buffer. This is a self-clearing field.                         */
    using CLR_TXF     = regbits< type, 11,  1 >;  /**< Clear TX FIFO/Buffer. Invalidates the TX Buffer content. This is a self-clearing field.          */
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0x303 >
  {
    ...
    using TDH   = regbits< type, 16,  2 >;  /**< Serial flash data in hold time                                    */
  };
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0x2 >
  {
    ...
    using MSTRID  = regbits< type,  0,  4 >;  /**< Master ID               */
    using ADATSZ  = regbits< type,  8,  7 >;  /**< AHB data transfer size  */
    using HP_EN   = regbits< type, 31,  1 >;  /**< High Priority Enable    */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x80000000 >
  {
    ...
    using MSTRID  = regbits< type,  0,  4 >;  /**< Master ID               */
    using ADATSZ  = regbits< type,  8,  7 >;  /**< AHB data transfer size  */
    using ALLMST  = regbits< type, 31,  1 >;  /**< All master enable       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x10c, ro, 0 >
  {
    ...
    using RDBFL  = regbits< type,  8,  5 >;  /**< RX Buffer Fill Level  */
    using RDCTR  = regbits< type, 16, 16 >;  /**< Read Counter          */
  };
  ...
  : public reg< uint32_t, base_addr + 0x110, rw, 0 >
  {
    ...
    using WMRK   = regbits< type,  0,  4 >;  /**< RX Buffer Watermark                                                                   */
    using RXBRD  = regbits< type,  8,  1 >;  /**< RX Buffer Readout. This field specifies the access scheme for the RX Buffer readout.  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x15c, ro, 0x2003800 >
  {
    ...
    using BUSY     = regbits< type,  0,  1 >;  /**< Module Busy                                                                                                               */
    ...
    using AHBTRN   = regbits< type,  6,  1 >;  /**< AHB Access Transaction pending                                                                                            */
    ...
    using RXWE     = regbits< type, 16,  1 >;  /**< RX Buffer Watermark Exceeded                                                                                              */
    using RXFULL   = regbits< type, 19,  1 >;  /**< RX Buffer Full                                                                                                            */
    ...
    using DLPSMP   = regbits< type, 29,  3 >;  /**< Data learning pattern sampling point                                                                                      */
  };
  ...
  : public reg< uint32_t, base_addr + 0x160, rw, 0x8000000 >
  {
    ...
    using TFF     = regbits< type,  0,  1 >;  /**< IP Command Transaction Finished Flag                 */
    using IPGEF   = regbits< type,  4,  1 >;  /**< IP Command Trigger during AHB Grant Error Flag       */
    ...
    using IUEF    = regbits< type, 11,  1 >;  /**< IP Command Usage Error Flag                          */
    using ABOF    = regbits< type, 12,  1 >;  /**< AHB Buffer Overflow Flag                             */
    using AIBSEF  = regbits< type, 13,  1 >;  /**< AHB Illegal Burst Size Error Flag                    */
    using AITEF   = regbits< type, 14,  1 >;  /**< AHB Illegal transaction error flag                   */
    using ABSEF   = regbits< type, 15,  1 >;  /**< AHB Sequence Error Flag                              */
    using RBDF    = regbits< type, 16,  1 >;  /**< RX Buffer Drain Flag                                 */
    using RBOF    = regbits< type, 17,  1 >;  /**< RX Buffer Overflow Flag                              */
    using ILLINE  = regbits< type, 23,  1 >;  /**< Illegal Instruction Error Flag                       */
    using TBUF    = regbits< type, 26,  1 >;  /**< TX Buffer Underrun Flag                              */
    using TBFF    = regbits< type, 27,  1 >;  /**< TX Buffer Fill Flag                                  */
    using DLPFF   = regbits< type, 31,  1 >;  /**< Data Learning Pattern Failure Flag                   */
  };
