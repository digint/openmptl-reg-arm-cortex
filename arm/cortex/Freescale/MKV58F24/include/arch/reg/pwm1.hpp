...
struct PWM1
{
  static constexpr reg_addr_t base_addr = 0x400b3000;
  ...
  : public reg< uint16_t, base_addr + 0x4, rw, 0 >
  {
    ...
    using FRCEN       = regbits< type,  7,  1 >;  /**< This bit allows the CTRL2[FORCE] signal to initialize the counter without regard to the signal selected by CTRL2[INIT_SEL]  */
  ...
  : public reg< uint16_t, base_addr + 0x6, rw, 0x400 >
  {
    ...
    using LDFQ   = regbits< type, 12,  4 >;  /**< Load Frequency                */
  };
  ...
  : public reg< uint16_t, base_addr + 0x2a, rw, 0 >
  {
    ...
    using TRGFRQ       = regbits< type, 12,  1 >;  /**< Trigger frequency               */
