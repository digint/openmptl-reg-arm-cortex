...
struct NVIC
{
  ...
  : public reg< uint8_t, base_addr + 0x364, rw, 0 >
  {
    ...
    using PRI100  = regbits< type,  4,  4 >;  /**< Priority of the INT_ENET_1588_Timer interrupt 100  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x365, rw, 0 >
  {
    ...
    using PRI101  = regbits< type,  4,  4 >;  /**< Priority of the INT_ENET_Transmit interrupt 101  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x366, rw, 0 >
  {
    ...
    using PRI102  = regbits< type,  4,  4 >;  /**< Priority of the INT_ENET_Receive interrupt 102  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x367, rw, 0 >
  {
    ...
    using PRI103  = regbits< type,  4,  4 >;  /**< Priority of the INT_ENET_Error interrupt 103  */
  };
   ...
   */
  struct NVICIP115
  : public reg< uint8_t, base_addr + 0x373, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x373, rw, 0 >;

    using PRI115  = regbits< type,  4,  4 >;  /**< Priority of the INT_CAN2_ORed_Message_buffer interrupt 115  */
  };
   ...
   */
  struct NVICIP116
  : public reg< uint8_t, base_addr + 0x374, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x374, rw, 0 >;

    using PRI116  = regbits< type,  4,  4 >;  /**< Priority of the INT_CAN2_Bus_Off interrupt 116  */
  };
   ...
   */
  struct NVICIP117
  : public reg< uint8_t, base_addr + 0x375, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x375, rw, 0 >;

    using PRI117  = regbits< type,  4,  4 >;  /**< Priority of the INT_CAN2_Error interrupt 117  */
  };
   ...
   */
  struct NVICIP118
  : public reg< uint8_t, base_addr + 0x376, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x376, rw, 0 >;

    using PRI118  = regbits< type,  4,  4 >;  /**< Priority of the INT_CAN2_Tx_Warning interrupt 118  */
  };
   ...
   */
  struct NVICIP119
  : public reg< uint8_t, base_addr + 0x377, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x377, rw, 0 >;

    using PRI119  = regbits< type,  4,  4 >;  /**< Priority of the INT_CAN2_Rx_Warning interrupt 119  */
  };
   ...
   */
  struct NVICIP120
  : public reg< uint8_t, base_addr + 0x378, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x378, rw, 0 >;

    using PRI120  = regbits< type,  4,  4 >;  /**< Priority of the INT_CAN2_Wake_Up interrupt 120  */
  };
