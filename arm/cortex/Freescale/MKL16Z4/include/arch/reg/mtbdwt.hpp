...
#ifndef ARCH_REG_MTBDWT_HPP_INCLUDED
#define ARCH_REG_MTBDWT_HPP_INCLUDED
...
struct MTBDWT
{
  ...
  : public reg< uint32_t, base_addr + 0xfcc, ro, 0x4 >
  {
    ...
    using DEVICETYPID_ = regbits< type,  0, 32 >;  /**< Hardwired to 0x0000_0004.  */
  };
...
#endif // ARCH_REG_MTBDWT_HPP_INCLUDED
