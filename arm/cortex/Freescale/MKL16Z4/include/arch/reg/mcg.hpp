...
struct MCG
{
   ...
   */
  struct C2
  : public reg< uint8_t, base_addr + 0x1, rw, 0xC0 >
  {
    using type = reg< uint8_t, base_addr + 0x1, rw, 0xC0 >;
  ...
  : public reg< uint8_t, base_addr + 0x4, rw, 0 >
  {
    ...
    using PRDIV0     = regbits< type,  0,  5 >;  /**< PLL External Reference Divider  */
  ...
  : public reg< uint8_t, base_addr + 0x5, rw, 0 >
  {
    ...
    using VDIV0   = regbits< type,  0,  5 >;  /**< VCO 0 Divider                   */
