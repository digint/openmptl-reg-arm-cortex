...
struct SIM
{
   ...
   */
  struct SRSID
  : public reg< uint32_t, base_addr + 0, ro, 0x2000002 >
  {
    using type = reg< uint32_t, base_addr + 0, ro, 0x2000002 >;
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0xE >
  {
    ...
    using ADHWT    = regbits< type,  8,  2 >;  /**< ADC Hardware Trigger Source                */
    ...
    using RXDFE    = regbits< type, 13,  1 >;  /**< UART0_RX Filter Select                     */
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0 >
  {
    ...
    using FTM0PS0  = regbits< type,  8,  1 >;  /**< FTM0[0] Port Pin Select  */
    using FTM0PS1  = regbits< type,  9,  1 >;  /**< FTM0[1] Port Pin Select  */
    using FTM1PS0  = regbits< type, 10,  1 >;  /**< FTM1[0] Port Pin Select  */
    using FTM1PS1  = regbits< type, 11,  1 >;  /**< FTM1[1] Port Pin Select  */
    using FTM2PS0  = regbits< type, 12,  1 >;  /**< FTM2[0] Port Pin Select  */
    using FTM2PS1  = regbits< type, 13,  1 >;  /**< FTM2[1] Port Pin Select  */
    using FTM2PS2  = regbits< type, 14,  1 >;  /**< FTM2[2] Port Pin Select  */
    using FTM2PS3  = regbits< type, 15,  1 >;  /**< FTM2[3] Port Pin Select  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0 >
  {
    ...
    // fixme: Field name equals parent register name: BUSDIV
    using BUSDIV_ = regbits< type,  0,  1 >;  /**< BUS Clock Divider  */
  };
};
} // namespace mptl
