...
struct USB0
{
  ...
  : public reg< uint8_t, base_addr + 0x10c, rw, 0 >
  {
    ...
    using VREDG_DET             = regbits< type,  3,  1 >;  /**< VBUS Rising Edge Interrupt Detect             */
    using VFEDG_DET             = regbits< type,  4,  1 >;  /**< VBUS Falling Edge Interrupt Detect            */
  ...
  : public reg< uint8_t, base_addr + 0x12c, rw, 0 >
  {
    ...
    using VREDG_EN      = regbits< type,  3,  1 >;  /**< VBUS Rising Edge Interrupt Enable              */
    using VFEDG_EN      = regbits< type,  4,  1 >;  /**< VBUS Falling Edge Interrupt Enable             */
  };
  ...
  : public reg< uint8_t, base_addr + 0x144, rw, 0x1 >
  {
    ...
    using REG_EN  = regbits< type,  0,  1 >;  /**< IRC48M regulator enable  */
