...
#ifndef ARCH_REG_I2C3_HPP_INCLUDED
#define ARCH_REG_I2C3_HPP_INCLUDED
...
struct I2C3
{
  static constexpr reg_addr_t base_addr = 0x400e7000;
  ...
  : public reg< uint8_t, base_addr + 0xa, rw, 0 >
  {
    ...
    using SSLT  = regbits< type,  0,  8 >;  /**< SSLT[15:8]  */
  };
  ...
  : public reg< uint8_t, base_addr + 0xb, rw, 0 >
  {
    ...
    using SSLT  = regbits< type,  0,  8 >;  /**< SSLT[7:0]  */
  };
...
#endif // ARCH_REG_I2C3_HPP_INCLUDED
