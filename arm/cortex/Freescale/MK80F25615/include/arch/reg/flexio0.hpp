...
struct FLEXIO0
{
  static constexpr reg_addr_t base_addr = 0x400df000;
   ...
   */
  struct PARAM
  : public reg< uint32_t, base_addr + 0x4, ro, 0x10200808 >
  {
    using type = reg< uint32_t, base_addr + 0x4, ro, 0x10200808 >;
