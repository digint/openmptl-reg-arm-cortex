...
template<> struct address_map< 0x40008100 > { static constexpr const char * name_str = "DMA::SAR%s"; };
template<> struct address_map< 0x40008104 > { static constexpr const char * name_str = "DMA::DAR%s"; };
template<> struct address_map< 0x40008108 > { static constexpr const char * name_str = "DMA::DSR_BCR%s"; };
template<> struct address_map< 0x4000810b > { static constexpr const char * name_str = "DMA::DSR0"; };
template<> struct address_map< 0x4000810c > { static constexpr const char * name_str = "DMA::DCR%s"; };
...
template<> struct address_map< 0x4007c006 > { static constexpr const char * name_str = "LLWU::FILT2"; };
