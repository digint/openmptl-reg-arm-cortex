...
struct UART0
{
  ...
  : public reg< uint8_t, base_addr + 0x5, rw, 0 >
  {
    ...
    using RXEDGIF  = regbits< type,  6,  1 >;  /**< UART _RX Pin Active Edge Interrupt Flag  */
  ...
  : public reg< uint8_t, base_addr + 0x6, rw, 0 >
  {
    ...
    using TXDIR  = regbits< type,  5,  1 >;  /**< UART _TX Pin Direction in Single-Wire Mode  */
  ...
  : public reg< uint8_t, base_addr + 0x7, rw, 0 >
  {
    ...
    using R0T0  = regbits< type,  0,  1 >;  /**< no description available  */
    using R1T1  = regbits< type,  1,  1 >;  /**< no description available  */
    using R2T2  = regbits< type,  2,  1 >;  /**< no description available  */
    using R3T3  = regbits< type,  3,  1 >;  /**< no description available  */
    using R4T4  = regbits< type,  4,  1 >;  /**< no description available  */
    using R5T5  = regbits< type,  5,  1 >;  /**< no description available  */
    using R6T6  = regbits< type,  6,  1 >;  /**< no description available  */
    using R7T7  = regbits< type,  7,  1 >;  /**< no description available  */
  };
