...
struct SPI0
{
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0x4001 >
  {
    ...
    using PCSIS      = regbits< type, 16,  4 >;  /**< Peripheral Chip Select x Inactive State  */
  ...
  : public reg< uint32_t, base_addr + 0x34, rw, 0 >
  {
    ...
    using PCS     = regbits< type, 16,  4 >;  /**< Select which PCS signals are to be asserted for the transfer  */
