...
struct NFC
{
  ...
  : public reg< uint32_t, base_addr + 0x3f24, rw, 0 >
  {
    ...
    using RESERVED  = regbits< type,  2,  7 >;  /**< no description available                                                                                                                                                   */
  ...
  : public reg< uint32_t, base_addr + 0x3f2c, rw, 0x420 >
  {
    ...
    using RESERVED  = regbits< type, 13, 19 >;  /**< no description available                       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x3f30, rw, 0xEA631 >
  {
    ...
    using TIMEOUT   = regbits< type,  8,  5 >;  /**< no description available                                                             */
  ...
  : public reg< uint32_t, base_addr + 0x3f38, rw, 0x60000000 >
  {
    ...
    using RESERVED  = regbits< type,  6, 11 >;  /**< no description available  */
    using IDLECLR   = regbits< type, 17,  1 >;  /**< no description available  */
    using DONECLR   = regbits< type, 18,  1 >;  /**< no description available  */
    using WERRCLR   = regbits< type, 19,  1 >;  /**< no description available  */
    using IDLEEN    = regbits< type, 20,  1 >;  /**< no description available  */
    using DONEEN    = regbits< type, 21,  1 >;  /**< no description available  */
    using WERREN    = regbits< type, 22,  1 >;  /**< no description available  */
