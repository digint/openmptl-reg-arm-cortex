...
struct PORTE
{
   ...
   */
  struct PCR6
  : public reg< uint32_t, base_addr + 0x18, rw, 0x703 >
  {
    using type = reg< uint32_t, base_addr + 0x18, rw, 0x703 >;
   ...
   */
  struct PCR7
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x702 >
  {
    using type = reg< uint32_t, base_addr + 0x1c, rw, 0x702 >;
