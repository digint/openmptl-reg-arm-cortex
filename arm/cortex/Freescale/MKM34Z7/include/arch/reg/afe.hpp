...
struct AFE
{
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0x80000 >
  {
    ...
    using BYP_MODE          = regbits< type, 17,  1 >;  /**< AFE Channel0 bypass mode                             */
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0x80000 >
  {
    ...
    using DEC_EN            = regbits< type, 13,  1 >;  /**< Decimation Filter enable                             */
    using SD_MOD_EN         = regbits< type, 14,  1 >;  /**< Sigma Delta Modulator enable                         */
    using BYP_MODE          = regbits< type, 17,  1 >;  /**< AFE Channel1 bypass mode                             */
    using PGA_GAIN_SEL      = regbits< type, 19,  3 >;  /**< PGA Gain Select                                      */
    using PGA_EN            = regbits< type, 24,  1 >;  /**< PGA enable                                           */
    using DEC_OSR           = regbits< type, 29,  3 >;  /**< Decimator OverSampling Ratio select                  */
  };
   ...
   */
  struct CH2_CFR
  : public reg< uint32_t, base_addr + 0x8, rw, 0x80000 >
  {
    using type = reg< uint32_t, base_addr + 0x8, rw, 0x80000 >;
    ...
    using DEC_EN            = regbits< type, 13,  1 >;  /**< Decimation Filter enable                                         */
    using SD_MOD_EN         = regbits< type, 14,  1 >;  /**< Sigma Delta Modulator enable                                     */
    using BYP_MODE          = regbits< type, 17,  1 >;  /**< AFE Channel2 bypass mode                                         */
    using PGA_GAIN_SEL      = regbits< type, 19,  3 >;  /**< This field selects the analog gain applied to the input signal.  */
    using PGA_EN            = regbits< type, 24,  1 >;  /**< It enables the PGA gain stage.                                   */
    using DEC_OSR           = regbits< type, 29,  3 >;  /**< Decimator OverSampling Ratio select                              */
  };
   ...
   */
  struct CH3_CFR
  : public reg< uint32_t, base_addr + 0xc, rw, 0x80000 >
  {
    using type = reg< uint32_t, base_addr + 0xc, rw, 0x80000 >;
    ...
    using DEC_EN            = regbits< type, 13,  1 >;  /**< Decimation Filter enable                                         */
    using SD_MOD_EN         = regbits< type, 14,  1 >;  /**< Sigma Delta Modulator enable                                     */
    using BYP_MODE          = regbits< type, 17,  1 >;  /**< AFE Channel3 bypass mode                                         */
    using PGA_GAIN_SEL      = regbits< type, 19,  3 >;  /**< This field selects the analog gain applied to the input signal.  */
    using PGA_EN            = regbits< type, 24,  1 >;  /**< It enables the PGA gain stage.                                   */
    using DEC_OSR           = regbits< type, 29,  3 >;  /**< Decimator OverSampling Ratio select                              */
  };
  ...
  : public reg< uint32_t, base_addr + 0x5c, ro, 0 >
  {
    ...
    using RDY3  = regbits< type, 16,  1 >;  /**< AFE Ready3           */
    using RDY2  = regbits< type, 17,  1 >;  /**< AFE Ready2           */
    using RDY1  = regbits< type, 18,  1 >;  /**< AFE Ready1           */
    using RDY0  = regbits< type, 19,  1 >;  /**< AFE Ready0           */
