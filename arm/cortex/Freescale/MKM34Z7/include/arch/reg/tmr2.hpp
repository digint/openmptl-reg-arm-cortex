...
#ifndef ARCH_REG_TMR2_HPP_INCLUDED
#define ARCH_REG_TMR2_HPP_INCLUDED
...
struct TMR2
{
  ...
  : public reg< uint16_t, base_addr + 0x8, rw, 0 >
  {
    ...
    using HOLD_ = regbits< type,  0, 16 >;  /**< This read/write register stores the counter's values of specific channels whenever any of the four counters within a module is read  */
  };
  ...
  : public reg< uint16_t, base_addr + 0xa, rw, 0 >
  {
    ...
    using COUNTER  = regbits< type,  0, 16 >;  /**< This read/write register is the counter for the corresponding channel in a timer module.  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x10, rw, 0 >
  {
    ...
    using COMPARATOR_LOAD_1  = regbits< type,  0, 16 >;  /**< This read/write register is the comparator 1 preload value for the COMP1 register for the corresponding channel in a timer module  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x12, rw, 0 >
  {
    ...
    using COMPARATOR_LOAD_2  = regbits< type,  0, 16 >;  /**< This read/write register is the comparator 2 preload value for the COMP2 register for the corresponding channel in a timer module  */
  };
   ...
   */
  struct ENBL
  : public reg< uint16_t, base_addr + 0x1e, rw, 0xF >
  {
    using type = reg< uint16_t, base_addr + 0x1e, rw, 0xF >;

    // fixme: Field name equals parent register name: ENBL
    using ENBL_ = regbits< type,  0,  4 >;  /**< Timer Channel Enable  */
  };
};
} // namespace mptl

#endif // ARCH_REG_TMR2_HPP_INCLUDED
