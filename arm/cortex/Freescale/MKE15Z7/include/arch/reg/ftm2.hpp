...
struct FTM2
{
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0 >
  {
    ...
    using RIE     = regbits< type,  6,  1 >;  /**< Reload Interrupt Enable          */
    using RF      = regbits< type,  7,  1 >;  /**< Reload Flag                      */
    using TOIE    = regbits< type,  8,  1 >;  /**< Timer Overflow Interrupt Enable  */
    using TOF     = regbits< type,  9,  1 >;  /**< Timer Overflow Flag              */
    using PWMEN0  = regbits< type, 16,  1 >;  /**< Channel 0 PWM enable bit         */
    using PWMEN1  = regbits< type, 17,  1 >;  /**< Channel 1 PWM enable bit         */
    using PWMEN2  = regbits< type, 18,  1 >;  /**< Channel 2 PWM enable bit         */
    using PWMEN3  = regbits< type, 19,  1 >;  /**< Channel 3 PWM enable bit         */
    using PWMEN4  = regbits< type, 20,  1 >;  /**< Channel 4 PWM enable bit         */
    using PWMEN5  = regbits< type, 21,  1 >;  /**< Channel 5 PWM enable bit         */
    using PWMEN6  = regbits< type, 22,  1 >;  /**< Channel 6 PWM enable bit         */
    using PWMEN7  = regbits< type, 23,  1 >;  /**< Channel 7 PWM enable bit         */
  };
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0 >
  {
    ...
    using ELSA      = regbits< type,  2,  1 >;  /**< Channel (n) Edge or Level Select                        */
    using ELSB      = regbits< type,  3,  1 >;  /**< Channel (n) Edge or Level Select                        */
    using MSA       = regbits< type,  4,  1 >;  /**< Channel (n) Mode Select                                 */
    using MSB       = regbits< type,  5,  1 >;  /**< Channel (n) Mode Select                                 */
    using CHIE      = regbits< type,  6,  1 >;  /**< Channel (n) Interrupt Enable                            */
    using CHF       = regbits< type,  7,  1 >;  /**< Channel (n) Flag                                        */
    using TRIGMODE  = regbits< type,  8,  1 >;  /**< Trigger mode control                                    */
    using CHIS      = regbits< type,  9,  1 >;  /**< Channel (n) Input State                                 */
  };
  ...
  : public reg< uint32_t, base_addr + 0x6c, rw, 0 >
  {
    ...
    using CH6TRIG     = regbits< type,  8,  1 >;  /**< Channel 6 Trigger Enable       */
    using CH7TRIG     = regbits< type,  9,  1 >;  /**< Channel 7 Trigger Enable       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x7c, rw, 0 >
  {
    ...
    using FSTATE    = regbits< type, 15,  1 >;  /**< Fault output state           */
  };
  ...
  : public reg< uint32_t, base_addr + 0x84, rw, 0 >
  {
    ...
    using LDFQ     = regbits< type,  0,  5 >;  /**< Load Frequency                          */
    using BDMMODE  = regbits< type,  6,  2 >;  /**< Debug Mode                              */
    using GTBEEN   = regbits< type,  9,  1 >;  /**< Global Time Base Enable                 */
    using GTBEOUT  = regbits< type, 10,  1 >;  /**< Global Time Base Output                 */
    using ITRIGR   = regbits< type, 11,  1 >;  /**< Initialization trigger on Reload Point  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x8c, rw, 0 >
  {
    ...
    using SWWRBUF     = regbits< type,  9,  1 >;  /**< MOD, HCR, CNTIN, and CV registers synchronization is activated by the software trigger.  */
    ...
    using HWWRBUF     = regbits< type, 17,  1 >;  /**< MOD, HCR, CNTIN, and CV registers synchronization is activated by a hardware trigger.    */
  ...
  : public reg< uint32_t, base_addr + 0x98, rw, 0 >
  {
    ...
    using HCSEL   = regbits< type,  8,  1 >;  /**< Half Cycle Select   */
    using LDOK    = regbits< type,  9,  1 >;  /**< Load Enable         */
    using GLEN    = regbits< type, 10,  1 >;  /**< Global Load Enable  */
    using GLDOK   = regbits< type, 11,  1 >;  /**< Global Load OK      */
  };
  ...
  : public reg< uint32_t, base_addr + 0x9c, rw, 0 >
  {
    ...
    using HCVAL  = regbits< type,  0, 16 >;  /**< Half Cycle Value  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x200, rw, 0 >
  {
    ...
    using FRACMOD  = regbits< type, 11,  5 >;  /**< Fractional Value for MOD register  */
    using MOD      = regbits< type, 16, 16 >;  /**< Modulo Value                       */
  };
  ...
  : public reg< uint32_t, base_addr + 0x204, rw, 0 >
  {
    ...
    using FRACVAL  = regbits< type, 11,  5 >;  /**< Fractional Value for VAL register  */
    using VAL      = regbits< type, 16, 16 >;  /**< Channel Value                      */
  };
};
} // namespace mptl
