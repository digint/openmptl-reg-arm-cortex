...
struct MTB
{
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0 >
  {
    ...
    using WRAP     = regbits< type,  2,  1 >;  /**< This field is set to 1 automatically when the POINTER value wraps as determined by the MTB_MASTER[MASK] field in the MASTER Trace Control Register  */
  ...
  : public reg< uint32_t, base_addr + 0x8, rw, 0 >
  {
    ...
    using AUTOSTOP   = regbits< type,  0,  1 >;  /**< If this field is 1 and WATERMARK is equal to MTB_POSITION[POINTER], then MTB_MASTER[EN] is automatically set to 0       */
    using AUTOHALT   = regbits< type,  1,  1 >;  /**< If this field is 1 and WATERMARK is equal to MTB_POSITION[POINTER], then MTB_MASTER[HALTREQ] is automatically set to 1  */
  ...
  : public reg< uint32_t, base_addr + 0xfd0, ro, 0 >
  {
    ...
    using PERIPHID  = regbits< type,  0, 32 >;  /**< Peripheral ID4 is hardwired to 0x0000_0004; ID0 to 0x0000_0032; ID1 to 0x0000_00B9; ID2 to 0x0000_001B; and all the others to 0x0000_0000  */
  };
