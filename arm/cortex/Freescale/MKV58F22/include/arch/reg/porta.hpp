...
struct PORTA
{
   ...
   */
  struct PCR0
  : public reg< uint32_t, base_addr + 0, rw, 0x702 >
  {
    using type = reg< uint32_t, base_addr + 0, rw, 0x702 >;
    ...
    using MUX   = regbits< type,  8,  4 >;  /**< Pin Mux Control          */
   ...
   */
  struct PCR1
  : public reg< uint32_t, base_addr + 0x4, rw, 0x703 >
  {
    using type = reg< uint32_t, base_addr + 0x4, rw, 0x703 >;
   ...
   */
  struct PCR2
  : public reg< uint32_t, base_addr + 0x8, rw, 0x703 >
  {
    using type = reg< uint32_t, base_addr + 0x8, rw, 0x703 >;
   ...
   */
  struct PCR4
  : public reg< uint32_t, base_addr + 0x10, rw, 0x703 >
  {
    using type = reg< uint32_t, base_addr + 0x10, rw, 0x703 >;
