...
struct SIM
{
  ...
  : public reg< uint32_t, base_addr + 0x1004, rw, 0x1000 >
  {
    ...
    using RMIISRC      = regbits< type, 19,  1 >;  /**< RMII clock source select                 */
  ...
  : public reg< uint32_t, base_addr + 0x100c, rw, 0 >
  {
    ...
    using FTM0FLT3     = regbits< type,  3,  1 >;  /**< Selects the source of FTM0 fault 3            */
    ...
    using FTM2TRG0SRC  = regbits< type, 24,  1 >;  /**< FlexTimer 2 Hardware Trigger 0 Source Select  */
    using FTM2TRG2SRC  = regbits< type, 26,  1 >;  /**< FlexTimer 2 Hardware Trigger 2 Source Select  */
  ...
  : public reg< uint32_t, base_addr + 0x1018, rw, 0 >
  {
    ...
    using HSADC0ATRGSEL    = regbits< type,  0,  4 >;  /**< HSADC0A trigger select            */
    using HSADC0AALTTRGEN  = regbits< type,  6,  2 >;  /**< HSADC0A alternate trigger enable  */
    using HSADC0BTRGSEL    = regbits< type,  8,  4 >;  /**< HSADC0B trigger select            */
    using HSADC0BALTTRGEN  = regbits< type, 14,  2 >;  /**< HSADC0B alternate trigger enable  */
    using HSADC1ATRGSEL    = regbits< type, 16,  4 >;  /**< HSADC1A trigger select            */
    using HSADC1AALTTRGEN  = regbits< type, 22,  2 >;  /**< HSADC1A alternate trigger enable  */
    using HSADC1BTRGSEL    = regbits< type, 24,  4 >;  /**< HSADC1B trigger select            */
    using HSADC1BALTTRGEN  = regbits< type, 30,  2 >;  /**< HSADC1B alternate trigger enable  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1020, rw, 0 >
  {
    ...
    using FTM2ICH0SRC  = regbits< type,  8,  2 >;  /**< FTM2 channel 0 input capture source select  */
    using FTM2ICH1SRC  = regbits< type, 10,  1 >;  /**< FTM2 channel 1 input capture source select  */
    ...
    using FTM2CLKSEL   = regbits< type, 28,  2 >;  /**< FlexTimer 2 External Clock Pin Select       */
   ...
   */
  struct SDID
  : public reg< uint32_t, base_addr + 0x1024, ro, 0x600180 >
  {
    using type = reg< uint32_t, base_addr + 0x1024, ro, 0x600180 >;
  ...
  : public reg< uint32_t, base_addr + 0x1028, rw, 0 >
  {
    ...
    using PWM1_SM0  = regbits< type, 24,  1 >;  /**< PWM1 submodule 0 Clock Gate Control  */
    using PWM1_SM1  = regbits< type, 25,  1 >;  /**< PWM1 submodule 1 Clock Gate Control  */
    using PWM1_SM2  = regbits< type, 26,  1 >;  /**< PWM1 submodule 2 Clock Gate Control  */
    using PWM1_SM3  = regbits< type, 27,  1 >;  /**< PWM1 submodule 3 Clock Gate Control  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x102c, rw, 0 >
  {
    ...
    using HSADC1  = regbits< type, 28,  1 >;  /**< HSADC1 Clock Gate Control  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1030, rw, 0 >
  {
    ...
    using FLEXCAN2  = regbits< type,  4,  1 >;  /**< FlexCAN2 Clock Gate Control  */
  ...
  : public reg< uint32_t, base_addr + 0x1034, rw, 0xF0000030 >
  {
    ...
    using PWM0_SM0  = regbits< type, 24,  1 >;  /**< PWM0 submodule 0 Clock Gate Control  */
    using PWM0_SM1  = regbits< type, 25,  1 >;  /**< PWM0 submodule 1 Clock Gate Control  */
    using PWM0_SM2  = regbits< type, 26,  1 >;  /**< PWM0 submodule 2 Clock Gate Control  */
    using PWM0_SM3  = regbits< type, 27,  1 >;  /**< PWM0 submodule 3 Clock Gate Control  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1038, rw, 0x40182 >
  {
    ...
    using ENC     = regbits< type, 21,  1 >;  /**< This bit controls the clock gate to the ENC module.  */
    ...
    using HSADC0  = regbits< type, 28,  1 >;  /**< HSADC0 Clock Gate Control                            */
  };
   ...
   */
  struct SCGC7
  : public reg< uint32_t, base_addr + 0x1040, rw, 0x104 >
  {
    using type = reg< uint32_t, base_addr + 0x1040, rw, 0x104 >;

    using FLEXBUS  = regbits< type,  0,  1 >;  /**< FlexBus Clock Gate Control  */
    using SMPU     = regbits< type,  2,  1 >;  /**< SMPU Clock Gate Control     */
   ...
   */
  struct ADCOPT
  : public reg< uint32_t, base_addr + 0x1108, rw, 0x4000000 >
  {
    using type = reg< uint32_t, base_addr + 0x1108, rw, 0x4000000 >;

    using ADC0TRGSEL     = regbits< type, 16,  4 >;  /**< ADC0 trigger select            */
    using ADC0PRETRGSEL  = regbits< type, 20,  1 >;  /**< ADC0 pretrigger select         */
    using ADC0ALTTRGEN   = regbits< type, 22,  2 >;  /**< ADC0 alternate trigger enable  */
    using HSADCIRCLK     = regbits< type, 25,  1 >;  /**< HSADC Clock Status             */
    using HSADCSTOPEN    = regbits< type, 26,  1 >;  /**< Enable HSADCs in STOP mode     */
  };
};
} // namespace mptl
