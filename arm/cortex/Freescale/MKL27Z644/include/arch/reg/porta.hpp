...
struct PORTA
{
   ...
   */
  struct PCR4
  : public reg< uint32_t, base_addr + 0x10, rw, 0x717 >
  {
    using type = reg< uint32_t, base_addr + 0x10, rw, 0x717 >;
   ...
   */
  struct PCR20
  : public reg< uint32_t, base_addr + 0x50, rw, 0x7 >
  {
    using type = reg< uint32_t, base_addr + 0x50, rw, 0x7 >;
