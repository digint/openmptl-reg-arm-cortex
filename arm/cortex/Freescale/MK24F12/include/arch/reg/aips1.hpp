...
#ifndef ARCH_REG_AIPS1_HPP_INCLUDED
#define ARCH_REG_AIPS1_HPP_INCLUDED
...
struct AIPS1
{
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0x77700000 >
  {
    ...
    using MPL5  = regbits< type,  8,  1 >;  /**< Master 5 Privilege Level     */
    using MTW5  = regbits< type,  9,  1 >;  /**< Master 5 Trusted For Writes  */
    using MTR5  = regbits< type, 10,  1 >;  /**< Master 5 Trusted For Read    */
   ...
   */
  struct PACRA
  : public reg< uint32_t, base_addr + 0x20, rw, 0x50000000 >
  {
    using type = reg< uint32_t, base_addr + 0x20, rw, 0x50000000 >;
   ...
   */
  struct PACRE
  : public reg< uint32_t, base_addr + 0x40, rw, 0x44444444 >
  {
    using type = reg< uint32_t, base_addr + 0x40, rw, 0x44444444 >;
   ...
   */
  struct PACRF
  : public reg< uint32_t, base_addr + 0x44, rw, 0x44444444 >
  {
    using type = reg< uint32_t, base_addr + 0x44, rw, 0x44444444 >;
   ...
   */
  struct PACRG
  : public reg< uint32_t, base_addr + 0x48, rw, 0x44444444 >
  {
    using type = reg< uint32_t, base_addr + 0x48, rw, 0x44444444 >;
   ...
   */
  struct PACRH
  : public reg< uint32_t, base_addr + 0x4c, rw, 0x44444444 >
  {
    using type = reg< uint32_t, base_addr + 0x4c, rw, 0x44444444 >;
   ...
   */
  struct PACRI
  : public reg< uint32_t, base_addr + 0x50, rw, 0x44444444 >
  {
    using type = reg< uint32_t, base_addr + 0x50, rw, 0x44444444 >;
   ...
   */
  struct PACRJ
  : public reg< uint32_t, base_addr + 0x54, rw, 0x44444444 >
  {
    using type = reg< uint32_t, base_addr + 0x54, rw, 0x44444444 >;
   ...
   */
  struct PACRK
  : public reg< uint32_t, base_addr + 0x58, rw, 0x44444444 >
  {
    using type = reg< uint32_t, base_addr + 0x58, rw, 0x44444444 >;
   ...
   */
  struct PACRL
  : public reg< uint32_t, base_addr + 0x5c, rw, 0x44444444 >
  {
    using type = reg< uint32_t, base_addr + 0x5c, rw, 0x44444444 >;
   ...
   */
  struct PACRM
  : public reg< uint32_t, base_addr + 0x60, rw, 0x44444444 >
  {
    using type = reg< uint32_t, base_addr + 0x60, rw, 0x44444444 >;
   ...
   */
  struct PACRN
  : public reg< uint32_t, base_addr + 0x64, rw, 0x44444444 >
  {
    using type = reg< uint32_t, base_addr + 0x64, rw, 0x44444444 >;
   ...
   */
  struct PACRO
  : public reg< uint32_t, base_addr + 0x68, rw, 0x44444444 >
  {
    using type = reg< uint32_t, base_addr + 0x68, rw, 0x44444444 >;
   ...
   */
  struct PACRU
  : public reg< uint32_t, base_addr + 0x80, rw, 0x44000000 >
  {
    using type = reg< uint32_t, base_addr + 0x80, rw, 0x44000000 >;
...
#endif // ARCH_REG_AIPS1_HPP_INCLUDED
