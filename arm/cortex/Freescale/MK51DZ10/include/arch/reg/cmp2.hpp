...
struct CMP2
{
  static constexpr reg_addr_t base_addr = 0x40073010;
  ...
  : public reg< uint8_t, base_addr + 0x3, rw, 0 >
  {
    ...
    using SMELB  = regbits< type,  5,  1 >;  /**< Stop Mode Edge/Level Interrupt Control  */
  ...
  : public reg< uint8_t, base_addr + 0x5, rw, 0 >
  {
    ...
    using MEN   = regbits< type,  6,  1 >;  /**< MMUX Enable              */
    using PEN   = regbits< type,  7,  1 >;  /**< PMUX Enable              */
  };
};
} // namespace mptl
