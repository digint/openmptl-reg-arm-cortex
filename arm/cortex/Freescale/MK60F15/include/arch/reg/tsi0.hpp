...
struct TSI0
{
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0 >
  {
    ...
    using STM       = regbits< type,  1,  1 >;  /**< Scan Trigger Mode. This bit-field can only be changed if the TSI module is disabled (TSIEN bit = 0).                                                  */
    ...
    using OVRF      = regbits< type, 12,  1 >;  /**< Overrun error Flag. This flag is set when a scan trigger occurs while a scan is still in progress. Writing "1" to this bit will clear the flag to 0.  */
  ...
  : public reg< uint32_t, base_addr + 0xc, ro, 0 >
  {
    ...
    using WUCNT  = regbits< type,  0, 16 >;  /**< TouchSensing wake-up Channel 16bit counter value  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x100, ro, 0 >
  {
    ...
    using CTN1  = regbits< type,  0, 16 >;  /**< TouchSensing Channel n-1 16-bit counter value  */
    using CTN   = regbits< type, 16, 16 >;  /**< TouchSensing Channel n 16-bit counter value    */
  };
