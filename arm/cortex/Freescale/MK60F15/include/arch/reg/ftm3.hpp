...
struct FTM3
{
  static constexpr reg_addr_t base_addr = 0x400b9000;
  ...
  : public reg< uint32_t, base_addr + 0x8c, rw, 0 >
  {
    ...
    using SWRSTCNT    = regbits< type,  8,  1 >;  /**< no description available          */
    using SWWRBUF     = regbits< type,  9,  1 >;  /**< no description available          */
    using SWOM        = regbits< type, 10,  1 >;  /**< no description available          */
    using SWINVC      = regbits< type, 11,  1 >;  /**< no description available          */
    using SWSOC       = regbits< type, 12,  1 >;  /**< no description available          */
    using HWRSTCNT    = regbits< type, 16,  1 >;  /**< no description available          */
    using HWWRBUF     = regbits< type, 17,  1 >;  /**< no description available          */
    using HWOM        = regbits< type, 18,  1 >;  /**< no description available          */
    using HWINVC      = regbits< type, 19,  1 >;  /**< no description available          */
    using HWSOC       = regbits< type, 20,  1 >;  /**< no description available          */
  };
