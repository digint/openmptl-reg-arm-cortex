...
struct PWMA
{
  ...
  : public reg< uint16_t, base_addr + 0x6, rw, 0x400 >
  {
    ...
    using SPLIT     = regbits< type,  3,  1 >;  /**< Split the DBLPWM signal to PWMA and PWMB                      */
    using PRSC      = regbits< type,  4,  3 >;  /**< Prescaler                                                     */
    using COMPMODE  = regbits< type,  7,  1 >;  /**< Compare Mode                                                  */
    ...
    using LDFQ      = regbits< type, 12,  4 >;  /**< These buffered read/write bits select the PWM load frequency  */
  };
   ...
   */
  struct SM%sDISMAP1
  : public reg< uint16_t, base_addr + 0x2e, rw, 0xFFFF >
  {
    using type = reg< uint16_t, base_addr + 0x2e, rw, 0xFFFF >;

    using DIS1A  = regbits< type,  0,  4 >;  /**< PWM_A Fault Disable Mask 1  */
    using DIS1B  = regbits< type,  4,  4 >;  /**< PWM_B Fault Disable Mask 1  */
    using DIS1X  = regbits< type,  8,  4 >;  /**< PWM_X Fault Disable Mask 1  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x30, rw, 0x7FF >
  {
    ...
    using DTCNT0  = regbits< type,  0, 16 >;  /**< The DTCNT0 field is interpreted differently depending on whether or not the fractional delays are being used (FRCNTRL[FRAC23_EN] is set)  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x32, rw, 0x7FF >
  {
    ...
    using DTCNT1  = regbits< type,  0, 16 >;  /**< The DTCNT1 field is interpreted differently depending on whether or not the fractional delays are being used (FRCNTRL[FRAC45_EN] is set)  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x40, ro, 0 >
  {
    ...
    using CAPTVAL0  = regbits< type,  0, 16 >;  /**< This read-only register stores the value captured from the submodule counter  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x42, ro, 0 >
  {
    ...
    using CVAL0CYC  = regbits< type,  0,  4 >;  /**< This read-only register stores the cycle number corresponding to the value captured in CVAL0  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x44, ro, 0 >
  {
    ...
    using CAPTVAL1  = regbits< type,  0, 16 >;  /**< This read-only register stores the value captured from the submodule counter  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x46, ro, 0 >
  {
    ...
    using CVAL1CYC  = regbits< type,  0,  4 >;  /**< This read-only register stores the cycle number corresponding to the value captured in CVAL1  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x48, ro, 0 >
  {
    ...
    using CAPTVAL2  = regbits< type,  0, 16 >;  /**< This read-only register stores the value captured from the submodule counter  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x4a, ro, 0 >
  {
    ...
    using CVAL2CYC  = regbits< type,  0,  4 >;  /**< This read-only register stores the cycle number corresponding to the value captured in CVAL2  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x4c, ro, 0 >
  {
    ...
    using CAPTVAL3  = regbits< type,  0, 16 >;  /**< This read-only register stores the value captured from the submodule counter  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x4e, ro, 0 >
  {
    ...
    using CVAL3CYC  = regbits< type,  0,  4 >;  /**< This read-only register stores the cycle number corresponding to the value captured in CVAL3  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x50, ro, 0 >
  {
    ...
    using CAPTVAL4  = regbits< type,  0, 16 >;  /**< This read-only register stores the value captured from the submodule counter  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x52, ro, 0 >
  {
    ...
    using CVAL4CYC  = regbits< type,  0,  4 >;  /**< This read-only register stores the cycle number corresponding to the value captured in CVAL4  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x54, ro, 0 >
  {
    ...
    using CAPTVAL5  = regbits< type,  0, 16 >;  /**< This read-only register stores the value captured from the submodule counter  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x56, ro, 0 >
  {
    ...
    using CVAL5CYC  = regbits< type,  0,  4 >;  /**< This read-only register stores the cycle number corresponding to the value captured in CVAL5  */
  };
