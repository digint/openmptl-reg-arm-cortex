...
struct FMC
{
   ...
   */
  struct PFAPR
  : public reg< uint32_t, base_addr + 0, rw, 0xF000FF >
  {
    using type = reg< uint32_t, base_addr + 0, rw, 0xF000FF >;
   ...
   */
  struct PFB1CR
  : public reg< uint32_t, base_addr + 0x8, ro, 0x30060000 >
  {
    using type = reg< uint32_t, base_addr + 0x8, ro, 0x30060000 >;
    ...
    using RESERVED  = regbits< type, 19,  9 >;  /**< no description available        */
  ...
  : public reg< uint32_t, base_addr + 0x100, rw, 0 >
  {
    ...
    using RESERVED  = regbits< type,  1,  5 >;  /**< no description available     */
