...
struct DMA
{
  ...
  : public reg< uint32_t, base_addr + 0x4, ro, 0 >
  {
    ...
    using RESERVED  = regbits< type, 12,  2 >;  /**< no description available                          */
    ...
    using RESERVED  = regbits< type, 17, 14 >;  /**< no description available                          */
   ...
   */
  struct DCHPRI2
  : public reg< uint8_t, base_addr + 0x101, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x101, rw, 0 >;
   ...
   */
  struct DCHPRI1
  : public reg< uint8_t, base_addr + 0x102, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x102, rw, 0 >;
   ...
   */
  struct DCHPRI0
  : public reg< uint8_t, base_addr + 0x103, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x103, rw, 0 >;
   ...
   */
  struct DCHPRI7
  : public reg< uint8_t, base_addr + 0x104, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x104, rw, 0 >;
   ...
   */
  struct DCHPRI6
  : public reg< uint8_t, base_addr + 0x105, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x105, rw, 0 >;
   ...
   */
  struct DCHPRI5
  : public reg< uint8_t, base_addr + 0x106, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x106, rw, 0 >;
   ...
   */
  struct DCHPRI4
  : public reg< uint8_t, base_addr + 0x107, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x107, rw, 0 >;
   ...
   */
  struct DCHPRI10
  : public reg< uint8_t, base_addr + 0x109, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x109, rw, 0 >;
   ...
   */
  struct DCHPRI9
  : public reg< uint8_t, base_addr + 0x10a, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x10a, rw, 0 >;
  ...
  {
    using type = reg< uint8_t, base_addr + 0x10b, rw, 0 >;
   ...
   */
  struct DCHPRI13
  : public reg< uint8_t, base_addr + 0x10e, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x10e, rw, 0 >;
   ...
   */
  struct DCHPRI12
  : public reg< uint8_t, base_addr + 0x10f, rw, 0 >
  {
    using type = reg< uint8_t, base_addr + 0x10f, rw, 0 >;
