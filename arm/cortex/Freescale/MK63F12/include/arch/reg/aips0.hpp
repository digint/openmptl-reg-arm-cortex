...
struct AIPS0
{
   ...
   */
  struct PACRA
  : public reg< uint32_t, base_addr + 0x20, rw, 0x50004000 >
  {
    using type = reg< uint32_t, base_addr + 0x20, rw, 0x50004000 >;
   ...
   */
  struct PACRB
  : public reg< uint32_t, base_addr + 0x24, rw, 0x44004400 >
  {
    using type = reg< uint32_t, base_addr + 0x24, rw, 0x44004400 >;
