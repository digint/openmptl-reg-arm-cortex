...
template<> struct address_map< 0x4001f204 > { static constexpr const char * name_str = "FMC::DATAW0S%s"; };
template<> struct address_map< 0x4001f244 > { static constexpr const char * name_str = "FMC::DATAW1S%s"; };
template<> struct address_map< 0x4001f284 > { static constexpr const char * name_str = "FMC::DATAW2S%s"; };
template<> struct address_map< 0x4001f2c4 > { static constexpr const char * name_str = "FMC::DATAW3S%s"; };
