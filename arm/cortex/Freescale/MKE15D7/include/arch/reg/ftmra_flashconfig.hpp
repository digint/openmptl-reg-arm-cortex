...
#ifndef ARCH_REG_FTMRA_FLASHCONFIG_HPP_INCLUDED
#define ARCH_REG_FTMRA_FLASHCONFIG_HPP_INCLUDED
...
struct FTMRA_FlashConfig
{
  ...
  : public reg< uint8_t, base_addr + 0xf, ro, 0xFF >
  {
    ...
    using DPS       = regbits< type,  0,  5 >;  /**< no description available  */
    using RESERVED  = regbits< type,  5,  1 >;  /**< no description available  */
    using RESERVED  = regbits< type,  6,  1 >;  /**< no description available  */
...
#endif // ARCH_REG_FTMRA_FLASHCONFIG_HPP_INCLUDED
