...
struct TSI0
{
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0 >
  {
    ...
    using STM       = regbits< type,  1,  1 >;  /**< Scan Trigger Mode. User is allowed to change this bit when TSI is not working in progress.                                                          */
    ...
    using OVRF      = regbits< type, 12,  1 >;  /**< Overrun error Flag. This flag is set when a scan trigger occurs while a scan is still in progress. Write "1", when this flag is set, to clear it..  */
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0 >
  {
    ...
    using EXTCHRG   = regbits< type, 16,  3 >;  /**< External OSC Charge Current select  */
    using RESERVED  = regbits< type, 19,  1 >;  /**< no description available            */
    using DVOLT     = regbits< type, 20,  2 >;  /**< no description available            */
    using RESERVED  = regbits< type, 22,  2 >;  /**< no description available            */
    using REFCHRG   = regbits< type, 24,  3 >;  /**< Ref OSC Charge Current select       */
    using RESERVED  = regbits< type, 27,  1 >;  /**< no description available            */
    using RW        = regbits< type, 28,  4 >;  /**< R/W                                 */
  };
  ...
  : public reg< uint32_t, base_addr + 0x100, ro, 0 >
  {
    ...
    using CNTN1  = regbits< type,  0, 16 >;  /**< TouchSensing Channel n-1 16-bit counter value  */
    using CNTN   = regbits< type, 16, 16 >;  /**< TouchSensing Channel n 16-bit counter value    */
  };
