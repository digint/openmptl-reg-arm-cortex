...
#ifndef ARCH_REG_LPUART0_HPP_INCLUDED
#define ARCH_REG_LPUART0_HPP_INCLUDED
...
struct LPUART0
{
   ...
   */
  struct VERID
  : public reg< uint32_t, base_addr + 0, ro, 0x4000003 >
  {
    using type = reg< uint32_t, base_addr + 0, ro, 0x4000003 >;
   ...
   */
  struct FIFO
  : public reg< uint32_t, base_addr + 0x28, rw, 0x33 >
  {
    using type = reg< uint32_t, base_addr + 0x28, rw, 0x33 >;
...
#endif // ARCH_REG_LPUART0_HPP_INCLUDED
