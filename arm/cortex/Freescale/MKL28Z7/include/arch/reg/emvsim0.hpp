...
#ifndef ARCH_REG_EMVSIM0_HPP_INCLUDED
#define ARCH_REG_EMVSIM0_HPP_INCLUDED
...
struct EMVSIM0
{
  ...
  : public reg< uint32_t, base_addr + 0x20, rw, 0 >
  {
    ...
    using RX_WPTR  = regbits< type, 16,  2 >;  /**< Receive FIFO Write Pointer Value       */
    using RX_CNT   = regbits< type, 22,  3 >;  /**< Receive FIFO Byte Count                */
  };
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0xB8 >
  {
    ...
    using TX_RPTR    = regbits< type, 16,  2 >;  /**< Transmit FIFO Read Pointer              */
    using TX_CNT     = regbits< type, 22,  3 >;  /**< Transmit FIFO Byte Count                */
  };
...
#endif // ARCH_REG_EMVSIM0_HPP_INCLUDED
