...
struct RTC
{
  ...
  : public reg< uint32_t, base_addr + 0x10, rw, 0 >
  {
    ...
    using CPS    = regbits< type,  5,  1 >;  /**< Clock Pin Select                */
    using LPOS   = regbits< type,  7,  1 >;  /**< LPO Select                      */
    ...
    using CPE    = regbits< type, 24,  2 >;  /**< Clock Pin Enable                */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x7 >
  {
    ...
    using TSIC  = regbits< type, 16,  3 >;  /**< Timer Seconds Interrupt Configuration  */
  };
};
} // namespace mptl
