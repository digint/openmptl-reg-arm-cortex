...
#ifndef ARCH_REG_HSADC1_HPP_INCLUDED
#define ARCH_REG_HSADC1_HPP_INCLUDED
...
struct HSADC1
{
  static constexpr reg_addr_t base_addr = 0x400dc000;
...
#endif // ARCH_REG_HSADC1_HPP_INCLUDED
