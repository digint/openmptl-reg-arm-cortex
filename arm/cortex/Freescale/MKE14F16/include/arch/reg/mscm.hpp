...
struct MSCM
{
  ...
  : public reg< uint32_t, base_addr + 0x400, rw, 0 >
  {
    ...
    using OCMC0   = regbits< type,  0,  4 >;  /**< OCMEM Control Field 0                                                                        */
    using OCMC1   = regbits< type,  4,  4 >;  /**< OCMEM Control Field 1                                                                        */
    using OCMC2   = regbits< type,  8,  4 >;  /**< OCMEM Control Field 2                                                                        */
