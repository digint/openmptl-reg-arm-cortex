...
#ifndef ARCH_REG_LPTMR1_HPP_INCLUDED
#define ARCH_REG_LPTMR1_HPP_INCLUDED
...
struct LPTMR1
{
  static constexpr reg_addr_t base_addr = 0x400b5000;
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0 >
  {
    ...
    using TDRE  = regbits< type,  8,  1 >;  /**< Timer DMA Request Enable    */
  };
...
#endif // ARCH_REG_LPTMR1_HPP_INCLUDED
