...
struct RCM
{
  ...
  : public reg< uint32_t, base_addr + 0x8, ro, 0x82 >
  {
    ...
    using WAKEUP   = regbits< type,  0,  1 >;  /**< VLLS Wakeup Reset                                      */
    ...
    using CORE1    = regbits< type, 16,  1 >;  /**< Core 1 Reset                                           */
  };
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0x82 >
  {
    ...
    using SWAKEUP   = regbits< type,  0,  1 >;  /**< Sticky VLLS Wakeup Reset            */
    ...
    using SCORE1    = regbits< type, 16,  1 >;  /**< Sticky Core 1 Reset                 */
  };
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0 >
  {
    ...
    using CORE1    = regbits< type, 16,  1 >;  /**< Core 1 Interrupt                  */
  };
};
} // namespace mptl
