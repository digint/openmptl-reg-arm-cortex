...
using portm            = irq_channel<51>;    
using dma1_04          = irq_channel<56>;    
using dma1_15          = irq_channel<57>;    
using dma1_26          = irq_channel<58>;    
using dma1_37          = irq_channel<59>;    
using dma1_error       = irq_channel<60>;    
