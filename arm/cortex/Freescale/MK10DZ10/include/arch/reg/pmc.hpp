...
struct PMC
{
  ...
  : public reg< uint8_t, base_addr + 0x2, rw, 0x4 >
  {
    ...
    using VLPRS   = regbits< type,  3,  1 >;  /**< Very Low Power Run Status                                                                             */
    using TRAMPO  = regbits< type,  4,  1 >;  /**< For devices with FlexNVM: Traditional RAM Power Option For devices with program flash only: Reserved  */
  };
};
} // namespace mptl
