...
#ifndef ARCH_REG_FGPIOB_HPP_INCLUDED
#define ARCH_REG_FGPIOB_HPP_INCLUDED
...
struct FGPIOB
{
  static constexpr reg_addr_t base_addr = 0xf8000040;
  ...
  : public reg< uint32_t, base_addr + 0x18, rw, 0xFFFFFFFF >
  {
    ...
    using PID  = regbits< type,  0, 32 >;  /**< Port Input Disable  */
  };
};
} // namespace mptl

#endif // ARCH_REG_FGPIOB_HPP_INCLUDED
