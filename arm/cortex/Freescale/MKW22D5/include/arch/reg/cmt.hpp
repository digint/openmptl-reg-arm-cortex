...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Freescale/MKW22D5.svd"
//
...
//  series: Kinetis_W
//  version: 1.6
//  description: MKW22D5 Freescale Microcontroller
//  --------------------------------------------------------------------
//
...
struct CMT
{
  ...
  : public reg< uint8_t, base_addr + 0x6, rw, 0 >
  {
    ...
    using MB  = regbits< type,  0,  8 >;  /**< Controls the upper mark periods of the modulator for all modes.  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x7, rw, 0 >
  {
    ...
    using MB  = regbits< type,  0,  8 >;  /**< Controls the lower mark periods of the modulator for all modes.  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x8, rw, 0 >
  {
    ...
    using SB  = regbits< type,  0,  8 >;  /**< Controls the upper space periods of the modulator for all modes.  */
  };
  ...
  : public reg< uint8_t, base_addr + 0x9, rw, 0 >
  {
    ...
    using SB  = regbits< type,  0,  8 >;  /**< Controls the lower space periods of the modulator for all modes.  */
  };
