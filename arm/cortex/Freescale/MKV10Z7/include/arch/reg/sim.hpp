...
struct SIM
{
  ...
  : public reg< uint32_t, base_addr + 0x100c, rw, 0 >
  {
    ...
    using FTM1ICH0SRC  = regbits< type, 18,  2 >;  /**< FTM1 Channel 0 Input Capture Source Select    */
    using FTM2ICH0SRC  = regbits< type, 20,  2 >;  /**< FTM2 Channel 0 Input Capture Source Select    */
    using FTM2ICH1SRC  = regbits< type, 22,  1 >;  /**< FTM2 Channel 1 Input Capture Source Select    */
  ...
  : public reg< uint32_t, base_addr + 0x101c, rw, 0 >
  {
    ...
    using CARRIER_SELECT  = regbits< type,  8,  1 >;  /**< Carrier frequency selection for FTM0/2 output channel  */
