...
struct USB0
{
  ...
  : public reg< uint8_t, base_addr + 0x104, ro, 0x50 >
  {
    ...
    using DMPD  = regbits< type,  4,  1 >;  /**< Provides observability of the D- Pulldown . signal output from the USB OTG module  */
    using DPPD  = regbits< type,  6,  1 >;  /**< Provides observability of the D+ Pulldown . signal output from the USB OTG module  */
    using DPPU  = regbits< type,  7,  1 >;  /**< Provides observability of the D+ Pullup . signal output from the USB OTG module    */
  };
