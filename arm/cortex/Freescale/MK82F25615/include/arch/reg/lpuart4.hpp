...
#ifndef ARCH_REG_LPUART4_HPP_INCLUDED
#define ARCH_REG_LPUART4_HPP_INCLUDED
...
struct LPUART4
{
  static constexpr reg_addr_t base_addr = 0x400d6000;
...
#endif // ARCH_REG_LPUART4_HPP_INCLUDED
