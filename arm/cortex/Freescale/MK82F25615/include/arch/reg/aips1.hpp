...
struct AIPS1
{
   ...
   */
  struct PACRA
  : public reg< uint32_t, base_addr + 0x20, rw, 0x40000000 >
  {
    using type = reg< uint32_t, base_addr + 0x20, rw, 0x40000000 >;
   ...
   */
  struct PACRE
  : public reg< uint32_t, base_addr + 0x40, rw, 0x40000000 >
  {
    using type = reg< uint32_t, base_addr + 0x40, rw, 0x40000000 >;
   ...
   */
  struct PACRF
  : public reg< uint32_t, base_addr + 0x44, rw, 0x4000 >
  {
    using type = reg< uint32_t, base_addr + 0x44, rw, 0x4000 >;
   ...
   */
  struct PACRG
  : public reg< uint32_t, base_addr + 0x48, rw, 0x4000000 >
  {
    using type = reg< uint32_t, base_addr + 0x48, rw, 0x4000000 >;
   ...
   */
  struct PACRH
  : public reg< uint32_t, base_addr + 0x4c, rw, 0x44000000 >
  {
    using type = reg< uint32_t, base_addr + 0x4c, rw, 0x44000000 >;
   ...
   */
  struct PACRI
  : public reg< uint32_t, base_addr + 0x50, rw, 0x4444 >
  {
    using type = reg< uint32_t, base_addr + 0x50, rw, 0x4444 >;
   ...
   */
  struct PACRJ
  : public reg< uint32_t, base_addr + 0x54, rw, 0x4404000 >
  {
    using type = reg< uint32_t, base_addr + 0x54, rw, 0x4404000 >;
   ...
   */
  struct PACRK
  : public reg< uint32_t, base_addr + 0x58, rw, 0x4440 >
  {
    using type = reg< uint32_t, base_addr + 0x58, rw, 0x4440 >;
   ...
   */
  struct PACRL
  : public reg< uint32_t, base_addr + 0x5c, rw, 0x400004 >
  {
    using type = reg< uint32_t, base_addr + 0x5c, rw, 0x400004 >;
   ...
   */
  struct PACRM
  : public reg< uint32_t, base_addr + 0x60, rw, 0x44 >
  {
    using type = reg< uint32_t, base_addr + 0x60, rw, 0x44 >;
