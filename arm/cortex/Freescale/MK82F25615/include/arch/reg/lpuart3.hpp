...
#ifndef ARCH_REG_LPUART3_HPP_INCLUDED
#define ARCH_REG_LPUART3_HPP_INCLUDED
...
struct LPUART3
{
  static constexpr reg_addr_t base_addr = 0x400c7000;
...
#endif // ARCH_REG_LPUART3_HPP_INCLUDED
