...
struct MCM
{
   ...
   */
  struct PLASC
  : public reg< uint16_t, base_addr + 0x8, ro, 0x3F >
  {
    using type = reg< uint16_t, base_addr + 0x8, ro, 0x3F >;
   ...
   */
  struct PLAMC
  : public reg< uint16_t, base_addr + 0xa, ro, 0x1F >
  {
    using type = reg< uint16_t, base_addr + 0xa, ro, 0x1F >;
