...
struct ADC
{
   ...
   */
  struct OFS
  : public reg< uint32_t, base_addr + 0x38, rw, 0x4 >
  {
    using type = reg< uint32_t, base_addr + 0x38, rw, 0x4 >;
   ...
   */
  struct PG
  : public reg< uint32_t, base_addr + 0x3c, rw, 0x8200 >
  {
    using type = reg< uint32_t, base_addr + 0x3c, rw, 0x8200 >;
   ...
   */
  struct CLPD
  : public reg< uint32_t, base_addr + 0x44, rw, 0xA >
  {
    using type = reg< uint32_t, base_addr + 0x44, rw, 0xA >;
   ...
   */
  struct CLPS
  : public reg< uint32_t, base_addr + 0x48, rw, 0x20 >
  {
    using type = reg< uint32_t, base_addr + 0x48, rw, 0x20 >;
   ...
   */
  struct CLP4
  : public reg< uint32_t, base_addr + 0x4c, rw, 0x200 >
  {
    using type = reg< uint32_t, base_addr + 0x4c, rw, 0x200 >;
   ...
   */
  struct CLP3
  : public reg< uint32_t, base_addr + 0x50, rw, 0x100 >
  {
    using type = reg< uint32_t, base_addr + 0x50, rw, 0x100 >;
   ...
   */
  struct CLP2
  : public reg< uint32_t, base_addr + 0x54, rw, 0x80 >
  {
    using type = reg< uint32_t, base_addr + 0x54, rw, 0x80 >;
   ...
   */
  struct CLP1
  : public reg< uint32_t, base_addr + 0x58, rw, 0x40 >
  {
    using type = reg< uint32_t, base_addr + 0x58, rw, 0x40 >;
   ...
   */
  struct CLP0
  : public reg< uint32_t, base_addr + 0x5c, rw, 0x20 >
  {
    using type = reg< uint32_t, base_addr + 0x5c, rw, 0x20 >;
