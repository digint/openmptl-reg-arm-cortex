...
struct FTFA_FlashConfig
{
  ...
  : public reg< uint8_t, base_addr + 0xd, ro, 0xFF >
  {
    ...
    using NMI_EN    = regbits< type,  2,  1 >;  /**< no description available  */
    using EXE_MODE  = regbits< type,  3,  1 >;  /**< no description available  */
    using CLK_SRC   = regbits< type,  5,  1 >;  /**< no description available  */
  };
};
} // namespace mptl
