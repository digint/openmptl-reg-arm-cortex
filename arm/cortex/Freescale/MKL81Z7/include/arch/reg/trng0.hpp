...
struct TRNG0
{
  ...
  /**
   * TRNG0 Miscellaneous Control Register
   */
  struct TRNG0_MCTL
  ...
  /**
   * TRNG0 Statistical Check Miscellaneous Register
   */
  struct TRNG0_SCMISC
  ...
  /**
   * TRNG0 Poker Maximum Limit Register
   */
  struct TRNG0_PKRMAX
  ...
  /**
   * TRNG0 Poker Square Calculation Result Register
   */
  struct TRNG0_PKRSQ
  ...
  /**
   * TRNG0 Sparse Bit Limit Register
   */
  struct TRNG0_SBLIM
  ...
  /**
   * TRNG0 Frequency Count Minimum Limit Register
   */
  struct TRNG0_FRQMIN
  ...
  /**
   * TRNG0 Frequency Count Register
   */
  struct TRNG0_FRQCNT
  ...
  /**
   * TRNG0 Frequency Count Maximum Limit Register
   */
  struct TRNG0_FRQMAX
  ...
  /**
   * TRNG0 Statistical Check Monobit Count Register
   */
  struct TRNG0_SCMC
  ...
  /**
   * TRNG0 Statistical Check Monobit Limit Register
   */
  struct TRNG0_SCML
  ...
  /**
   * TRNG0 Statistical Check Run Length 1 Count Register
   */
  struct TRNG0_SCR1C
  ...
  /**
   * TRNG0 Statistical Check Run Length 1 Limit Register
   */
  struct TRNG0_SCR1L
  ...
  /**
   * TRNG0 Statistical Check Run Length 2 Count Register
   */
  struct TRNG0_SCR2C
  ...
  /**
   * TRNG0 Statistical Check Run Length 2 Limit Register
   */
  struct TRNG0_SCR2L
  ...
  /**
   * TRNG0 Statistical Check Run Length 3 Count Register
   */
  struct TRNG0_SCR3C
  ...
  /**
   * TRNG0 Statistical Check Run Length 3 Limit Register
   */
  struct TRNG0_SCR3L
  ...
  /**
   * TRNG0 Statistical Check Run Length 4 Count Register
   */
  struct TRNG0_SCR4C
  ...
  /**
   * TRNG0 Statistical Check Run Length 4 Limit Register
   */
  struct TRNG0_SCR4L
  ...
  /**
   * TRNG0 Statistical Check Run Length 5 Count Register
   */
  struct TRNG0_SCR5C
  ...
  /**
   * TRNG0 Statistical Check Run Length 5 Limit Register
   */
  struct TRNG0_SCR5L
  ...
  /**
   * TRNG0 Statistical Check Run Length 6+ Count Register
   */
  struct TRNG0_SCR6PC
  ...
  /**
   * TRNG0 Statistical Check Run Length 6+ Limit Register
   */
  struct TRNG0_SCR6PL
  ...
  /**
   * TRNG0 Statistical Check Poker Count 1 and 0 Register
   */
  ...
  /**
   * TRNG0 Statistical Check Poker Count 3 and 2 Register
   */
  ...
  /**
   * TRNG0 Statistical Check Poker Count 5 and 4 Register
   */
  ...
  /**
   * TRNG0 Statistical Check Poker Count 7 and 6 Register
   */
  ...
  /**
   * TRNG0 Statistical Check Poker Count 9 and 8 Register
   */
  ...
  /**
   * TRNG0 Statistical Check Poker Count B and A Register
   */
  ...
  /**
   * TRNG0 Statistical Check Poker Count D and C Register
   */
  ...
  /**
   * TRNG0 Statistical Check Poker Count F and E Register
   */
  ...
  /**
   * TRNG0 Security Configuration Register
   */
  ...
  /**
   * TRNG0 Interrupt Control Register
   */
  ...
  /**
   * TRNG0 Interrupt Status Register
   */
  ...
  : public reg< uint32_t, base_addr + 0xf0, ro, 0x300100 >
  {
    ...
    using TRNG0_MIN_REV  = regbits< type,  0,  8 >;  /**< Shows the Freescale IP's Minor revision of the TRNG.  */
    using TRNG0_MAJ_REV  = regbits< type,  8,  8 >;  /**< Shows the Freescale IP's Major revision of the TRNG.  */
    using TRNG0_IP_ID    = regbits< type, 16, 16 >;  /**< Shows the Freescale IP ID.                            */
  };

  /**
   * TRNG0 Version ID Register (LS)
   */
  struct TRNG0_VID2
  : public reg< uint32_t, base_addr + 0xf4, ro, 0 >
  {
    ...
    using TRNG0_CONFIG_OPT  = regbits< type,  0,  8 >;  /**< Shows the Freescale IP's Configuaration options for the TRNG.  */
    using TRNG0_ECO_REV     = regbits< type,  8,  8 >;  /**< Shows the Freescale IP's ECO revision of the TRNG.             */
    using TRNG0_INTG_OPT    = regbits< type, 16,  8 >;  /**< Shows the Freescale integration options for the TRNG.          */
    using TRNG0_ERA         = regbits< type, 24,  8 >;  /**< Shows the Freescale compile options for the TRNG.              */
  };
};
} // namespace mptl
