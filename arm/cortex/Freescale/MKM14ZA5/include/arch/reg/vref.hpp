...
struct VREF
{
  ...
  : public reg< uint8_t, base_addr + 0x5, rw, 0 >
  {
    ...
    using VREFL_TRIM  = regbits< type,  0,  3 >;  /**< no description available  */
    using VREFL_EN    = regbits< type,  3,  1 >;  /**< no description available  */
    using VREFL_SEL   = regbits< type,  4,  1 >;  /**< no description available  */
  };
};
} // namespace mptl
