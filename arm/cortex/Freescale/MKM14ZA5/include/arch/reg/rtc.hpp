...
struct RTC
{
  ...
  : public reg< uint16_t, base_addr + 0, rw, 0x1 >
  {
    ...
    using MON_CNT  = regbits< type,  0,  4 >;  /**< no description available  */
  ...
  : public reg< uint16_t, base_addr + 0xe, rw, 0 >
  {
    ...
    using ALM_SEC  = regbits< type,  0,  6 >;  /**< no description available         */
  ...
  : public reg< uint16_t, base_addr + 0x10, rw, 0 >
  {
    ...
    using COMP_EN         = regbits< type,  1,  1 >;  /**< no description available      */
  ...
  : public reg< uint16_t, base_addr + 0x20, rw, 0 >
  {
    ...
    using GP_DATA_REG_ = regbits< type,  0, 16 >;  /**< no description available  */
  };
   ...
   */
  struct TAMPER_DIRECTION
  : public reg< uint16_t, base_addr + 0x2c, rw, 0 >
  {
    using type = reg< uint16_t, base_addr + 0x2c, rw, 0 >;

    using A_P_TAMP  = regbits< type,  0,  4 >;  /**< no description available  */
    using I_O_TAMP  = regbits< type,  8,  4 >;  /**< no description available  */
  };
   ...
   */
  struct TAMPER_QSCR
  : public reg< uint16_t, base_addr + 0x2e, rw, 0x2 >
  {
    using type = reg< uint16_t, base_addr + 0x2e, rw, 0x2 >;

    using Q_FULL         = regbits< type,  0,  1 >;  /**< no description available  */
    using Q_FULL_INT_EN  = regbits< type,  1,  1 >;  /**< no description available  */
    using Q_CLEAR        = regbits< type,  2,  1 >;  /**< no description available  */
    using LFSR_CLK_SEL   = regbits< type,  8,  3 >;  /**< no description available  */
    using LFSR_DURATION  = regbits< type, 12,  4 >;  /**< no description available  */
  };
  ...
  : public reg< uint16_t, base_addr + 0x40, ro, 0 >
  {
    ...
    using TAMPER_DATA  = regbits< type,  0, 16 >;  /**< Tamper type stamp and pin number information register  */
  };
