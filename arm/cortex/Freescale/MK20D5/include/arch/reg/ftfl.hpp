...
struct FTFL
{
  ...
  : public reg< uint8_t, base_addr + 0, rw, 0 >
  {
    ...
    using RDCOLERR  = regbits< type,  6,  1 >;  /**< FTFL Read Collision Error Flag                    */
  ...
  : public reg< uint8_t, base_addr + 0x1, rw, 0 >
  {
    ...
    using EEERDY    = regbits< type,  0,  1 >;  /**< This flag indicates if the EEPROM backup data has been copied to the FlexRAM and is therefore available for read access  */
    using RAMRDY    = regbits< type,  1,  1 >;  /**< RAM Ready                                                                                                                */
    using PFLSH     = regbits< type,  2,  1 >;  /**< FTFL configuration                                                                                                       */
