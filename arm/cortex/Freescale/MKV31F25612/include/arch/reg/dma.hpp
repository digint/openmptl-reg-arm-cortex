...
////////////////////////////////////////////////////////////////////////
//
//  Import from CMSIS-SVD: "Freescale/MKV31F25612.svd"
//
...
//  series: Kinetis_V
//  version: 1.6
//  description: MKV31F25612 Freescale Microcontroller
//  --------------------------------------------------------------------
//
...
struct DMA
{
  ...
  : public reg< uint32_t, base_addr + 0x4, ro, 0 >
  {
    ...
    using ERRCHN  = regbits< type,  8,  4 >;  /**< Error Channel Number or Canceled Channel Number  */
  ...
  : public reg< uint32_t, base_addr + 0x44, rw, 0 >
  {
    ...
    using EDREQ_4   = regbits< type,  4,  1 >;  /**< Enable asynchronous DMA request in stop for channel 4   */
    using EDREQ_5   = regbits< type,  5,  1 >;  /**< Enable asynchronous DMA request in stop for channel 5   */
    using EDREQ_6   = regbits< type,  6,  1 >;  /**< Enable asynchronous DMA request in stop for channel 6   */
    using EDREQ_7   = regbits< type,  7,  1 >;  /**< Enable asynchronous DMA request in stop for channel 7   */
    using EDREQ_8   = regbits< type,  8,  1 >;  /**< Enable asynchronous DMA request in stop for channel 8   */
    using EDREQ_9   = regbits< type,  9,  1 >;  /**< Enable asynchronous DMA request in stop for channel 9   */
    using EDREQ_10  = regbits< type, 10,  1 >;  /**< Enable asynchronous DMA request in stop for channel 10  */
    using EDREQ_11  = regbits< type, 11,  1 >;  /**< Enable asynchronous DMA request in stop for channel 11  */
    using EDREQ_12  = regbits< type, 12,  1 >;  /**< Enable asynchronous DMA request in stop for channel 12  */
    using EDREQ_13  = regbits< type, 13,  1 >;  /**< Enable asynchronous DMA request in stop for channel 13  */
    using EDREQ_14  = regbits< type, 14,  1 >;  /**< Enable asynchronous DMA request in stop for channel 14  */
    using EDREQ_15  = regbits< type, 15,  1 >;  /**< Enable asynchronous DMA request in stop for channel 15  */
  };
