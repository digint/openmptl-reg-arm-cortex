...
struct SIM
{
   ...
   */
  struct SDID
  : public reg< uint32_t, base_addr + 0x1024, ro, 0x100D80 >
  {
    using type = reg< uint32_t, base_addr + 0x1024, ro, 0x100D80 >;
  ...
  : public reg< uint32_t, base_addr + 0x1050, ro, 0x7FFF0000 >
  {
    ...
    using MAXADDR1  = regbits< type, 16,  7 >;  /**< This field concatenated with leading zeros plus the value of the MAXADDR0 field indicates the first invalid address of the second program flash block (flash block 1)  */
