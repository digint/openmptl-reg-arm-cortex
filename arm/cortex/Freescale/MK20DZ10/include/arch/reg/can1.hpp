...
struct CAN1
{
  static constexpr reg_addr_t base_addr = 0x400a4000;
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0 >
  {
    ...
    using ERRMSK   = regbits< type, 14,  1 >;  /**< Error Mask                       */
    using BOFFMSK  = regbits< type, 15,  1 >;  /**< Bus Off Mask                     */
   ...
   */
  struct RX15MASK
  : public reg< uint32_t, base_addr + 0x18, rw, 0xFFFFFFFF >
  {
    using type = reg< uint32_t, base_addr + 0x18, rw, 0xFFFFFFFF >;
  ...
  : public reg< uint32_t, base_addr + 0x20, rw, 0 >
  {
    ...
    using IDLE     = regbits< type,  7,  1 >;  /**< no description available       */
  ...
  : public reg< uint32_t, base_addr + 0x24, rw, 0 >
  {
    ...
    using BUFHM  = regbits< type,  0, 32 >;  /**< Buffer MBi Mask  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x28, rw, 0 >
  {
    ...
    using BUFLM  = regbits< type,  0, 32 >;  /**< Buffer MBi Mask  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x2c, rw, 0 >
  {
    ...
    using BUFHI  = regbits< type,  0, 32 >;  /**< Buffer MBi Interrupt  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x30, rw, 0 >
  {
    ...
    using BUF4TO0I   = regbits< type,  0,  5 >;  /**< Buffer MBi Interrupt or "reserved"                     */
   ...
   */
  struct CTRL2
  : public reg< uint32_t, base_addr + 0x34, rw, 0xC00000 >
  {
    using type = reg< uint32_t, base_addr + 0x34, rw, 0xC00000 >;
    ...
    using WRMFRZ  = regbits< type, 28,  1 >;  /**< Write-Access to Memory in Freeze mode                              */
  };
  ...
  : public reg< uint32_t, base_addr + 0x44, ro, 0 >
  {
    ...
    using TXCRC  = regbits< type,  0, 15 >;  /**< CRC Transmitted  */
   ...
   */
  struct RXFGMASK
  : public reg< uint32_t, base_addr + 0x48, rw, 0xFFFFFFFF >
  {
    using type = reg< uint32_t, base_addr + 0x48, rw, 0xFFFFFFFF >;
