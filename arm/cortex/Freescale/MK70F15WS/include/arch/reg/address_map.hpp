...
template<> struct address_map< 0x4006a01b > { static constexpr const char * name_str = "UART0::WP7816T0"; };  /* svd2hpp: duplicate address for: UART0::WP7816T0, UART0::WP7816T1 */
...
template<> struct address_map< 0x4006b01b > { static constexpr const char * name_str = "UART1::WP7816T0"; };  /* svd2hpp: duplicate address for: UART1::WP7816T0, UART1::WP7816T1 */
