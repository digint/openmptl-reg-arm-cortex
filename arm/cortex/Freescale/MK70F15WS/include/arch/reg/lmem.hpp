...
struct LMEM
{
  ...
  : public reg< uint32_t, base_addr + 0, rw, 0 >
  {
    ...
    using RESERVED  = regbits< type,  2, 22 >;  /**< no description available  */
  ...
  : public reg< uint32_t, base_addr + 0x4, rw, 0 >
  {
    ...
    using RESERVED   = regbits< type, 17,  3 >;  /**< no description available           */
   ...
   */
  struct PSCRMR
  : public reg< uint32_t, base_addr + 0x820, rw, 0xAA0FA000 >
  {
    using type = reg< uint32_t, base_addr + 0x820, rw, 0xAA0FA000 >;
