...
struct SDHC
{
  ...
  : public reg< uint32_t, base_addr + 0xc, rw, 0 >
  {
    ...
    using RESERVED  = regbits< type,  6, 10 >;  /**< no description available        */
  ...
  : public reg< uint32_t, base_addr + 0x24, ro, 0 >
  {
    ...
    using RESERVED  = regbits< type, 17,  6 >;  /**< no description available           */
  ...
  : public reg< uint32_t, base_addr + 0x30, rw, 0 >
  {
    ...
    using RESERVED  = regbits< type, 25,  3 >;  /**< no description available  */
  ...
  : public reg< uint32_t, base_addr + 0x40, ro, 0x7F30000 >
  {
    ...
    using VS30      = regbits< type, 25,  1 >;  /**< Voltage Support 3.0 V     */
    using VS18      = regbits< type, 26,  1 >;  /**< Voltage Support 1.8 V     */
    using RESERVED  = regbits< type, 27,  5 >;  /**< no description available  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x44, rw, 0x100010 >
  {
    ...
    using RESERVED   = regbits< type,  8,  5 >;  /**< no description available  */
    using RESERVED   = regbits< type, 13,  3 >;  /**< no description available  */
    using WRWML      = regbits< type, 16,  8 >;  /**< Write Watermark Level     */
    using WRBRSTLEN  = regbits< type, 24,  5 >;  /**< no description available  */
    using RESERVED   = regbits< type, 29,  3 >;  /**< no description available  */
  };
  ...
  : public reg< uint32_t, base_addr + 0x54, ro, 0 >
  {
    ...
    using ADMADCE   = regbits< type,  3,  1 >;  /**< ADMA Descritor Error                             */
  ...
  : public reg< uint32_t, base_addr + 0xc0, rw, 0x1 >
  {
    ...
    using RESERVED  = regbits< type,  2, 14 >;  /**< no description available                             */
  ...
  : public reg< uint32_t, base_addr + 0xc4, rw, 0 >
  {
    ...
    using AUTOSABGEN  = regbits< type,  7,  1 >;  /**< no description available          */
    using RESERVED    = regbits< type,  8,  8 >;  /**< no description available          */
    using BOOTBLKCNT  = regbits< type, 16, 16 >;  /**< no description available          */
  };
