...
struct LCDC
{
  ...
  : public reg< uint32_t, base_addr + 0x1c, rw, 0x4000000 >
  {
    ...
    using RESERVED  = regbits< type, 16, 10 >;  /**< no description available                   */
  ...
  : public reg< uint32_t, base_addr + 0x2c, rw, 0 >
  {
    ...
    using RESERVED  = regbits< type, 16,  9 >;  /**< no description available  */
  ...
  : public reg< uint32_t, base_addr + 0x30, rw, 0x80040060 >
  {
    ...
    using RESERVED  = regbits< type,  7,  9 >;  /**< no description available  */
    using HM        = regbits< type, 16,  7 >;  /**< DMA high mark             */
    using RESERVED  = regbits< type, 23,  8 >;  /**< no description available  */
  ...
  : public reg< uint32_t, base_addr + 0x64, rw, 0 >
  {
    ...
    using RESERVED  = regbits< type, 18,  3 >;  /**< no description available                     */
  ...
  : public reg< uint32_t, base_addr + 0x80, rw, 0 >
  {
    ...
    using RESERVED  = regbits< type, 24,  7 >;  /**< no description available                         */
